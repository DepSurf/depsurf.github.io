...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584808336,
      "name": "ZSTD_compressBlock_doubleFast",
      "external": false,
      "loc": "lib/zstd/compress.c:1383",
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "ZSTD_compressBlock_doubleFast",
      "external": true,
      "loc": "lib/zstd/compress/zstd_double_fast.c:317",
  ...
  "symbols": [
    {
      "addr": 18446744071594157856,
      "name": "ZSTD_compressBlock_doubleFast.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 4385
    },
    {
      "addr": 18446744071586325024,
      "name": "ZSTD_compressBlock_doubleFast",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 13690
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071587356944,
      "name": "ZSTD_compressBlock_doubleFast",
      "external": true,
      "loc": "lib/zstd/compress/zstd_double_fast.c:490",
      "file": "lib/zstd/compress/zstd_double_fast.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

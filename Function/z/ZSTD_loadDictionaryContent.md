...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584838064,
      "name": "ZSTD_loadDictionaryContent",
      "external": false,
      "loc": "lib/zstd/compress.c:2557",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586264128,
      "name": "ZSTD_loadDictionaryContent",
      "external": false,
      "loc": "lib/zstd/compress/zstd_compress.c:3049",
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "ZSTD_loadDictionaryContent",
      "external": false,
      "loc": "lib/zstd/compress/zstd_compress.c:4109",
      "file": "lib/zstd/compress/zstd_compress.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596137511,
      "name": "ZSTD_loadDictionaryContent.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 29
    }

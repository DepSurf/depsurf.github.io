...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584838479,
      "name": "ZSTD_fillHashTable",
      "external": false,
      "loc": "lib/zstd/compress.c:992",
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "ZSTD_fillHashTable",
      "external": true,
      "loc": "lib/zstd/compress/zstd_fast.c:15",
  ...
  "symbols": [
    {
      "addr": 18446744071594168544,
      "name": "ZSTD_fillHashTable.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 640
    },
    {
      "addr": 18446744071586361392,
      "name": "ZSTD_fillHashTable",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 604

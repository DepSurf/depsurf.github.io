...
```json
{
  "name": "hugetlb_cgroup_charge_cgroup_rsvd",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071583423776,
      "name": "hugetlb_cgroup_charge_cgroup_rsvd",
      "external": true,
      "loc": "mm/hugetlb_cgroup.c:304",
      "file": "mm/hugetlb_cgroup.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

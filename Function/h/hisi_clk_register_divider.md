# Function: <code>hisi_clk_register_divider</code>
...
```c
int hisi_clk_register_divider(const struct hisi_divider_clock * clks, int nums, struct hisi_clock_data * data)
```

```json
{
  "name": "hisi_clk_register_divider",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336497823168,
      "name": "hisi_clk_register_divider",
      "external": true,
      "loc": "drivers/clk/hisilicon/clk.c:212",

# Function: <code>hip04_set_snoop_filter</code>
...
```c
void hip04_set_snoop_filter(unsigned int cluster, unsigned int on)
```

```json
{
  "name": "hip04_set_snoop_filter",
  ...
  "funcs": [
    {
      ...
      "name": "hip04_set_snoop_filter",
      "external": false,
      "loc": "arch/arm/mach-hisi/platmcpm.c:81",

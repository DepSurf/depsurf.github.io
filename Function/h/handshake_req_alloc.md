# Function: <code>handshake_req_alloc</code>
...
```c
struct handshake_req * handshake_req_alloc(const struct handshake_proto * proto, gfp_t flags)
```

```json
{
  "name": "handshake_req_alloc",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071596223120,
      "name": "handshake_req_alloc",
      "external": true,
      "loc": "net/handshake/request.c:109",

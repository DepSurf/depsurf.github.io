# Function: <code>hash_conntrack_raw</code>
...
```c
u32 hash_conntrack_raw(const struct nf_conntrack_tuple * tuple, const struct net * net)
```

```json
{
  "name": "hash_conntrack_raw",
  ...
  "funcs": [
    {
      ...
      "name": "hash_conntrack_raw",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_core.c:184",

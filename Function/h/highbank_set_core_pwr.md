# Function: <code>highbank_set_core_pwr</code>
...
```c
void highbank_set_core_pwr()
```

```json
{
  "name": "highbank_set_core_pwr",
  ...
  "funcs": [
    {
      ...
      "name": "highbank_set_core_pwr",
      "external": false,
      "loc": "arch/arm/mach-highbank/sysregs.h:27",
    ...
    },
    {
      ...
      "external": false,
      "loc": "arch/arm/mach-highbank/sysregs.h:27",
      "file": "arch/arm/mach-highbank/system.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>hisi_clk_register_mux</code>
...
```c
int hisi_clk_register_mux(const struct hisi_mux_clock * clks, int nums, struct hisi_clock_data * data)
```

```json
{
  "name": "hisi_clk_register_mux",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336497822640,
      "name": "hisi_clk_register_mux",
      "external": true,
      "loc": "drivers/clk/hisilicon/clk.c:150",

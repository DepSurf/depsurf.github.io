...
```json
{
  "name": "hdmi_audio_infoframe_pack_payload",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596212970,
      "name": "hdmi_audio_infoframe_pack_payload.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 21
    }

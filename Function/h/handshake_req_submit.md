# Function: <code>handshake_req_submit</code>
...
```c
int handshake_req_submit(struct socket * sock, struct handshake_req * req, gfp_t flags)
```

```json
{
  "name": "handshake_req_submit",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071596225024,
      "name": "handshake_req_submit",
      "external": true,
      "loc": "net/handshake/request.c:223",

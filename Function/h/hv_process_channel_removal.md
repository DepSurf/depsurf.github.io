# Function: <code>hv_process_channel_removal</code>
...
```json
{
  "name": "hv_process_channel_removal",
  ...
  "funcs": [
    {
      ...
      "name": "hv_process_channel_removal",
      "external": true,
      "loc": "drivers/hv/channel_mgmt.c:374",
      "file": "drivers/hv/channel_mgmt.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "drivers/hv/vmbus_drv.c:vmbus_device_release",

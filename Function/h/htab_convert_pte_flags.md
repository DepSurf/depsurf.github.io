# Function: <code>htab_convert_pte_flags</code>
...
```c
long unsigned int htab_convert_pte_flags(long unsigned int pteflags)
```

```json
{
  "name": "htab_convert_pte_flags",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282738080,
      "name": "htab_convert_pte_flags",
      "external": true,
      "loc": "arch/powerpc/mm/book3s64/hash_utils.c:186",

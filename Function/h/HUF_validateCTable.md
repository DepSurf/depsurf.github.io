...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584803632,
      "name": "HUF_validateCTable",
      "external": false,
      "loc": "lib/zstd/huf_compress.c:511",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586255472,
      "name": "HUF_validateCTable",
      "external": true,
      "loc": "lib/zstd/compress/huf_compress.c:551",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071587249026,
      "name": "HUF_validateCTable",
      "external": true,
      "loc": "lib/zstd/compress/huf_compress.c:718",
      "file": "lib/zstd/compress/huf_compress.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "lib/zstd/compress/huf_compress.c:HUF_compress_internal"

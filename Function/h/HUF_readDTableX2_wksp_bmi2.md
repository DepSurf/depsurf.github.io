...
```json
{
  "name": "HUF_readDTableX2_wksp_bmi2",
  ...
  "funcs": [
    {
      ...
      "name": "HUF_readDTableX2_wksp_bmi2",
      "external": true,
      "loc": "lib/zstd/decompress/huf_decompress.c:1048",
  ...
  "symbols": [
    {
      "addr": 18446744071596192768,
      "name": "HUF_readDTableX2_wksp_bmi2.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 140
    },

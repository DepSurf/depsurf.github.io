# Function: <code>hisi_clk_register_gate_sep</code>
...
```c
void hisi_clk_register_gate_sep(const struct hisi_gate_clock * clks, int nums, struct hisi_clock_data * data)
```

```json
{
  "name": "hisi_clk_register_gate_sep",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336497823720,
      "name": "hisi_clk_register_gate_sep",
      "external": true,
      "loc": "drivers/clk/hisilicon/clk.c:287",

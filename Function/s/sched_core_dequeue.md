...
```json
{
  "name": "sched_core_dequeue",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071579885261,
      "name": "sched_core_dequeue",
      "external": true,
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580002623,
      "name": "sched_core_dequeue",
      "external": true,
      "loc": "kernel/sched/core.c:246",
      "file": "kernel/sched/core.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "kernel/sched/core.c:sched_move_task",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580164794,
      "name": "sched_core_dequeue",
      "external": true,
      "loc": "kernel/sched/core.c:243",
      "file": "kernel/sched/core.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "kernel/sched/core.c:sched_move_task",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580213334,
      "name": "sched_core_dequeue",
      "external": true,
      "loc": "kernel/sched/core.c:249",
      "file": "kernel/sched/core.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "kernel/sched/core.c:sched_move_task",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580262039,
      "name": "sched_core_dequeue",
      "external": true,
      "loc": "kernel/sched/core.c:250",
      "file": "kernel/sched/core.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "kernel/sched/core.c:sched_move_task",

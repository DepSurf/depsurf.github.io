...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071593140720,
      "name": "status_store",
      "external": false,
      "loc": "drivers/cpufreq/amd-pstate.c:1027",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592158992,
      "name": "status_store",
      "external": false,
      "loc": "drivers/gpu/drm/drm_sysfs.c:185",
    ...
    {
      "addr": 18446744071593894144,
      "name": "status_store",
      "external": false,
      "loc": "drivers/cpufreq/amd-pstate.c:1064",
      "file": "drivers/cpufreq/amd-pstate.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

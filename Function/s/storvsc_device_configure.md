# Function: <code>storvsc_device_configure</code>
...
```c
int storvsc_device_configure(struct scsi_device * sdevice)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586262128,
      "name": "storvsc_device_configure",
      "external": false,
      "loc": "drivers/scsi/storvsc_drv.c:1422",

# Function: <code>samsung_clk_register_fixed_rate</code>
...
```c
void samsung_clk_register_fixed_rate(struct samsung_clk_provider * ctx, const struct samsung_fixed_rate_clock * list, unsigned int nr_clk)
```

```json
{
  "name": "samsung_clk_register_fixed_rate",
  ...
  "funcs": [
    {
      ...
      "name": "samsung_clk_register_fixed_rate",
      "external": true,
      "loc": "drivers/clk/samsung/clk.c:127",

# Function: <code>SyS_rt_sigtimedwait</code>
...
```c
long int SyS_rt_sigtimedwait(long int uthese, long int uinfo, long int uts, long int sigsetsize)
```

...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071596268480,
      "name": "strlcpy",
      "external": true,
      "loc": "include/linux/string.h:250",
      "file": "init/main.c",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071602584422,
      "name": "strlcpy",
      "external": true,
      "loc": "include/linux/string.h:285",
      "file": "init/main.c",
      "inline": "declared, inlined",
      "caller_inline": [
        "init/do_mounts.c:root_dev_setup",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071602752516,
      "name": "strlcpy",
      "external": true,
      "loc": "include/linux/string.h:286",
      "file": "init/main.c",
      "inline": "declared, inlined",
      "caller_inline": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071604546574,
      "name": "strlcpy",
      "external": true,
      "loc": "include/linux/string.h:293",
      "file": "init/main.c",
      "inline": "declared, inlined",
      "caller_inline": [
        "init/main.c:parse_early_param",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071612068532,
      "name": "strlcpy",
      "external": true,
      "loc": "include/linux/string.h:341",
      "file": "init/main.c",
      "inline": "declared, inlined",
      "caller_inline": [
        "init/main.c:parse_early_param",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071614205250,
      "name": "strlcpy",
      "external": true,
      "loc": "include/linux/fortify-string.h:80",
      "file": "init/main.c",
      "inline": "declared, inlined",
      "caller_inline": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071627479821,
      "name": "strlcpy",
      "external": true,
      "loc": "include/linux/fortify-string.h:261",
      "file": "init/version.c",
      "inline": "declared, inlined",
      "caller_inline": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071619223341,
      "name": "strlcpy",
      "external": true,
      "loc": "include/linux/fortify-string.h:241",
      "file": "init/version.c",
      "inline": "declared, inlined",
      "caller_inline": [
        "init/version.c:early_hostname",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446743936279760946,
      "name": "strlcpy",
      "external": true,
      "loc": "lib/string.c:141",
      "file": "lib/string.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

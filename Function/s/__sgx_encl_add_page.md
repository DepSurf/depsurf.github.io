...
```json
{
  "name": "__sgx_encl_add_page",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071579266336,
      "name": "__sgx_encl_add_page",
      "external": false,
      "loc": "arch/x86/kernel/cpu/sgx/ioctl.c:229",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579267792,
      "name": "__sgx_encl_add_page",
      "external": false,
      "loc": "arch/x86/kernel/cpu/sgx/ioctl.c:230",
      "file": "arch/x86/kernel/cpu/sgx/ioctl.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "__sgx_encl_add_page",
      "external": false,
      "loc": "arch/x86/kernel/cpu/sgx/ioctl.c:199",
      "file": "arch/x86/kernel/cpu/sgx/ioctl.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

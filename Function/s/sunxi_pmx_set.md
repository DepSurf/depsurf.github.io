# Function: <code>sunxi_pmx_set</code>
...
```c
void sunxi_pmx_set(struct pinctrl_dev * pctldev, unsigned int pin, u8 config)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446603336496667176,
      "name": "sunxi_pmx_set",
      "external": false,
      "loc": "drivers/pinctrl/sunxi/pinctrl-sunxi.c:698",

# Function: <code>smc_phy_read</code>
...
```c
int smc_phy_read(struct net_device * dev, int phyaddr, int phyreg)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446603336500090920,
      "name": "smc_phy_read",
      "external": false,
      "loc": "drivers/net/ethernet/smsc/smc91x.c:807",

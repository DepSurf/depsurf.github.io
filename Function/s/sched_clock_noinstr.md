# Function: <code>sched_clock_noinstr</code>
...
```json
{
  "name": "sched_clock_noinstr",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071596926400,
      "name": "sched_clock_noinstr",
      "external": true,
      "loc": "arch/x86/kernel/tsc.c:264",
      ...
      "caller_func": [
        ...
        "kernel/sched/build_utility.c:sched_clock_cpu",
        "kernel/sched/build_utility.c:local_clock_noinstr",
        "kernel/sched/build_utility.c:local_clock_noinstr",
        "kernel/sched/build_utility.c:local_clock_noinstr"
      ]
    }

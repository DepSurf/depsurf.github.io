# Function: <code>samsung_clk_register_div</code>
...
```c
void samsung_clk_register_div(struct samsung_clk_provider * ctx, const struct samsung_div_clock * list, unsigned int nr_clk)
```
  ...
  "funcs": [
    {
      ...
      "name": "samsung_clk_register_div",
      "external": true,
      "loc": "drivers/clk/samsung/clk.c:200",

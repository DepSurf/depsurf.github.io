# Function: <code>storvsc_host_reset_handler</code>
...
```c
int storvsc_host_reset_handler(struct scsi_cmnd * scmnd)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586261552,
      "name": "storvsc_host_reset_handler",
      "external": false,
      "loc": "drivers/scsi/storvsc_drv.c:1471",

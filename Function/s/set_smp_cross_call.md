...
```c
void set_smp_cross_call(void (*)(const struct cpumask *, unsigned int) fn)
```

```json
{
  "name": "set_smp_cross_call",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336510823776,
      "name": "set_smp_cross_call",
      "external": true,
      "loc": "arch/arm64/kernel/smp.c:758",

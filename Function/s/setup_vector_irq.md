  ...
  "funcs": [
    {
      ...
      "name": "setup_vector_irq",
      "external": true,
      "loc": "arch/x86/kernel/apic/vector.c:479",
  ...
  "funcs": [
    {
      ...
      "name": "setup_vector_irq",
      "external": true,
      "loc": "arch/x86/kernel/apic/vector.c:481",
      "file": "arch/x86/kernel/apic/vector.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579205616,
      "name": "setup_vector_irq",
      "external": true,
      "loc": "arch/x86/kernel/apic/vector.c:501",
      "file": "arch/x86/kernel/apic/vector.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

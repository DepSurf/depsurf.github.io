# Function: <code>sanitize_temp_error</code>
...
```c
void sanitize_temp_error(struct exynos_tmu_data * data, u32 trim_info)
```

```json
{
  "name": "sanitize_temp_error",
  ...
  "funcs": [
    {
      ...
      "name": "sanitize_temp_error",
      "external": false,
      "loc": "drivers/thermal/samsung/exynos_tmu.c:235",

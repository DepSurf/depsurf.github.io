# Function: <code>shmobile_smp_scu_prepare_cpus</code>
...
```c
void shmobile_smp_scu_prepare_cpus(phys_addr_t scu_base_phys, unsigned int max_cpus)
```

```json
{
  "name": "shmobile_smp_scu_prepare_cpus",
  ...
  "funcs": [
    {
      ...
      "name": "shmobile_smp_scu_prepare_cpus",
      "external": true,
      "loc": "arch/arm/mach-shmobile/platsmp-scu.c:29",

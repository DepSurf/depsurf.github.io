# Function: <code>set_subcores_per_core</code>
...
```c
int set_subcores_per_core(int new_mode)
```

```json
{
  "name": "set_subcores_per_core",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055283009584,
      "name": "set_subcores_per_core",
      "external": false,
      "loc": "arch/powerpc/platforms/powernv/subcore.c:326",

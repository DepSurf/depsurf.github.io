...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585357664,
      "name": "scsi_execute",
      "external": true,
      "loc": "drivers/scsi/scsi_lib.c:231",
      "file": "drivers/scsi/scsi_lib.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585436000,
      "name": "scsi_execute",
      "external": true,
      "loc": "drivers/scsi/scsi_lib.c:237",
      "file": "drivers/scsi/scsi_lib.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585866624,
      "name": "scsi_execute",
      "external": true,
      "loc": "drivers/scsi/scsi_lib.c:245",
      "file": "drivers/scsi/scsi_lib.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586112816,
      "name": "scsi_execute",
      "external": true,
      "loc": "drivers/scsi/scsi_lib.c:258",
      "file": "drivers/scsi/scsi_lib.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

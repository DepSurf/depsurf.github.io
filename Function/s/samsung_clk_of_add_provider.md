# Function: <code>samsung_clk_of_add_provider</code>
...
```c
void samsung_clk_of_add_provider(struct device_node * np, struct samsung_clk_provider * ctx)
```

```json
{
  "name": "samsung_clk_of_add_provider",
  ...
  "funcs": [
    {
      ...
      "name": "samsung_clk_of_add_provider",
      "external": true,
      "loc": "drivers/clk/samsung/clk.c:78",

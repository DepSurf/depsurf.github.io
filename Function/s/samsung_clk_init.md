# Function: <code>samsung_clk_init</code>
...
```c
struct samsung_clk_provider * samsung_clk_init(struct device_node * np, void * base, long unsigned int nr_clks)
```

```json
{
  "name": "samsung_clk_init",
  ...
  "funcs": [
    {
      ...
      "name": "samsung_clk_init",
      "external": true,
      "loc": "drivers/clk/samsung/clk.c:57",

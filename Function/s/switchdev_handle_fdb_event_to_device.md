...
```json
{
  "name": "switchdev_handle_fdb_event_to_device",
  ...
  "funcs": [
    {
      ...
      "name": "switchdev_handle_fdb_event_to_device",
      "external": true,
      "loc": "net/switchdev/switchdev.c:514",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071596877488,
      "name": "switchdev_handle_fdb_event_to_device",
      "external": true,
      "loc": "net/switchdev/switchdev.c:587",
      "file": "net/switchdev/switchdev.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

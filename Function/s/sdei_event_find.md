# Function: <code>sdei_event_find</code>
...
```c
struct sdei_event * sdei_event_find(u32 event_num)
```

```json
{
  "name": "sdei_event_find",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336501477160,
      "name": "sdei_event_find",
      "external": false,
      "loc": "drivers/firmware/arm_sdei.c:170",

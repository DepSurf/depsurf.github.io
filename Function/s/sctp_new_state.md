# Function: <code>sctp_new_state</code>
...
```c
int sctp_new_state(enum ip_conntrack_dir dir, enum sctp_conntrack cur_state, int chunk_type)
```
  ...
  "funcs": [
    {
      ...
      "name": "sctp_new_state",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_proto_sctp.c:201",

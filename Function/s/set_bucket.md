...
```c
void set_bucket(struct dtsec_regs * regs, int bucket, bool enable)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446603336500069952,
      "name": "set_bucket",
      "external": false,
      "loc": "drivers/net/ethernet/freescale/fman/fman_dtsec.c:534",

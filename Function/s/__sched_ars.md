# Function: <code>__sched_ars</code>
...
```c
void __sched_ars(struct acpi_nfit_desc * acpi_desc, unsigned int tmo)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585088640,
      "name": "__sched_ars",
      "external": false,
      "loc": "drivers/acpi/nfit/core.c:3206",

# Function: <code>smp_ipi_demux</code>
...
```json
{
  ...
  "funcs": [
    {
      "addr": 13835058055282513024,
      "name": "smp_ipi_demux",
      "external": true,
      "loc": "arch/powerpc/kernel/smp.c:275",
      ...
      "caller_func": [
        ...
        "arch/powerpc/sysdev/xive/common.c:xive_muxed_ipi_action"
      ]
    }
  ],
  "symbols": [

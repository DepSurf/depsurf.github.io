...
```c
unsigned int sh_pfc_walk_regs(struct sh_pfc * pfc, void (*)(struct sh_pfc *, u32, unsigned int) do_reg)
```

```json
{
  "name": "sh_pfc_walk_regs",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336496641216,
      "name": "sh_pfc_walk_regs",
      "external": false,
      "loc": "drivers/pinctrl/sh-pfc/core.c:639",

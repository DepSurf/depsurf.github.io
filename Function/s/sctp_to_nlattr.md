# Function: <code>sctp_to_nlattr</code>
...
```c
int sctp_to_nlattr(struct sk_buff * skb, struct nlattr * nla, struct nf_conn * ct)
```
  ...
  "funcs": [
    {
      ...
      "name": "sctp_to_nlattr",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_proto_sctp.c:514",

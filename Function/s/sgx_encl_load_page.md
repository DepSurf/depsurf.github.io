  ...
  "funcs": [
    {
      ...
      "name": "sgx_encl_load_page",
      "external": false,
      "loc": "arch/x86/kernel/cpu/sgx/encl.c:93",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579307520,
      "name": "sgx_encl_load_page",
      "external": false,
      "loc": "arch/x86/kernel/cpu/sgx/encl.c:134",
      "file": "arch/x86/kernel/cpu/sgx/encl.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "sgx_encl_load_page",
      "external": false,
      "loc": "arch/x86/kernel/cpu/sgx/encl.c:235",
      "file": "arch/x86/kernel/cpu/sgx/encl.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579436832,
      "name": "sgx_encl_load_page",
      "external": true,
      "loc": "arch/x86/kernel/cpu/sgx/encl.c:289",
      "file": "arch/x86/kernel/cpu/sgx/encl.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "sgx_encl_load_page",
      "external": true,
      "loc": "arch/x86/kernel/cpu/sgx/encl.c:302",
      "file": "arch/x86/kernel/cpu/sgx/encl.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

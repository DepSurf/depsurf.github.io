# Function: <code>smc_phy_powerdown</code>
...
```c
void smc_phy_powerdown(struct net_device * dev)
```

```json
{
  "name": "smc_phy_powerdown",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336500091832,
      "name": "smc_phy_powerdown",
      "external": false,
      "loc": "drivers/net/ethernet/smsc/smc91x.c:977",

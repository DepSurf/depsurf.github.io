...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580345792,
      "name": "set_print_fmt",
      "external": true,
      "loc": "kernel/trace/trace_probe.c:707",
  ...
  "funcs": [
    {
      ...
      "name": "set_print_fmt",
      "external": true,
      "loc": "kernel/trace/trace_probe.c:740",
      "file": "kernel/trace/trace_probe.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580448864,
      "name": "set_print_fmt",
      "external": true,
      "loc": "kernel/trace/trace_probe.c:744",
      "file": "kernel/trace/trace_probe.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580460288,
      "name": "set_print_fmt",
      "external": true,
      "loc": "kernel/trace/trace_probe.c:756",
      "file": "kernel/trace/trace_probe.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "set_print_fmt",
      "external": true,
      "loc": "kernel/trace/trace_probe.c:668",
      "file": "kernel/trace/trace_probe.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

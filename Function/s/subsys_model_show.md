# Function: <code>subsys_model_show</code>
...
```c
ssize_t subsys_model_show(struct device * dev, struct device_attribute * attr, char * buf)
```

```json
{
  "name": "subsys_model_show",
  ...
  "funcs": [
    {
      ...
      "name": "subsys_model_show",
      "external": false,
      "loc": "drivers/nvme/host/core.c:2558",

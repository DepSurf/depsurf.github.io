# Function: <code>serialize_against_pte_lookup</code>
...
```json
{
  "name": "serialize_against_pte_lookup",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 13835058055282756836,
      "name": "serialize_against_pte_lookup",
      "external": true,
      "loc": "arch/powerpc/mm/book3s64/pgtable.c:95",

# Function: <code>sdei_event_destroy</code>
...
```c
void sdei_event_destroy(struct sdei_event * event)
```

```json
{
  "name": "sdei_event_destroy",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336501477944,
      "name": "sdei_event_destroy",
      "external": false,
      "loc": "drivers/firmware/arm_sdei.c:283",

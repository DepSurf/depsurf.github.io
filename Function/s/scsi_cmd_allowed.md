...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071587949299,
      "name": "scsi_cmd_allowed",
      "external": true,
      "loc": "drivers/scsi/scsi_ioctl.c:248",
  ...
  "symbols": [
    {
      "addr": 18446744071587948192,
      "name": "scsi_cmd_allowed.part.0.isra.0",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 237
    },
    {
      "addr": 18446744071587948432,
      "name": "scsi_cmd_allowed",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 48
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591210496,
      "name": "scsi_cmd_allowed",
      "external": true,
      "loc": "drivers/scsi/scsi_ioctl.c:251",
      "file": "drivers/scsi/scsi_ioctl.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

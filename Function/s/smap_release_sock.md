...
```json
{
  "name": "smap_release_sock",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071580621357,
      "name": "smap_release_sock",
      "external": false,
      "loc": "kernel/bpf/sockmap.c:355",
  ...
  "symbols": [
    {
      ...
      "name": "smap_release_sock.part.10",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 165
    }
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580733344,
      "name": "smap_release_sock",
      "external": false,
      "loc": "kernel/bpf/sockmap.c:1470",
      "file": "kernel/bpf/sockmap.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [

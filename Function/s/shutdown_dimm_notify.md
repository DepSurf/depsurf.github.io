# Function: <code>shutdown_dimm_notify</code>
...
```c
void shutdown_dimm_notify(void * data)
```

```json
{
  "name": "shutdown_dimm_notify",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071585085056,
      "name": "shutdown_dimm_notify",
      "external": false,
      "loc": "drivers/acpi/nfit/core.c:1976",

# Function: <code>sev_es_rd_ghcb_msr</code>
...
```c
u64 sev_es_rd_ghcb_msr()
```

```json
{
  "name": "sev_es_rd_ghcb_msr",
  ...
  "funcs": [
    {
      ...
      "name": "sev_es_rd_ghcb_msr",
      "external": false,
      "loc": "arch/x86/kernel/sev-es.c:233",

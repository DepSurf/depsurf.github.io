# Function: <code>static_call_force_reinit</code>
...
```c
void static_call_force_reinit()
```

```json
{
  "name": "static_call_force_reinit",
  ...
  "funcs": [
    {
      ...
      "name": "static_call_force_reinit",
      "external": true,
      "loc": "kernel/static_call_inline.c:23",

# Function: <code>switchdev_handle_port_obj_add_foreign</code>
...
```json
{
  "name": "switchdev_handle_port_obj_add_foreign",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071593579648,
      "name": "switchdev_handle_port_obj_add_foreign",
      "external": true,
      "loc": "net/switchdev/switchdev.c:631",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071596878160,
      "name": "switchdev_handle_port_obj_add_foreign",
      "external": true,
      "loc": "net/switchdev/switchdev.c:704",
      "file": "net/switchdev/switchdev.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

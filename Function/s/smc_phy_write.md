# Function: <code>smc_phy_write</code>
...
```c
void smc_phy_write(struct net_device * dev, int phyaddr, int phyreg, int phydata)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446603336500090592,
      "name": "smc_phy_write",
      "external": false,
      "loc": "drivers/net/ethernet/smsc/smc91x.c:837",

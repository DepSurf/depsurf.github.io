...
```c
long int SYSC_mbind(long unsigned int start, long unsigned int len, long unsigned int mode, const long unsigned int * nmask, long unsigned int maxnode, unsigned int flags)
```

  ...
  "funcs": [
    {
      ...
      "name": "sgx_encl_cpumask",
      "external": true,
      "loc": "arch/x86/kernel/cpu/sgx/encl.c:903",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579446224,
      "name": "sgx_encl_cpumask",
      "external": true,
      "loc": "arch/x86/kernel/cpu/sgx/encl.c:905",
      "file": "arch/x86/kernel/cpu/sgx/encl.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579475984,
      "name": "sgx_encl_cpumask",
      "external": true,
      "loc": "arch/x86/kernel/cpu/sgx/encl.c:925",
      "file": "arch/x86/kernel/cpu/sgx/encl.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>subsys_serial_show</code>
...
```c
ssize_t subsys_serial_show(struct device * dev, struct device_attribute * attr, char * buf)
```

```json
{
  "name": "subsys_serial_show",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586454576,
      "name": "subsys_serial_show",
      "external": false,
      "loc": "drivers/nvme/host/core.c:2559",

# Function: <code>send_vblank_event</code>
...
```c
void send_vblank_event(struct drm_device * dev, struct drm_pending_vblank_event * e, u64 seq, ktime_t now)
```

```json
{
  "name": "send_vblank_event",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071592170288,
      "name": "send_vblank_event",
      "external": false,
      "loc": "drivers/gpu/drm/drm_vblank.c:1014",

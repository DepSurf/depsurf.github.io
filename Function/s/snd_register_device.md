# Function: <code>snd_register_device</code>
  ...
  "funcs": [
    {
      ...
      "name": "snd_register_device",
      "external": true,
      "loc": "sound/core/sound.c:246",
      "file": "sound/core/sound.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "sound/core/control.c:snd_ctl_dev_register",
        "sound/core/timer.c:alsa_timer_init",
        "sound/core/pcm.c:snd_pcm_dev_register",
        "sound/core/pcm.c:snd_pcm_dev_register",
        "sound/core/compress_offload.c:snd_compress_dev_register"
      ]
    }
  ],
  "symbols": [

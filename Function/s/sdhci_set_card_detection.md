# Function: <code>sdhci_set_card_detection</code>
...
```c
void sdhci_set_card_detection(struct sdhci_host * host, bool enable)
```

```json
{
  "name": "sdhci_set_card_detection",
  ...
  "funcs": [
    {
      ...
      "name": "sdhci_set_card_detection",
      "external": false,
      "loc": "drivers/mmc/host/sdhci.c:150",

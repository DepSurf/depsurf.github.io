# Function: <code>__ppc64_runlatch_off</code>
...
```c
void __ppc64_runlatch_off()
```

```json
{
  "name": "__ppc64_runlatch_off",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282306576,
      "name": "__ppc64_runlatch_off",
      "external": true,
      "loc": "arch/powerpc/kernel/process.c:2127",

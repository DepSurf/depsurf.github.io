...
```json
{
  "name": "poll_state_synchronize_rcu_full",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071580640533,
      "name": "poll_state_synchronize_rcu_full",
      "external": true,
      "loc": "kernel/rcu/tree.c:3774",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580791797,
      "name": "poll_state_synchronize_rcu_full",
      "external": true,
      "loc": "kernel/rcu/tree.c:3846",
      "file": "kernel/rcu/tree.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "kernel/rcu/tree.c:cond_synchronize_rcu_expedited_full",

# Function: <code>pnv_ioda_reserve_m64_pe</code>
...
```c
void pnv_ioda_reserve_m64_pe(struct pci_bus * bus, long unsigned int * pe_bitmap, bool all)
```

```json
{
  "name": "pnv_ioda_reserve_m64_pe",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055283029840,
      "name": "pnv_ioda_reserve_m64_pe",
      "external": false,
      "loc": "arch/powerpc/platforms/powernv/pci-ioda.c:336",

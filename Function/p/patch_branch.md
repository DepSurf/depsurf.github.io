# Function: <code>patch_branch</code>
...
```c
int patch_branch(unsigned int * addr, long unsigned int target, int flags)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 13835058055282847552,
      "name": "patch_branch",
      "external": true,
      "loc": "arch/powerpc/lib/code-patching.c:197",

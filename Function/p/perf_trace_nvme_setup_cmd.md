# Function: <code>perf_trace_nvme_setup_cmd</code>
...
```c
void perf_trace_nvme_setup_cmd(void * __data, struct request * req, struct nvme_command * cmd)
```

```json
{
  "name": "perf_trace_nvme_setup_cmd",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586470384,
      "name": "perf_trace_nvme_setup_cmd",
      "external": false,

# Function: <code>pnv_pci_unlink_table_and_group</code>
...
```c
void pnv_pci_unlink_table_and_group(struct iommu_table * tbl, struct iommu_table_group * table_group)
```

```json
{
  "name": "pnv_pci_unlink_table_and_group",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055283063392,
      "name": "pnv_pci_unlink_table_and_group",
      "external": true,
      "loc": "arch/powerpc/platforms/powernv/pci-ioda-tce.c:351",

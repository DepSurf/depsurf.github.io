# Function: <code>__put_cpu_fpsimd_context</code>
...
```c
void __put_cpu_fpsimd_context()
```

```json
{
  "name": "__put_cpu_fpsimd_context",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446603336490185464,
      "name": "__put_cpu_fpsimd_context",
      "external": false,
      "loc": "arch/arm64/kernel/fpsimd.c:174",

# Function: <code>perf_trace_nvme_complete_rq</code>
...
```c
void perf_trace_nvme_complete_rq(void * __data, struct request * req)
```

```json
{
  "name": "perf_trace_nvme_complete_rq",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586469584,
      "name": "perf_trace_nvme_complete_rq",
      "external": false,

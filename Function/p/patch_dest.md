...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "patch_dest",
      "external": false,
      "loc": "arch/x86/kernel/callthunks.c:184",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071595968226,
      "name": "patch_dest.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 20
    }
  ...
  "funcs": [
    {
      ...
      "name": "patch_dest",
      "external": false,
      "loc": "arch/x86/kernel/callthunks.c:179",
      "file": "arch/x86/kernel/callthunks.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

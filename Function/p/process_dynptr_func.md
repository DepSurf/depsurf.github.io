...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "process_dynptr_func",
      "external": true,
      "loc": "kernel/bpf/verifier.c:6120",
  ...
  "symbols": [
    {
      "addr": 18446744071596019602,
      "name": "process_dynptr_func.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 51
    },
    {
      "addr": 18446744071581897744,
      "name": "process_dynptr_func",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 1349
  ...
  "funcs": [
    {
      ...
      "name": "process_dynptr_func",
      "external": false,
      "loc": "kernel/bpf/verifier.c:7188",
      "file": "kernel/bpf/verifier.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "process_dynptr_func",
      "external": false,
      "loc": "kernel/bpf/verifier.c:7565",
      "file": "kernel/bpf/verifier.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

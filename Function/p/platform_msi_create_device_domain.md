...
```json
{
  "name": "platform_msi_create_device_domain",
  ...
  "funcs": [
    {
      ...
      "name": "platform_msi_create_device_domain",
      "external": true,
      "loc": "drivers/base/platform-msi.c:333",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585077328,
      "name": "platform_msi_create_device_domain",
      "external": true,
      "loc": "drivers/base/platform-msi.c:332",
      "file": "drivers/base/platform-msi.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585830928,
      "name": "platform_msi_create_device_domain",
      "external": true,
      "loc": "drivers/base/platform-msi.c:324",
      "file": "drivers/base/platform-msi.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

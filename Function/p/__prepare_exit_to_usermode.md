# Function: <code>__prepare_exit_to_usermode</code>
...
```c
void __prepare_exit_to_usermode(struct pt_regs * regs)
```

```json
{
  "name": "__prepare_exit_to_usermode",
  ...
  "funcs": [
    {
      ...
      "name": "__prepare_exit_to_usermode",
      "external": false,
      "loc": "arch/x86/entry/common.c:264",

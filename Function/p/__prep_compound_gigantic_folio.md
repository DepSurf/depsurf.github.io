...
```json
{
  "name": "__prep_compound_gigantic_folio",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596040354,
      "name": "__prep_compound_gigantic_folio.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 72
    }

# Function: <code>pnv_eeh_enable_phbs</code>
...
```c
void pnv_eeh_enable_phbs()
```

```json
{
  "name": "pnv_eeh_enable_phbs",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055283074528,
      "name": "pnv_eeh_enable_phbs",
      "external": true,
      "loc": "arch/powerpc/platforms/powernv/eeh-powernv.c:200",

# Function: <code>pcibios_bus_report_status</code>
...
```json
{
  "name": "pcibios_bus_report_status",
  ...
  "funcs": [
    {
      ...
      "name": "pcibios_bus_report_status",
      "external": false,
      "loc": "arch/arm/kernel/bios32.c:26",
      "file": "arch/arm/kernel/bios32.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "arch/arm/kernel/bios32.c:pcibios_report_status",

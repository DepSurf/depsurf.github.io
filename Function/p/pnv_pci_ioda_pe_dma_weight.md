# Function: <code>pnv_pci_ioda_pe_dma_weight</code>
...
```c
unsigned int pnv_pci_ioda_pe_dma_weight(struct pnv_ioda_pe * pe)
```

```json
{
  "name": "pnv_pci_ioda_pe_dma_weight",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055283033344,
      "name": "pnv_pci_ioda_pe_dma_weight",
      "external": false,
      "loc": "arch/powerpc/platforms/powernv/pci-ioda.c:2162",

# Function: <code>page_pool_get_stats</code>
...
```json
{
  "name": "page_pool_get_stats",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071594058720,
      "name": "page_pool_get_stats",
      "external": true,
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071594849328,
      "name": "page_pool_get_stats",
      "external": true,
      "loc": "net/core/page_pool.c:74",
      "file": "net/core/page_pool.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
<code>struct page_pool * pool</code> ➡️ <code>const struct page_pool * pool</code>
</li>
</ul>
</details>
</li>

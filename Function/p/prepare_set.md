# Function: <code>prepare_set</code>
  ...
  "funcs": [
    {
      ...
      "name": "prepare_set",
      "external": false,
      "loc": "arch/x86/kernel/cpu/mtrr/generic.c:726",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579156752,
      "name": "prepare_set",
      "external": false,
      "loc": "arch/x86/kernel/cpu/mtrr/generic.c:729",
      "file": "arch/x86/kernel/cpu/mtrr/generic.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "prepare_set",
      "external": false,
      "loc": "arch/x86/kernel/cpu/mtrr/generic.c:730",
      "file": "arch/x86/kernel/cpu/mtrr/generic.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

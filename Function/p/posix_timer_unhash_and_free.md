# Function: <code>posix_timer_unhash_and_free</code>
...
```c
void posix_timer_unhash_and_free(struct k_itimer * tmr)
```

```json
{
  "name": "posix_timer_unhash_and_free",
  ...
  "funcs": [
    {
      ...
      "name": "posix_timer_unhash_and_free",
      "external": false,
      "loc": "kernel/time/posix-timers.c:429",

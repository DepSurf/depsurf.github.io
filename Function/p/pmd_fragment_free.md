# Function: <code>pmd_fragment_free</code>
...
```c
void pmd_fragment_free(long unsigned int * pmd)
```

```json
{
  "name": "pmd_fragment_free",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282757888,
      "name": "pmd_fragment_free",
      "external": true,
      "loc": "arch/powerpc/mm/book3s64/pgtable.c:340",

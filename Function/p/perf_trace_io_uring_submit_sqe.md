# Function: <code>perf_trace_io_uring_submit_sqe</code>
...
```c
void perf_trace_io_uring_submit_sqe(void * __data, void * ctx, u8 opcode, u64 user_data, bool force_nonblock, bool sq_thread)
```

```json
{
  "name": "perf_trace_io_uring_submit_sqe",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071582491008,
      "name": "perf_trace_io_uring_submit_sqe",
      "external": false,
...
```c
void perf_trace_io_uring_submit_sqe(void * __data, void * ctx, void * req, u8 opcode, u64 user_data, u32 flags, bool force_nonblock, bool sq_thread)
```
...
```c
void perf_trace_io_uring_submit_sqe(void * __data, void * ctx, void * req, long long unsigned int user_data, u8 opcode, u32 flags, bool force_nonblock, bool sq_thread)
```
...
```c
void perf_trace_io_uring_submit_sqe(void * __data, struct io_kiocb * req, bool force_nonblock)
```

...
```json
{
  "name": "pci_parse_request_of_pci_ranges",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446603336496946680,
      "name": "pci_parse_request_of_pci_ranges",
      "external": true,
      "loc": "drivers/pci/of.c:483",

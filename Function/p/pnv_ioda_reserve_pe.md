# Function: <code>pnv_ioda_reserve_pe</code>
...
```c
void pnv_ioda_reserve_pe(struct pnv_phb * phb, int pe_no)
```

```json
{
  "name": "pnv_ioda_reserve_pe",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055283029520,
      "name": "pnv_ioda_reserve_pe",
      "external": false,
      "loc": "arch/powerpc/platforms/powernv/pci-ioda.c:158",

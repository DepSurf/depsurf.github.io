# Function: <code>pnv_pci_ioda2_unset_window</code>
...
```c
long int pnv_pci_ioda2_unset_window(struct iommu_table_group * table_group, int num)
```

```json
{
  "name": "pnv_pci_ioda2_unset_window",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055283036720,
      "name": "pnv_pci_ioda2_unset_window",
      "external": false,
      "loc": "arch/powerpc/platforms/powernv/pci-ioda.c:2491",

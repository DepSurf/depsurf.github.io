# Function: <code>perf_trace_nvme_sq</code>
...
```c
void perf_trace_nvme_sq(void * __data, struct request * req, __le16 sq_head, int sq_tail)
```

```json
{
  "name": "perf_trace_nvme_sq",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586470000,
      "name": "perf_trace_nvme_sq",
      "external": false,

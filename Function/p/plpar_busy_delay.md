# Function: <code>plpar_busy_delay</code>
...
```c
unsigned int plpar_busy_delay(int rc)
```

```json
{
  "name": "plpar_busy_delay",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282953152,
      "name": "plpar_busy_delay",
      "external": false,
      "loc": "arch/powerpc/sysdev/xive/spapr.c:128",

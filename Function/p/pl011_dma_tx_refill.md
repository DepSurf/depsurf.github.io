# Function: <code>pl011_dma_tx_refill</code>
...
```c
int pl011_dma_tx_refill(struct uart_amba_port * uap)
```

```json
{
  "name": "pl011_dma_tx_refill",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336498629448,
      "name": "pl011_dma_tx_refill",
      "external": false,
      "loc": "drivers/tty/serial/amba-pl011.c:598",

# Function: <code>perf_trace_nvme_async_event</code>
...
```c
void perf_trace_nvme_async_event(void * __data, struct nvme_ctrl * ctrl, u32 result)
```

```json
{
  "name": "perf_trace_nvme_async_event",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586451552,
      "name": "perf_trace_nvme_async_event",
      "external": false,

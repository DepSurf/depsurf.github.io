...
```json
{
  "name": "__printk_cpu_sync_try_get",
  ...
  "funcs": [
    {
      ...
      "name": "__printk_cpu_sync_try_get",
      "external": true,
      "loc": "kernel/printk/printk.c:3872",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580471680,
      "name": "__printk_cpu_sync_try_get",
      "external": true,
      "loc": "kernel/printk/printk.c:4135",
      "file": "kernel/printk/printk.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "__printk_cpu_sync_try_get",
      "external": true,
      "loc": "kernel/printk/printk.c:4176",
      "file": "kernel/printk/printk.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "__printk_cpu_sync_try_get",
      "external": true,
      "loc": "kernel/printk/printk.c:4293",
      "file": "kernel/printk/printk.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

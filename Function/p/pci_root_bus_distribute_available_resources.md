...
```json
{
  "name": "pci_root_bus_distribute_available_resources",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588219152,
      "name": "pci_root_bus_distribute_available_resources",
      "external": false,
      "loc": "drivers/pci/setup-bus.c:2015",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588494640,
      "name": "pci_root_bus_distribute_available_resources",
      "external": false,
      "loc": "drivers/pci/setup-bus.c:2006",
      "file": "drivers/pci/setup-bus.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588793008,
      "name": "pci_root_bus_distribute_available_resources",
      "external": false,
      "loc": "drivers/pci/setup-bus.c:2016",
      "file": "drivers/pci/setup-bus.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>arch_timer_common_init</code>
...
```c
int arch_timer_common_init()
```

```json
{
  "name": "arch_timer_common_init",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336511295256,
      "name": "arch_timer_common_init",
      "external": false,
      "loc": "drivers/clocksource/arm_arch_timer.c:1200",

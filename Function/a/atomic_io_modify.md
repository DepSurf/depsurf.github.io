# Function: <code>atomic_io_modify</code>
...
```c
void atomic_io_modify(void * reg, u32 mask, u32 set)
```

```json
{
  "name": "atomic_io_modify",
  ...
  "funcs": [
    {
      ...
      "caller_func": [
        ...
        "drivers/clocksource/timer-orion.c:orion_clkevt_shutdown",

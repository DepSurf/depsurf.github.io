# Function: <code>advk_pcie_link_up</code>
...
```c
int advk_pcie_link_up(struct advk_pcie * pcie)
```

```json
{
  "name": "advk_pcie_link_up",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336497101928,
      "name": "advk_pcie_link_up",
      "external": false,
      "loc": "drivers/pci/controller/pci-aardvark.c:216",

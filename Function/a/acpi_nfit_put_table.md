# Function: <code>acpi_nfit_put_table</code>
...
```c
void acpi_nfit_put_table(void * table)
```

```json
{
  "name": "acpi_nfit_put_table",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071585107841,
      "name": "acpi_nfit_put_table",
      "external": false,
      "loc": "drivers/acpi/nfit/core.c:3577",

# Function: <code>__apply_microcode</code>
...
```c
enum ucode_state __apply_microcode(struct ucode_cpu_info * uci, struct microcode_intel * mc, u32 * cur_rev)
```

```json
{
  "name": "__apply_microcode",
  ...
  "funcs": [
    {
      ...
      "name": "__apply_microcode",
      "external": false,
      "loc": "arch/x86/kernel/cpu/microcode/intel.c:302",
      ...
      "caller_func": [
        "arch/x86/kernel/cpu/microcode/intel.c:apply_microcode_late",

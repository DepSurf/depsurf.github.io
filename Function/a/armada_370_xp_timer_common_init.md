# Function: <code>armada_370_xp_timer_common_init</code>
...
```c
int armada_370_xp_timer_common_init(struct device_node * np)
```

```json
{
  "name": "armada_370_xp_timer_common_init",
  ...
  "funcs": [
    {
      ...
      "name": "armada_370_xp_timer_common_init",
      "external": false,
      "loc": "drivers/clocksource/timer-armada-370-xp.c:243",

...
```json
{
  ...
  "symbols": [
    {
      "addr": 18446744071593824469,
      "name": "apply_retpolines.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 307
    },
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579214816,
      "name": "apply_retpolines",
      "external": true,
      "loc": "arch/x86/kernel/alternative.c:528",
      "file": "arch/x86/kernel/alternative.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "apply_retpolines",
      "external": true,
      "loc": "arch/x86/kernel/alternative.c:642",
      "file": "arch/x86/kernel/alternative.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "apply_retpolines",
      "external": true,
      "loc": "arch/x86/kernel/alternative.c:727",
      "file": "arch/x86/kernel/alternative.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>alloc_shstk</code>
...
```c
long unsigned int alloc_shstk(long unsigned int addr, long unsigned int size, long unsigned int token_offset, bool set_res_tok)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579672784,
      "name": "alloc_shstk",
      "external": false,
      "loc": "arch/x86/kernel/shstk.c:100",

...
```c
int ars_start(struct acpi_nfit_desc * acpi_desc, struct nfit_spa * nfit_spa, enum nfit_ars_state req_type)
```
  ...
  "funcs": [
    {
      ...
      "name": "ars_start",
      "external": false,
      "loc": "drivers/acpi/nfit/core.c:2661",

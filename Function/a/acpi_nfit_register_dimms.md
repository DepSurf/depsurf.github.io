# Function: <code>acpi_nfit_register_dimms</code>
...
```c
int acpi_nfit_register_dimms(struct acpi_nfit_desc * acpi_desc)
```

```json
{
  "name": "acpi_nfit_register_dimms",
  ...
  "funcs": [
    {
      ...
      "name": "acpi_nfit_register_dimms",
      "external": false,
      "loc": "drivers/acpi/nfit/core.c:2012",

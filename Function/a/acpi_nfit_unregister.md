# Function: <code>acpi_nfit_unregister</code>
...
```c
void acpi_nfit_unregister(void * data)
```

```json
{
  "name": "acpi_nfit_unregister",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071585085024,
      "name": "acpi_nfit_unregister",
      "external": false,
      "loc": "drivers/acpi/nfit/core.c:3365",

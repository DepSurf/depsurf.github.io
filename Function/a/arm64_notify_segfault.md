# Function: <code>arm64_notify_segfault</code>
...
```c
void arm64_notify_segfault(long unsigned int addr)
```

```json
{
  "name": "arm64_notify_segfault",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336490242440,
      "name": "arm64_notify_segfault",
      "external": true,
      "loc": "arch/arm64/kernel/traps.c:382",

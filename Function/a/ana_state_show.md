# Function: <code>ana_state_show</code>
...
```c
ssize_t ana_state_show(struct device * dev, struct device_attribute * attr, char * buf)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586485488,
      "name": "ana_state_show",
      "external": false,
      "loc": "drivers/nvme/host/multipath.c:638",

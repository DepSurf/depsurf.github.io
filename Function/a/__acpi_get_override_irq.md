...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "__acpi_get_override_irq",
      "external": false,
      "loc": "arch/x86/kernel/apic/io_apic.c:828",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071591261092,
      "name": "__acpi_get_override_irq.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 46
    }
  ...
  "funcs": [
    {
      ...
      "name": "__acpi_get_override_irq",
      "external": false,
      "loc": "arch/x86/kernel/apic/io_apic.c:829",
      "file": "arch/x86/kernel/apic/io_apic.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "__acpi_get_override_irq",
      "external": false,
      "loc": "arch/x86/kernel/apic/io_apic.c:830",
      "file": "arch/x86/kernel/apic/io_apic.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

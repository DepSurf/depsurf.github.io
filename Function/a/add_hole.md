...
```c
void add_hole(struct drm_mm_node * node)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592087552,
      "name": "add_hole",
      "external": false,
      "loc": "drivers/gpu/drm/drm_mm.c:266",
      "file": "drivers/gpu/drm/drm_mm.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "drivers/gpu/drm/drm_mm.c:drm_mm_init",

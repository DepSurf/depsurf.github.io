# Function: <code>apic_mem_wait_icr_idle</code>
...
```c
void apic_mem_wait_icr_idle()
```

```json
{
  "name": "apic_mem_wait_icr_idle",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071579540945,
      "name": "apic_mem_wait_icr_idle",
      "external": true,
      "loc": "arch/x86/kernel/apic/ipi.c:128",

# Function: <code>apparmor_secid_to_secctx</code>
  ...
  "funcs": [
    {
      ...
      "name": "apparmor_secid_to_secctx",
      "external": true,
      "loc": "security/apparmor/secid.c:76",
  ...
  "funcs": [
    {
      ...
      "name": "apparmor_secid_to_secctx",
      "external": true,
      "loc": "security/apparmor/secid.c:72",
      "file": "security/apparmor/secid.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585298112,
      "name": "apparmor_secid_to_secctx",
      "external": true,
      "loc": "security/apparmor/secid.c:65",
      "file": "security/apparmor/secid.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586270656,
      "name": "apparmor_secid_to_secctx",
      "external": true,
      "loc": "security/apparmor/secid.c:64",
      "file": "security/apparmor/secid.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

...
```json
{
  "name": "aa_sock_create_perm",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071582584288,
      "name": "aa_sock_create_perm",
      "external": true,
      "loc": "security/apparmor/net.c:252",
  ...
  "funcs": [
    {
      ...
      "name": "aa_sock_create_perm",
      "external": true,
      "loc": "security/apparmor/net.c:251",
      "file": "security/apparmor/net.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

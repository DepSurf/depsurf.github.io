# Function: <code>apic_mem_wait_icr_idle_timeout</code>
...
```c
u32 apic_mem_wait_icr_idle_timeout()
```

```json
{
  "name": "apic_mem_wait_icr_idle_timeout",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071579540993,
      "name": "apic_mem_wait_icr_idle_timeout",
      "external": true,
      "loc": "arch/x86/kernel/apic/ipi.c:115",

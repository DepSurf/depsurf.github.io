# Function: <code>ars_complete</code>
...
```c
void ars_complete(struct acpi_nfit_desc * acpi_desc, struct nfit_spa * nfit_spa)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585087376,
      "name": "ars_complete",
      "external": false,
      "loc": "drivers/acpi/nfit/core.c:2725",

...
```json
{
  "name": "amd_iommu_domain_flush_pages",
  ...
  "funcs": [
    {
      ...
      "name": "amd_iommu_domain_flush_pages",
      "external": true,
      "loc": "drivers/iommu/amd/iommu.c:1497",
  ...
  "symbols": [
    {
      "addr": 18446744071597677228,
      "name": "amd_iommu_domain_flush_pages.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 52
    },
    {
      "addr": 18446744071590733504,
      "name": "amd_iommu_domain_flush_pages",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 420

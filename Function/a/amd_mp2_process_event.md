# Function: <code>amd_mp2_process_event</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "amd_mp2_process_event",
      "external": true,
      "loc": "drivers/i2c/busses/i2c-amd-mp2-pci.c:190",
  ...
  "symbols": [
    {
      "addr": 18446744071587661620,
      "name": "amd_mp2_process_event.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 226
    },
    {
      "addr": 18446744071587661024,
      "name": "amd_mp2_process_event",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 287

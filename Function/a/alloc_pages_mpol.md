# Function: <code>alloc_pages_mpol</code>
...
```c
struct page * alloc_pages_mpol(gfp_t gfp, unsigned int order, struct mempolicy * pol, long unsigned int ilx, int nid)
```

```json
{
  "name": "alloc_pages_mpol",

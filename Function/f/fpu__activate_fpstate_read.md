...
```json
{
  "name": "fpu__activate_fpstate_read",
  ...
  "funcs": [
    {
      ...
      "name": "fpu__activate_fpstate_read",
      "external": true,
      "loc": "arch/x86/kernel/fpu/core.c:304",
  ...
  "funcs": [
    {
      ...
      "name": "fpu__activate_fpstate_read",
      "external": true,
      "loc": "arch/x86/kernel/fpu/core.c:325",
      "file": "arch/x86/kernel/fpu/core.c",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579078448,
      "name": "fpu__activate_fpstate_read",
      "external": true,
      "loc": "arch/x86/kernel/fpu/core.c:270",
      "file": "arch/x86/kernel/fpu/core.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579070144,
      "name": "fpu__activate_fpstate_read",
      "external": true,
      "loc": "arch/x86/kernel/fpu/core.c:263",
      "file": "arch/x86/kernel/fpu/core.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [

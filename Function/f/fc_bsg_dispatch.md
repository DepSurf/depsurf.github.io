# Function: <code>fc_bsg_dispatch</code>
...
```c
int fc_bsg_dispatch(struct bsg_job * job)
```

```json
{
  "name": "fc_bsg_dispatch",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586251088,
      "name": "fc_bsg_dispatch",
      "external": false,
      "loc": "drivers/scsi/scsi_transport_fc.c:3733",

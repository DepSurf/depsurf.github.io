  ...
  "funcs": [
    {
      ...
      "name": "fpu_clone",
      "external": true,
      "loc": "arch/x86/kernel/fpu/core.c:251",
  ...
  "funcs": [
    {
      ...
      "name": "fpu_clone",
      "external": true,
      "loc": "arch/x86/kernel/fpu/core.c:559",
      "file": "arch/x86/kernel/fpu/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "fpu_clone",
      "external": true,
      "loc": "arch/x86/kernel/fpu/core.c:556",
      "file": "arch/x86/kernel/fpu/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "fpu_clone",
      "external": true,
      "loc": "arch/x86/kernel/fpu/core.c:584",
      "file": "arch/x86/kernel/fpu/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

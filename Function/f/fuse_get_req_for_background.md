...
```json
{
  "name": "fuse_get_req_for_background",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071582055008,
      "name": "fuse_get_req_for_background",
      "external": true,
      "loc": "fs/fuse/dev.c:208",
      "file": "fs/fuse/dev.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582266816,
      "name": "fuse_get_req_for_background",
      "external": true,
      "loc": "fs/fuse/dev.c:188",
      "file": "fs/fuse/dev.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582887536,
      "name": "fuse_get_req_for_background",
      "external": true,
      "loc": "fs/fuse/dev.c:238",
      "file": "fs/fuse/dev.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

...
```json
{
  "name": "futex_parse_waitv",
  "collision_type": "Unique Static",
  "inline_type": "Full",
  "funcs": [
    {
      "addr": 18446744071580629429,
      "name": "futex_parse_waitv",
      "external": false,
      "loc": "kernel/futex/syscalls.c:197",
  ...
  "funcs": [
    {
      ...
      "name": "futex_parse_waitv",
      "external": true,
      "loc": "kernel/futex/syscalls.c:192",
      "file": "kernel/futex/syscalls.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>find_num_contig</code>
...
```c
int find_num_contig(struct mm_struct * mm, long unsigned int addr, pte_t * ptep, size_t * pgsize)
```

```json
{
  "name": "find_num_contig",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336490354544,
      "name": "find_num_contig",
      "external": false,
      "loc": "arch/arm64/mm/hugetlbpage.c:66",

# Function: <code>__fd_array_map_delete_elem</code>
...
```c
long int __fd_array_map_delete_elem(struct bpf_map * map, void * key, bool need_defer)
```

```json
{
  "name": "__fd_array_map_delete_elem",

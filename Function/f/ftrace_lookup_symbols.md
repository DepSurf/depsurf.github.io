...
```json
{
  "name": "ftrace_lookup_symbols",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071581020448,
      "name": "ftrace_lookup_symbols",
      "external": true,
  ...
  "funcs": [
    {
      ...
      "name": "ftrace_lookup_symbols",
      "external": true,
      "loc": "kernel/trace/ftrace.c:8334",
      "file": "kernel/trace/ftrace.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071581415504,
      "name": "ftrace_lookup_symbols",
      "external": true,
      "loc": "kernel/trace/ftrace.c:8148",
      "file": "kernel/trace/ftrace.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579187209,
      "name": "fpstate_reset",
      "external": true,
      "loc": "arch/x86/kernel/fpu/core.c:531",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579243342,
      "name": "fpstate_reset",
      "external": true,
      "loc": "arch/x86/kernel/fpu/core.c:528",
      "file": "arch/x86/kernel/fpu/core.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "arch/x86/kernel/fpu/core.c:fpu_flush_thread",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579278734,
      "name": "fpstate_reset",
      "external": true,
      "loc": "arch/x86/kernel/fpu/core.c:529",
      "file": "arch/x86/kernel/fpu/core.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "arch/x86/kernel/fpu/core.c:fpu_flush_thread",

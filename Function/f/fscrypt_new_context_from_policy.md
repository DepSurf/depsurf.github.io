...
```json
{
  "name": "fscrypt_new_context_from_policy",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582599120,
      "name": "fscrypt_new_context_from_policy",
      "external": false,
      "loc": "fs/crypto/policy.c:230",
      "file": "fs/crypto/policy.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

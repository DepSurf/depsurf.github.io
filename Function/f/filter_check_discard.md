# Function: <code>filter_check_discard</code>
...
```c
int filter_check_discard(struct trace_event_file * file, void * rec, struct ring_buffer * buffer, struct ring_buffer_event * event)
```

```json
{
  "name": "filter_check_discard",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071580205600,
      "name": "filter_check_discard",
      "external": true,

...
```json
{
  "name": "fb_modesetting_disabled",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588505520,
      "name": "fb_modesetting_disabled",
      "external": true,
      "loc": "drivers/video/fbdev/core/fbmem.c:1853",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071589085008,
      "name": "fb_modesetting_disabled",
      "external": true,
      "loc": "drivers/video/fbdev/core/fbmem.c:649",
      "file": "drivers/video/fbdev/core/fbmem.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

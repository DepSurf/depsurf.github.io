# Function: <code>fec_enet_update_ethtool_stats</code>
...
```c
void fec_enet_update_ethtool_stats(struct net_device * dev)
```

```json
{
  "name": "fec_enet_update_ethtool_stats",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336500011344,
      "name": "fec_enet_update_ethtool_stats",
      "external": false,
      "loc": "drivers/net/ethernet/freescale/fec_main.c:2379",

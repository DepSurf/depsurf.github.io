...
```json
{
  "name": "__fwnode_property_read_string_array",
  ...
  "funcs": [
    {
      ...
      "name": "__fwnode_property_read_string_array",
      "external": false,
      "loc": "drivers/base/property.c:536",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584755360,
      "name": "__fwnode_property_read_string_array",
      "external": false,
      "loc": "drivers/base/property.c:543",
      "file": "drivers/base/property.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

...
```json
{
  "name": "firmware_request_builtin_buf",
  ...
  "funcs": [
    {
      ...
      "name": "firmware_request_builtin_buf",
      "external": true,
      "loc": "drivers/base/firmware_loader/builtin/main.c:86",

# Function: <code>free_pgtable</code>
...
```c
void free_pgtable(u64 * pt, int level)
```
  ...
  "funcs": [
    {
      ...
      "name": "free_pgtable",
      "external": false,
      "loc": "drivers/iommu/amd/io_pgtable_v2.c:113",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071590409968,
      "name": "free_pgtable",
      "external": false,
      "loc": "drivers/iommu/amd/io_pgtable_v2.c:107",
      "file": "drivers/iommu/amd/io_pgtable_v2.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

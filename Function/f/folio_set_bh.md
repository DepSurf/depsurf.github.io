...
```json
{
  ...
  "symbols": [
    {
      "addr": 18446744071596574948,
      "name": "folio_set_bh.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 25
    },
    {
      "addr": 18446744071584126240,
      "name": "folio_set_bh",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 113
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584345043,
      "name": "folio_set_bh",
      "external": true,
      "loc": "fs/buffer.c:1537",
      "file": "fs/buffer.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "fs/buffer.c:folio_alloc_buffers"

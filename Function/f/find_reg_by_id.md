# Function: <code>find_reg_by_id</code>
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446603336490522288,
      "name": "find_reg_by_id",
      "external": true,
      "loc": "arch/arm64/kvm/sys_regs.c:2340",
      ...
      "caller_func": [
        ...
        "arch/arm64/kvm/vgic-sys-reg-v3.c:vgic_v3_cpu_sysregs_uaccess",
        "arch/arm64/kvm/vgic-sys-reg-v3.c:vgic_v3_has_cpu_sysregs_attr"
      ]
    }
  ],
  "symbols": [

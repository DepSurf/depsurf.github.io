# Function: <code>flush_and_reload_slb</code>
...
```c
void flush_and_reload_slb()
```

```json
{
  "name": "flush_and_reload_slb",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 13835058055282402816,
      "name": "flush_and_reload_slb",
      "external": true,
      "loc": "arch/powerpc/kernel/mce_power.c:62",

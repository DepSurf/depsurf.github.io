...
```json
{
  "name": "fbcon_modechange_possible",
  ...
  "funcs": [
    {
      ...
      "name": "fbcon_modechange_possible",
      "external": true,
      "loc": "drivers/video/fbdev/core/fbcon.c:2761",
  ...
  "funcs": [
    {
      ...
      "name": "fbcon_modechange_possible",
      "external": true,
      "loc": "drivers/video/fbdev/core/fbcon.c:2759",
      "file": "drivers/video/fbdev/core/fbcon.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588824160,
      "name": "fbcon_modechange_possible",
      "external": true,
      "loc": "drivers/video/fbdev/core/fbcon.c:2752",
      "file": "drivers/video/fbdev/core/fbcon.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

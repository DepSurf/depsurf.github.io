...
```json
{
  "name": "futex_cmpxchg_value_locked",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071581069776,
      "name": "futex_cmpxchg_value_locked",
      "external": true,
      "loc": "kernel/futex/core.c:453",
      "file": "kernel/futex/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>fc_terminate_rport_io</code>
...
```c
void fc_terminate_rport_io(struct fc_rport * rport)
```

```json
{
  "name": "fc_terminate_rport_io",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586241568,
      "name": "fc_terminate_rport_io",
      "external": false,
      "loc": "drivers/scsi/scsi_transport_fc.c:2462",
      "file": "drivers/scsi/scsi_transport_fc.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "drivers/scsi/scsi_transport_fc.c:fc_timeout_fail_rport_io",

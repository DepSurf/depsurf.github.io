# Function: <code>futex_get_value_locked</code>
...
```c
int futex_get_value_locked(u32 * dest, u32 * from)
```

```json
{
  "name": "futex_get_value_locked",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071580627264,
      "name": "futex_get_value_locked",
      "external": true,
      "loc": "kernel/futex/core.c:451",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071581070944,
      "name": "futex_get_value_locked",
      "external": true,
      "loc": "kernel/futex/core.c:464",
      "file": "kernel/futex/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

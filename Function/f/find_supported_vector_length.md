# Function: <code>find_supported_vector_length</code>
...
```c
unsigned int find_supported_vector_length(unsigned int vl)
```

```json
{
  "name": "find_supported_vector_length",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336490184704,
      "name": "find_supported_vector_length",
      "external": false,
      "loc": "arch/arm64/kernel/fpsimd.c:322",

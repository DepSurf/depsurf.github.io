# Function: <code>firmware_rev_show</code>
...
```c
ssize_t firmware_rev_show(struct device * dev, struct device_attribute * attr, char * buf)
```

```json
{
  "name": "firmware_rev_show",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586455152,
      "name": "firmware_rev_show",
      "external": false,
      "loc": "drivers/nvme/host/core.c:3160",

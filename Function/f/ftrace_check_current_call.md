# Function: <code>ftrace_check_current_call</code>
...
```c
int ftrace_check_current_call(long unsigned int hook_pos, unsigned int * expected)
```

```json
{
  "name": "ftrace_check_current_call",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446743936271355550,
      "name": "ftrace_check_current_call",
      "external": false,
      "loc": "arch/riscv/kernel/ftrace.c:13",

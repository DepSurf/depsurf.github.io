...
```json
{
  "name": "flow_indr_block_dev_lookup",
  ...
  "funcs": [
    {
      ...
      "name": "flow_indr_block_dev_lookup",
      "external": false,
      "loc": "net/core/flow_offload.c:311",

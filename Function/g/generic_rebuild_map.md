# Function: <code>generic_rebuild_map</code>
...
```c
void generic_rebuild_map()
```

```json
{
  "name": "generic_rebuild_map",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071579378992,
      "name": "generic_rebuild_map",
      "external": true,
      "loc": "arch/x86/kernel/cpu/mtrr/generic.c:330",

# Function: <code>gpiod_line_state_notify</code>
...
```c
void gpiod_line_state_notify(struct gpio_desc * desc, long unsigned int action)
```

```json
{
  "name": "gpiod_line_state_notify",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071588591061,
      "name": "gpiod_line_state_notify",
      "external": true,
      "loc": "drivers/gpio/gpiolib.c:3924",

# Function: <code>__get_cpu_fpsimd_context</code>
...
```c
void __get_cpu_fpsimd_context()
```

```json
{
  "name": "__get_cpu_fpsimd_context",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446603336490185392,
      "name": "__get_cpu_fpsimd_context",
      "external": false,
      "loc": "arch/arm64/kernel/fpsimd.c:152",

# Function: <code>get_l4proto</code>
...
```c
int get_l4proto(const struct sk_buff * skb, unsigned int nhoff, u8 pf, u8 * l4num)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588926144,
      "name": "get_l4proto",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_core.c:377",

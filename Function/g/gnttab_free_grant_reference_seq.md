...
```json
{
  "name": "gnttab_free_grant_reference_seq",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071589727888,
      "name": "gnttab_free_grant_reference_seq",
      "external": true,
      "loc": "drivers/xen/grant-table.c:637",
      "file": "drivers/xen/grant-table.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071590065856,
      "name": "gnttab_free_grant_reference_seq",
      "external": true,
      "loc": "drivers/xen/grant-table.c:635",
      "file": "drivers/xen/grant-table.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

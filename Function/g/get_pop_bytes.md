...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579482616,
      "name": "get_pop_bytes",
      "external": false,
      "loc": "arch/x86/net/bpf_jit_comp.c:375",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579484439,
      "name": "get_pop_bytes",
      "external": false,
      "loc": "arch/x86/net/bpf_jit_comp.c:387",
      "file": "arch/x86/net/bpf_jit_comp.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "arch/x86/net/bpf_jit_comp.c:emit_bpf_tail_call_direct",
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "get_pop_bytes",
      "external": false,
      "loc": "arch/x86/net/bpf_jit_comp.c:383",
      "file": "arch/x86/net/bpf_jit_comp.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071592096809,
      "name": "get_pop_bytes.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 107
    }

# Function: <code>get_slice_psize</code>
...
```c
unsigned int get_slice_psize(struct mm_struct * mm, long unsigned int addr)
```

```json
{
  "name": "get_slice_psize",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282834032,
      "name": "get_slice_psize",
      "external": true,
      "loc": "arch/powerpc/mm/slice.c:662",

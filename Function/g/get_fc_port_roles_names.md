# Function: <code>get_fc_port_roles_names</code>
  ...
  "funcs": [
    {
      ...
      "name": "get_fc_port_roles_names",
      "external": false,
      "loc": "drivers/scsi/scsi_transport_fc.c:286",
      "file": "drivers/scsi/scsi_transport_fc.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "drivers/scsi/scsi_transport_fc.c:show_fc_rport_roles"
      ]
    }
  ],
  "symbols": [

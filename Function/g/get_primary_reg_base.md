# Function: <code>get_primary_reg_base</code>
...
```json
{
  "name": "get_primary_reg_base",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071593379616,
      "name": "get_primary_reg_base",
      "external": true,
      "loc": "drivers/platform/x86/intel/pmc/core.c:1020",
      "file": "drivers/platform/x86/intel/pmc/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "drivers/platform/x86/intel/pmc/spt.c:spt_core_init",
        "drivers/platform/x86/intel/pmc/cnp.c:cnp_core_init",
        "drivers/platform/x86/intel/pmc/icl.c:icl_core_init",

# Function: <code>edma_assign_channel_eventq</code>
...
```c
void edma_assign_channel_eventq(struct edma_chan * echan, enum dma_event_q eventq_no)
```

```json
{
  "name": "edma_assign_channel_eventq",

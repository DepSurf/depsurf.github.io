# Function: <code>exit_flush_lazy_tlbs</code>
...
```c
void exit_flush_lazy_tlbs(struct mm_struct * mm)
```

```json
{
  "name": "exit_flush_lazy_tlbs",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282777536,
      "name": "exit_flush_lazy_tlbs",
      "external": false,
      "loc": "arch/powerpc/mm/book3s64/radix_tlb.c:658",

# Function: <code>emc_seq_update_timing</code>
...
```c
void emc_seq_update_timing(struct tegra_emc * emc)
```

```json
{
  "name": "emc_seq_update_timing",
  ...
  "funcs": [
    {
      ...
      "name": "emc_seq_update_timing",
      "external": false,
      "loc": "drivers/memory/tegra/tegra124-emc.c:487",

...
```c
struct eeh_pe * eeh_pe_get(struct pci_controller * phb, int pe_no, int config_addr)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 13835058055282455536,
      "name": "eeh_pe_get",
      "external": true,
      "loc": "arch/powerpc/kernel/eeh_pe.c:309",

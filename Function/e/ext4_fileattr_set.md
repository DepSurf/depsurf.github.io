...
```json
{
  "name": "ext4_fileattr_set",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071583151552,
      "name": "ext4_fileattr_set",
      "external": true,
      "loc": "fs/ext4/ioctl.c:740",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584019120,
      "name": "ext4_fileattr_set",
      "external": true,
      "loc": "fs/ext4/ioctl.c:967",
      "file": "fs/ext4/ioctl.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584650496,
      "name": "ext4_fileattr_set",
      "external": true,
      "loc": "fs/ext4/ioctl.c:982",
      "file": "fs/ext4/ioctl.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584873760,
      "name": "ext4_fileattr_set",
      "external": true,
      "loc": "fs/ext4/ioctl.c:989",
      "file": "fs/ext4/ioctl.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

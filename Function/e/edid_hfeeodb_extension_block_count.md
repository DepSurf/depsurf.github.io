# Function: <code>edid_hfeeodb_extension_block_count</code>
...
```c
int edid_hfeeodb_extension_block_count(const struct edid * edid)
```

```json
{
  "name": "edid_hfeeodb_extension_block_count",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071592026425,
      "name": "edid_hfeeodb_extension_block_count",
      "external": false,
      "loc": "drivers/gpu/drm/drm_edid.c:5182",

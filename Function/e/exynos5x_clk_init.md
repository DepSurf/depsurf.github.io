# Function: <code>exynos5x_clk_init</code>
...
```c
void exynos5x_clk_init(struct device_node * np, enum exynos5x_soc soc)
```

```json
{
  "name": "exynos5x_clk_init",
  ...
  "funcs": [
    {
      ...
      "name": "exynos5x_clk_init",
      "external": false,
      "loc": "drivers/clk/samsung/clk-exynos5420.c:1542",

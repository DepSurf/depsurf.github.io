# Function: <code>eeh_rmv_from_parent_pe</code>
...
```json
{
  "name": "eeh_rmv_from_parent_pe",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282456992,
      "name": "eeh_rmv_from_parent_pe",
      "external": true,
      "loc": "arch/powerpc/kernel/eeh_pe.c:470",
      "file": "arch/powerpc/kernel/eeh_pe.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "arch/powerpc/kernel/eeh.c:eeh_remove_device",
        "arch/powerpc/kernel/eeh_driver.c:eeh_pe_detach_dev",

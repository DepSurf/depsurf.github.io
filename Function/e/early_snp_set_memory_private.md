...
```json
{
  "name": "early_snp_set_memory_private",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071617057953,
      "name": "early_snp_set_memory_private",
      "external": true,
      "loc": "arch/x86/kernel/sev.c:701",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071619461405,
      "name": "early_snp_set_memory_private",
      "external": true,
      "loc": "arch/x86/kernel/sev.c:715",
      "file": "arch/x86/kernel/sev.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "arch/x86/kernel/sev.c:snp_prep_memory"
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071621757693,
      "name": "early_snp_set_memory_private",
      "external": true,
      "loc": "arch/x86/kernel/sev.c:742",
      "file": "arch/x86/kernel/sev.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "arch/x86/kernel/sev.c:snp_prep_memory"

# Function: <code>eeh_edev_actionable</code>
...
```c
bool eeh_edev_actionable(struct eeh_dev * edev)
```

```json
{
  "name": "eeh_edev_actionable",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 13835058055282461744,
      "name": "eeh_edev_actionable",
      "external": false,
      "loc": "arch/powerpc/kernel/eeh_driver.c:98",

# Function: <code>efi_virtmap_unload</code>
...
```c
void efi_virtmap_unload()
```

```json
{
  "name": "efi_virtmap_unload",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336501563960,
      "name": "efi_virtmap_unload",
      "external": true,
      "loc": "drivers/firmware/efi/arm-runtime.c:155",

...
```c
ssize_t eui_show(struct device * dev, struct device_attribute * attr, char * buf)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586454736,
      "name": "eui_show",
      "external": false,
      "loc": "drivers/nvme/host/core.c:3078",

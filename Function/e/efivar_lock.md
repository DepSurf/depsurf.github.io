...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592883824,
      "name": "efivar_lock",
      "external": true,
      "loc": "drivers/firmware/efi/vars.c:130",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071593322416,
      "name": "efivar_lock",
      "external": true,
      "loc": "drivers/firmware/efi/vars.c:134",
      "file": "drivers/firmware/efi/vars.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071594079456,
      "name": "efivar_lock",
      "external": true,
      "loc": "drivers/firmware/efi/vars.c:142",
      "file": "drivers/firmware/efi/vars.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [

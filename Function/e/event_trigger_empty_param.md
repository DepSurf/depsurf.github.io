...
```json
{
  "name": "event_trigger_empty_param",
  ...
  "funcs": [
    {
      ...
      "name": "event_trigger_empty_param",
      "external": true,
      "loc": "kernel/trace/trace_events_trigger.c:734",
  ...
  "funcs": [
    {
      ...
      "name": "event_trigger_empty_param",
      "external": true,
      "loc": "kernel/trace/trace_events_trigger.c:735",
      "file": "kernel/trace/trace_events_trigger.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "event_trigger_empty_param",
      "external": true,
      "loc": "kernel/trace/trace_events_trigger.c:737",
      "file": "kernel/trace/trace_events_trigger.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [

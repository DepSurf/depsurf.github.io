...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592883936,
      "name": "efivar_unlock",
      "external": true,
      "loc": "drivers/firmware/efi/vars.c:161",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071593322528,
      "name": "efivar_unlock",
      "external": true,
      "loc": "drivers/firmware/efi/vars.c:165",
      "file": "drivers/firmware/efi/vars.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071594079568,
      "name": "efivar_unlock",
      "external": true,
      "loc": "drivers/firmware/efi/vars.c:173",
      "file": "drivers/firmware/efi/vars.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [

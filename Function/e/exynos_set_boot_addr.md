# Function: <code>exynos_set_boot_addr</code>
...
```c
int exynos_set_boot_addr(u32 core_id, long unsigned int boot_addr)
```

```json
{
  "name": "exynos_set_boot_addr",
  ...
  "funcs": [
    {
      ...
      "name": "exynos_set_boot_addr",
      "external": true,
      "loc": "arch/arm/mach-exynos/platsmp.c:271",

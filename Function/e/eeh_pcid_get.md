# Function: <code>eeh_pcid_get</code>
...
```c
struct pci_driver * eeh_pcid_get(struct pci_dev * pdev)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 13835058055282463992,
      "name": "eeh_pcid_get",
      "external": false,
      "loc": "arch/powerpc/kernel/eeh_driver.c:121",

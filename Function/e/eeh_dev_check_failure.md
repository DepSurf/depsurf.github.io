# Function: <code>eeh_dev_check_failure</code>
...
```json
{
  "name": "eeh_dev_check_failure",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 13835058055282441104,
      "name": "eeh_dev_check_failure",
      "external": true,
      "loc": "arch/powerpc/kernel/eeh.c:446",
  ...
  "symbols": [
    {
      "addr": 13835058055282441104,
      "name": "eeh_dev_check_failure.part.0",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 1524
    },
    {
      "addr": 13835058055282442640,
      "name": "eeh_dev_check_failure",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 100

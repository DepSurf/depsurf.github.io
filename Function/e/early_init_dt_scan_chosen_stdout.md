...
```json
{
  "name": "early_init_dt_scan_chosen_stdout",
  ...
  "funcs": [
    {
      ...
      "name": "early_init_dt_scan_chosen_stdout",
      "external": false,
      "loc": "include/linux/of_fdt.h:100",
  ...
  "funcs": [
    {
      ...
      "name": "early_init_dt_scan_chosen_stdout",
      "external": false,
      "loc": "include/linux/of_fdt.h:103",
      "file": "drivers/tty/serial/earlycon.c",
      "inline": "declared, inlined",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446603336511303284,
      "name": "early_init_dt_scan_chosen_stdout",
      "external": true,
      "loc": "drivers/of/fdt.c:908",

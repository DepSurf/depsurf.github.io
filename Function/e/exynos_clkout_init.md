# Function: <code>exynos_clkout_init</code>
...
```c
void exynos_clkout_init(struct device_node * node, u32 mux_mask)
```

```json
{
  "name": "exynos_clkout_init",
  ...
  "funcs": [
    {
      ...
      "name": "exynos_clkout_init",
      "external": false,
      "loc": "drivers/clk/samsung/clk-exynos-clkout.c:54",

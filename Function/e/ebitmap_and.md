# Function: <code>ebitmap_and</code>
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071583821312,
      "name": "ebitmap_and",
      "external": true,
      "loc": "security/selinux/ss/ebitmap.c:81",
  ...
  "funcs": [
    {
      ...
      "name": "ebitmap_and",
      "external": true,
      "loc": "security/selinux/ss/ebitmap.c:82",
      "file": "security/selinux/ss/ebitmap.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

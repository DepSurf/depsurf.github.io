...
```json
{
  "name": "event_trigger_register",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071581223008,
      "name": "event_trigger_register",
      "external": true,
      "loc": "kernel/trace/trace_events_trigger.c:931",
  ...
  "funcs": [
    {
      ...
      "name": "event_trigger_register",
      "external": true,
      "loc": "kernel/trace/trace_events_trigger.c:932",
      "file": "kernel/trace/trace_events_trigger.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "kernel/trace/trace_events_trigger.c:event_enable_trigger_parse",

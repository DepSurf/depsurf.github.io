...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071583389218,
      "name": "ext4_fc_memcpy",
      "external": false,
      "loc": "fs/ext4/fast_commit.c:703",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071583758255,
      "name": "ext4_fc_memcpy",
      "external": false,
      "loc": "fs/ext4/fast_commit.c:671",
      "file": "fs/ext4/fast_commit.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "fs/ext4/fast_commit.c:ext4_fc_perform_commit"
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584310336,
      "name": "ext4_fc_memcpy",
      "external": false,
      "loc": "fs/ext4/fast_commit.c:750",
      "file": "fs/ext4/fast_commit.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

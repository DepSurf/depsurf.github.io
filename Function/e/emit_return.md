...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "emit_return",
      "external": false,
      "loc": "arch/x86/net/bpf_jit_comp.c:428",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071593864232,
      "name": "emit_return.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 24
    }
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579755280,
      "name": "emit_return",
      "external": false,
      "loc": "arch/x86/net/bpf_jit_comp.c:441",
      "file": "arch/x86/net/bpf_jit_comp.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "emit_return",
      "external": false,
      "loc": "arch/x86/net/bpf_jit_comp.c:563",
      "file": "arch/x86/net/bpf_jit_comp.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>uaccess_enable_not_uao</code>
...
```c
void uaccess_enable_not_uao()
```

```json
{
  "name": "uaccess_enable_not_uao",
  ...
  "funcs": [
    {
      ...
      "name": "uaccess_enable_not_uao",
      "external": false,
      "loc": "arch/arm64/include/asm/uaccess.h:220",

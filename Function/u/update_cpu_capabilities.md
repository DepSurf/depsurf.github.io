# Function: <code>update_cpu_capabilities</code>
...
```c
void update_cpu_capabilities(u16 scope_mask)
```

```json
{
  "name": "update_cpu_capabilities",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336490261928,
      "name": "update_cpu_capabilities",
      "external": false,
      "loc": "arch/arm64/kernel/cpufeature.c:1767",

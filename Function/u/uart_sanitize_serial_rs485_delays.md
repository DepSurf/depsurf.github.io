...
```json
{
  "name": "uart_sanitize_serial_rs485_delays",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071589801888,
      "name": "uart_sanitize_serial_rs485_delays",
      "external": false,
      "loc": "drivers/tty/serial/serial_core.c:1317",
  ...
  "funcs": [
    {
      ...
      "name": "uart_sanitize_serial_rs485_delays",
      "external": false,
      "loc": "drivers/tty/serial/serial_core.c:1338",
      "file": "drivers/tty/serial/serial_core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071590446672,
      "name": "uart_sanitize_serial_rs485_delays",
      "external": false,
      "loc": "drivers/tty/serial/serial_core.c:1332",
      "file": "drivers/tty/serial/serial_core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

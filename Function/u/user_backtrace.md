# Function: <code>user_backtrace</code>
  ...
  "funcs": [
    {
      ...
      "name": "user_backtrace",
      "external": false,
      "loc": "arch/arm64/kernel/perf_callchain.c:23",
  ...
  "funcs": [
    {
      ...
      "name": "user_backtrace",
      "external": false,
      "loc": "arch/arm/kernel/perf_callchain.c:34",
...
```c
long unsigned int user_backtrace(struct perf_callchain_entry_ctx * entry, long unsigned int fp, long unsigned int reg_ra)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446743936271358114,
      "name": "user_backtrace",
      "external": false,
      "loc": "arch/riscv/kernel/perf_callchain.c:17",

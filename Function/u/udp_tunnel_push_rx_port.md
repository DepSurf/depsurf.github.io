# Function: <code>udp_tunnel_push_rx_port</code>
...
```c
void udp_tunnel_push_rx_port(struct net_device * dev, struct socket * sock, short unsigned int type)
```

```json
{
  "name": "udp_tunnel_push_rx_port",

# Function: <code>user_event_mm_fault_in</code>
...
```c
int user_event_mm_fault_in(struct user_event_mm * mm, long unsigned int uaddr, int attempt)
```

```json
{
  "name": "user_event_mm_fault_in",
  ...
  "funcs": [
    {
      ...
      "name": "user_event_mm_fault_in",
      "external": false,
      "loc": "kernel/trace/trace_events_user.c:362",
  ...
  "funcs": [
    {
      ...
      "name": "user_event_mm_fault_in",
      "external": false,
      "loc": "kernel/trace/trace_events_user.c:390",
      "file": "kernel/trace/trace_events_user.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

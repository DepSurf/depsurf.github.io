# Function: <code>update_sched_clock</code>
...
```c
void update_sched_clock()
```

```json
{
  "name": "update_sched_clock",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336491418568,
      "name": "update_sched_clock",
      "external": false,
      "loc": "kernel/time/sched_clock.c:142",

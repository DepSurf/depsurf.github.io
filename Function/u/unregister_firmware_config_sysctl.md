...
```json
{
  "name": "unregister_firmware_config_sysctl",
  ...
  "funcs": [
    {
      ...
      "name": "unregister_firmware_config_sysctl",
      "external": true,
      "loc": "drivers/base/firmware_loader/fallback_table.c:62",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591107168,
      "name": "unregister_firmware_config_sysctl",
      "external": true,
      "loc": "drivers/base/firmware_loader/fallback_table.c:61",
      "file": "drivers/base/firmware_loader/fallback_table.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

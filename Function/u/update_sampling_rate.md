# Function: <code>update_sampling_rate</code>
...
```c
void update_sampling_rate(struct dbs_data * dbs_data, unsigned int new_rate)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585873072,
      "name": "update_sampling_rate",
      "external": false,
      "loc": "drivers/cpufreq/cpufreq_ondemand.c:246",

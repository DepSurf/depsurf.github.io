# Function: <code>update_partition_sd_lb</code>
...
```c
void update_partition_sd_lb(struct cpuset * cs, int old_prs)
```

```json
{
  "name": "update_partition_sd_lb",
  ...
  "funcs": [
    {
      ...
      "name": "update_partition_sd_lb",
      "external": false,
      "loc": "kernel/cgroup/cpuset.c:1364",

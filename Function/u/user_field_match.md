...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "user_field_match",
      "external": false,
      "loc": "kernel/trace/trace_events_user.c:1779",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596529627,
      "name": "user_field_match.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 62
    }
  ...
  "funcs": [
    {
      ...
      "name": "user_field_match",
      "external": false,
      "loc": "kernel/trace/trace_events_user.c:1819",
      "file": "kernel/trace/trace_events_user.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

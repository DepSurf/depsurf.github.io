...
```json
{
  "name": "__lockup_detector_reconfigure",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071593938291,
      "name": "__lockup_detector_reconfigure.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 45
    }

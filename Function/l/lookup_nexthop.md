# Function: <code>lookup_nexthop</code>
...
```c
void lookup_nexthop(struct sk_buff * skb, struct in6_addr * nhaddr, u32 tbl_id)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588606464,
      "name": "lookup_nexthop",
      "external": false,
      "loc": "net/ipv6/seg6_local.c:143",

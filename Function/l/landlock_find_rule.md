  ...
  "funcs": [
    {
      ...
      "name": "landlock_find_rule",
      "external": true,
      "loc": "security/landlock/ruleset.c:452",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585370000,
      "name": "landlock_find_rule",
      "external": true,
      "loc": "security/landlock/ruleset.c:455",
      "file": "security/landlock/ruleset.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586627536,
      "name": "landlock_find_rule",
      "external": true,
      "loc": "security/landlock/ruleset.c:590",
      "file": "security/landlock/ruleset.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

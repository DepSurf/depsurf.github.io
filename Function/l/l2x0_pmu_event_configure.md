# Function: <code>l2x0_pmu_event_configure</code>
...
```c
void l2x0_pmu_event_configure(struct perf_event * event)
```

```json
{
  "name": "l2x0_pmu_event_configure",
  ...
  "funcs": [
    {
      ...
      "name": "l2x0_pmu_event_configure",
      "external": false,
      "loc": "arch/arm/mm/cache-l2x0-pmu.c:133",

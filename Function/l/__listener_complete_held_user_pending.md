...
```json
{
  "name": "__listener_complete_held_user_pending",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586332608,
      "name": "__listener_complete_held_user_pending",
      "external": false,
      "loc": "security/apparmor/notify.c:536",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586599616,
      "name": "__listener_complete_held_user_pending",
      "external": false,
      "loc": "security/apparmor/notify.c:541",
      "file": "security/apparmor/notify.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

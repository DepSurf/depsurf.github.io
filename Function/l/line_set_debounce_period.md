# Function: <code>line_set_debounce_period</code>
...
```c
void line_set_debounce_period(struct line * line, unsigned int debounce_period_us)
```

```json
{
  "name": "line_set_debounce_period",
  ...
  "funcs": [
    {
      ...
      "name": "line_set_debounce_period",
      "external": false,
      "loc": "drivers/gpio/gpiolib-cdev.c:639",

...
```json
{
  "name": "resctrl_arch_get_num_closid",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579386832,
      "name": "resctrl_arch_get_num_closid",
      "external": true,
      "loc": "arch/x86/kernel/cpu/resctrl/core.c:339",
      "file": "arch/x86/kernel/cpu/resctrl/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "resctrl_arch_get_num_closid",
      "external": true,
      "loc": "arch/x86/kernel/cpu/resctrl/core.c:364",
      "file": "arch/x86/kernel/cpu/resctrl/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "resctrl_arch_get_num_closid",
      "external": true,
      "loc": "arch/x86/kernel/cpu/resctrl/core.c:368",
      "file": "arch/x86/kernel/cpu/resctrl/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>__rpte_sub_valid</code>
...
```c
bool __rpte_sub_valid(real_pte_t rpte, long unsigned int index)
```

```json
{
  "name": "__rpte_sub_valid",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 13835058055282809372,
      "name": "__rpte_sub_valid",
      "external": true,
      "loc": "arch/powerpc/mm/book3s64/hash_64k.c:31",

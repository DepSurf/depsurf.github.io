# Function: <code>rockchip_register_restart_notifier</code>
...
```c
void rockchip_register_restart_notifier(struct rockchip_clk_provider * ctx, unsigned int reg, void (*)() cb)
```

```json
{
  "name": "rockchip_register_restart_notifier",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336511167976,
      "name": "rockchip_register_restart_notifier",
      "external": true,
      "loc": "drivers/clk/rockchip/clk.c:625",

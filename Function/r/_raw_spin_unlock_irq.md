...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071594746352,
      "name": "_raw_spin_unlock_irq",
      "external": true,
      "loc": "kernel/locking/spinlock.c:200",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071590299840,
      "name": "_raw_spin_unlock_irq",
      "external": true,
      "loc": "kernel/locking/spinlock.c:197",
      "file": "kernel/locking/spinlock.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591639832,
      "name": "rtnl_is_locked",
      "external": true,
      "loc": "net/core/rtnetlink.c:157",
      "file": "net/core/rtnetlink.c",
      "inline": "not declared, inlined",
      "caller_inline": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071593422696,
      "name": "rtnl_is_locked",
      "external": true,
      "loc": "net/core/rtnetlink.c:158",
      "file": "net/core/rtnetlink.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "net/core/rtnetlink.c:rtnl_offload_xstats_notify",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071593885528,
      "name": "rtnl_is_locked",
      "external": true,
      "loc": "net/core/rtnetlink.c:161",
      "file": "net/core/rtnetlink.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "net/core/rtnetlink.c:rtnl_offload_xstats_notify",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071594668712,
      "name": "rtnl_is_locked",
      "external": true,
      "loc": "net/core/rtnetlink.c:162",
      "file": "net/core/rtnetlink.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "net/core/rtnetlink.c:rtnl_offload_xstats_notify",

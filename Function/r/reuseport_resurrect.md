...
```json
{
  "name": "reuseport_resurrect",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071590191376,
      "name": "reuseport_resurrect",
      "external": false,
      "loc": "net/core/sock_reuseport.c:283",
  ...
  "funcs": [
    {
      ...
      "name": "reuseport_resurrect",
      "external": false,
      "loc": "net/core/sock_reuseport.c:369",
      "file": "net/core/sock_reuseport.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

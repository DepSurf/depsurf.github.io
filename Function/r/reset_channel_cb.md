# Function: <code>reset_channel_cb</code>
...
```c
void reset_channel_cb(void * arg)
```

```json
{
  "name": "reset_channel_cb",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071587568076,
      "name": "reset_channel_cb",
      "external": false,
      "loc": "drivers/hv/channel.c:610",

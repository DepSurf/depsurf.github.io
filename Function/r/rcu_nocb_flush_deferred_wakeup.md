...
```json
{
  "name": "rcu_nocb_flush_deferred_wakeup",
  ...
  "funcs": [
    {
      ...
      "name": "rcu_nocb_flush_deferred_wakeup",
      "external": false,
      "loc": "include/linux/rcupdate.h:116",
  ...
  "funcs": [
    {
      ...
      "name": "rcu_nocb_flush_deferred_wakeup",
      "external": false,
      "loc": "include/linux/rcupdate.h:122",
      "file": "kernel/sched/idle.c",
      "inline": "declared, inlined",
      "caller_inline": [],
      "caller_func": []
  ...
  "funcs": [
    {
      ...
      "name": "rcu_nocb_flush_deferred_wakeup",
      "external": false,
      "loc": "include/linux/rcupdate.h:123",
  ...
  "funcs": [
    {
      ...
      "name": "rcu_nocb_flush_deferred_wakeup",
      "external": false,
      "loc": "include/linux/rcupdate.h:156",
      "file": "kernel/sched/build_policy.c",
      "inline": "declared, inlined",
      "caller_inline": [],
      "caller_func": []
  ...
  "funcs": [
    {
      ...
      "name": "rcu_nocb_flush_deferred_wakeup",
      "external": false,
      "loc": "include/linux/rcupdate.h:157",
      "file": "kernel/sched/build_policy.c",
      "inline": "declared, inlined",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580768944,
      "name": "rcu_nocb_flush_deferred_wakeup",
      "external": true,
      "loc": "kernel/rcu/tree_nocb.h:1073",

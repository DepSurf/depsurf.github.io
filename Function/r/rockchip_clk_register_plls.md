# Function: <code>rockchip_clk_register_plls</code>
...
```c
void rockchip_clk_register_plls(struct rockchip_clk_provider * ctx, struct rockchip_pll_clock * list, unsigned int nr_pll, int grf_lock_offset)
```

```json
{
  "name": "rockchip_clk_register_plls",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336511165048,
      "name": "rockchip_clk_register_plls",
      "external": true,
      "loc": "drivers/clk/rockchip/clk.c:413",

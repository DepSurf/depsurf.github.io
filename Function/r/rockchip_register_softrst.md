# Function: <code>rockchip_register_softrst</code>
...
```c
void rockchip_register_softrst(struct device_node * np, unsigned int num_regs, void * base, u8 flags)
```

```json
{
  "name": "rockchip_register_softrst",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336511168096,
      "name": "rockchip_register_softrst",
      "external": true,
      "loc": "drivers/clk/rockchip/softrst.c:80",

...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071589480384,
      "name": "__resolve_freq",
      "external": false,
      "loc": "drivers/cpufreq/cpufreq.c:527",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071590968809,
      "name": "__resolve_freq",
      "external": false,
      "loc": "drivers/cpufreq/cpufreq.c:528",
      "file": "drivers/cpufreq/cpufreq.c",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071593103904,
      "name": "__resolve_freq",
      "external": false,
      "loc": "drivers/cpufreq/cpufreq.c:535",
      "file": "drivers/cpufreq/cpufreq.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "drivers/cpufreq/cpufreq.c:cpufreq_set_policy",

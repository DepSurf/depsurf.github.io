...
```json
{
  "name": "refcount_dec_and_test_checked",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584145616,
      "name": "refcount_dec_and_test_checked",
      "external": true,
      "loc": "lib/refcount.c:218",
      "file": "lib/refcount.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": []

  ...
  "funcs": [
    {
      ...
      "name": "_raw_write_lock",
      "external": true,
      "loc": "kernel/locking/spinlock.c:293",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588894688,
      "name": "_raw_write_lock",
      "external": true,
      "loc": "kernel/locking/spinlock.c:286",
      "file": "kernel/locking/spinlock.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592833664,
      "name": "_raw_write_lock",
      "external": true,
      "loc": "kernel/locking/spinlock.c:298",
      "file": "kernel/locking/spinlock.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

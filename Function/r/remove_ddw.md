...
```c
void remove_ddw(struct device_node * np, bool remove_prop)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 13835058055283143920,
      "name": "remove_ddw",
      "external": false,
      "loc": "arch/powerpc/platforms/pseries/iommu.c:770",

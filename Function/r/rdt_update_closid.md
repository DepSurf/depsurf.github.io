# Function: <code>rdt_update_closid</code>
...
```c
void rdt_update_closid(const struct cpumask * cpu_mask, int * closid)
```

```json
{
  "name": "rdt_update_closid",
  ...
  "funcs": [
    {
      ...
      "name": "rdt_update_closid",
      "external": false,
      "loc": "arch/x86/kernel/cpu/intel_rdt_rdtgroup.c:222",

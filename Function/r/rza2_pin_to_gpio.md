# Function: <code>rza2_pin_to_gpio</code>
...
```c
void rza2_pin_to_gpio(void * pfc_base, unsigned int offset, u8 dir)
```

```json
{
  "name": "rza2_pin_to_gpio",
  ...
  "funcs": [
    {
      ...
      "name": "rza2_pin_to_gpio",
      "external": false,
      "loc": "drivers/pinctrl/pinctrl-rza2.c:107",

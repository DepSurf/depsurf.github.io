...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586728128,
      "name": "raw_seq_open",
      "external": true,
      "loc": "net/ipv4/raw.c:1056",
      "file": "net/ipv4/raw.c",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071587176150,
      "name": "raw_seq_open",
      "external": true,
      "loc": "net/ipv4/raw.c:1059",
      "file": "net/ipv4/raw.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "net/ipv4/raw.c:raw_v4_seq_open"
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071587376326,
      "name": "raw_seq_open",
      "external": true,
      "loc": "net/ipv4/raw.c:1078",
      "file": "net/ipv4/raw.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "net/ipv4/raw.c:raw_v4_seq_open"
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071587510438,
      "name": "raw_seq_open",
      "external": true,
      "loc": "net/ipv4/raw.c:1087",
      "file": "net/ipv4/raw.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "net/ipv4/raw.c:raw_v4_seq_open"
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588033190,
      "name": "raw_seq_open",
      "external": true,
      "loc": "net/ipv4/raw.c:1100",
      "file": "net/ipv4/raw.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "net/ipv4/raw.c:raw_v4_seq_open"

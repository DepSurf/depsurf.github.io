...
```json
{
  "name": "wake_up_and_wait_for_irq_thread_ready",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580508688,
      "name": "wake_up_and_wait_for_irq_thread_ready",
      "external": false,
      "loc": "kernel/irq/manage.c:1272",
      "file": "kernel/irq/manage.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

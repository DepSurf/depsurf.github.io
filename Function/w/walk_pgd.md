...
```c
void walk_pgd(struct pg_state * st, struct mm_struct * mm, long unsigned int start)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446603336490360008,
      "name": "walk_pgd",
      "external": false,
      "loc": "arch/arm64/mm/dump.c:344",

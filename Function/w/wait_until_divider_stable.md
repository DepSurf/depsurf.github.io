# Function: <code>wait_until_divider_stable</code>
...
```c
void wait_until_divider_stable(void * div_reg, long unsigned int mask)
```

```json
{
  "name": "wait_until_divider_stable",
  ...
  "funcs": [
    {
      ...
      "name": "wait_until_divider_stable",
      "external": false,
      "loc": "drivers/clk/samsung/clk-cpu.c:69",

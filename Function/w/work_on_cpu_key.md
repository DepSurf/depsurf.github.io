...
```c
long int work_on_cpu_key(int cpu, long int (*)(void *) fn, void * arg, struct lock_class_key * key)
```

```json
{
  "name": "work_on_cpu_key",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071580071914,
      "name": "work_on_cpu_key",
      "external": true,
      "loc": "kernel/workqueue.c:5626",

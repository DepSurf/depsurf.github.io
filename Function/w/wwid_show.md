...
```c
ssize_t wwid_show(struct device * dev, struct device_attribute * attr, char * buf)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586467520,
      "name": "wwid_show",
      "external": false,
      "loc": "drivers/nvme/host/core.c:3023",

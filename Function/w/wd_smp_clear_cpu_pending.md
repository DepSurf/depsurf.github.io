# Function: <code>wd_smp_clear_cpu_pending</code>
...
```c
void wd_smp_clear_cpu_pending(int cpu, u64 tb)
```

```json
{
  "name": "wd_smp_clear_cpu_pending",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282388800,
      "name": "wd_smp_clear_cpu_pending",
      "external": false,
      "loc": "arch/powerpc/kernel/watchdog.c:201",

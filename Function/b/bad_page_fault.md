# Function: <code>bad_page_fault</code>
...
```c
void bad_page_fault(struct pt_regs * regs, long unsigned int address, int sig)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 13835058055282716368,
      "name": "bad_page_fault",
      "external": true,
      "loc": "arch/powerpc/mm/fault.c:648",

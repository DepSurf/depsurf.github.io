...
```json
{
  "name": "bpf_dynptr_init",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071581566094,
      "name": "bpf_dynptr_init",
      "external": true,
      "loc": "kernel/bpf/helpers.c:1443",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071581939390,
      "name": "bpf_dynptr_init",
      "external": true,
      "loc": "kernel/bpf/helpers.c:1427",
      "file": "kernel/bpf/helpers.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "kernel/bpf/helpers.c:bpf_dynptr_from_mem"
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582123390,
      "name": "bpf_dynptr_init",
      "external": true,
      "loc": "kernel/bpf/helpers.c:1463",
      "file": "kernel/bpf/helpers.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "kernel/bpf/helpers.c:bpf_dynptr_from_mem"
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582263934,
      "name": "bpf_dynptr_init",
      "external": true,
      "loc": "kernel/bpf/helpers.c:1482",
      "file": "kernel/bpf/helpers.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "kernel/bpf/helpers.c:bpf_dynptr_from_mem"

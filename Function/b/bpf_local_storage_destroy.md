...
```json
{
  "name": "bpf_local_storage_destroy",
  ...
  "funcs": [
    {
      ...
      "name": "bpf_local_storage_destroy",
      "external": true,
      "loc": "kernel/bpf/bpf_local_storage.c:749",
  ...
  "symbols": [
    {
      "addr": 18446744071596543376,
      "name": "bpf_local_storage_destroy.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 42
    },
  ...
  "funcs": [
    {
      ...
      "name": "bpf_local_storage_destroy",
      "external": true,
      "loc": "kernel/bpf/bpf_local_storage.c:730",
      "file": "kernel/bpf/bpf_local_storage.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

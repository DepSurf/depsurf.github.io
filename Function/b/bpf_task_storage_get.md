  ...
  "funcs": [
    {
      ...
      "name": "bpf_task_storage_get",
      "external": true,
      "loc": "kernel/bpf/bpf_task_storage.c:208",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071581097472,
      "name": "bpf_task_storage_get",
      "external": true,
      "loc": "kernel/bpf/bpf_task_storage.c:227",
      "file": "kernel/bpf/bpf_task_storage.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071581630912,
      "name": "bpf_task_storage_get",
      "external": true,
      "loc": "kernel/bpf/bpf_task_storage.c:231",
      "file": "kernel/bpf/bpf_task_storage.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582210864,
      "name": "bpf_task_storage_get",
      "external": true,
      "loc": "kernel/bpf/bpf_task_storage.c:249",
      "file": "kernel/bpf/bpf_task_storage.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

...
```json
{
  "name": "__bpf_trampoline_link_prog",
  ...
  "funcs": [
    {
      ...
      "name": "__bpf_trampoline_link_prog",
      "external": false,
      "loc": "kernel/bpf/trampoline.c:535",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582221024,
      "name": "__bpf_trampoline_link_prog",
      "external": false,
      "loc": "kernel/bpf/trampoline.c:513",
      "file": "kernel/bpf/trampoline.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582376928,
      "name": "__bpf_trampoline_link_prog",
      "external": false,
      "loc": "kernel/bpf/trampoline.c:524",
      "file": "kernel/bpf/trampoline.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

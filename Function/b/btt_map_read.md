# Function: <code>btt_map_read</code>
...
```c
int btt_map_read(struct arena_info * arena, u32 lba, u32 * mapping, int * trim, int * error, long unsigned int rwb_flags)
```
...
```json
{
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071586113970,
      "name": "btt_map_read.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 43
    }

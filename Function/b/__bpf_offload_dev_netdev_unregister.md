...
```json
{
  "name": "__bpf_offload_dev_netdev_unregister",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596544458,
      "name": "__bpf_offload_dev_netdev_unregister.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 20
    }

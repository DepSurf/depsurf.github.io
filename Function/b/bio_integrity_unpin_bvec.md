# Function: <code>bio_integrity_unpin_bvec</code>
...
```c
void bio_integrity_unpin_bvec(struct bio_vec * bv, int nr_vecs, bool dirty)
```

```json
{
  "name": "bio_integrity_unpin_bvec",

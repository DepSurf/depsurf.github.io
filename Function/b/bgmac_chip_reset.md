# Function: <code>bgmac_chip_reset</code>
...
```c
void bgmac_chip_reset(struct bgmac * bgmac)
```

```json
{
  "name": "bgmac_chip_reset",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336500001496,
      "name": "bgmac_chip_reset",
      "external": false,
      "loc": "drivers/net/ethernet/broadcom/bgmac.c:906",

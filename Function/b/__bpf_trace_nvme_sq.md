# Function: <code>__bpf_trace_nvme_sq</code>
...
```c
void __bpf_trace_nvme_sq(void * __data, struct request * req, __le16 sq_head, int sq_tail)
```

```json
{
  "name": "__bpf_trace_nvme_sq",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586452688,
      "name": "__bpf_trace_nvme_sq",
      "external": false,

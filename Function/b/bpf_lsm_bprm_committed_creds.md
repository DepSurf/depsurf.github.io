...
```json
{
  "name": "bpf_lsm_bprm_committed_creds",
  ...
  "funcs": [
    {
      ...
      "name": "bpf_lsm_bprm_committed_creds",
      "external": true,
      "loc": "include/linux/lsm_hook_defs.h:56",

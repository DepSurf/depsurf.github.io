...
```json
{
  "name": "blk_crypto_alloc_cipher_req",
  ...
  "funcs": [
    {
      ...
      "name": "blk_crypto_alloc_cipher_req",
      "external": false,
      "loc": "block/blk-crypto-fallback.c:186",
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "blk_crypto_alloc_cipher_req",
      "external": false,
      "loc": "block/blk-crypto-fallback.c:189",
      "file": "block/blk-crypto-fallback.c",
  ...
  "symbols": [
    {
      "addr": 18446744071584767440,
      "name": "blk_crypto_alloc_cipher_req.constprop.0",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 123
    }

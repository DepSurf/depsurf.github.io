...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071581624352,
      "name": "bpf_ringbuf_reserve_dynptr",
      "external": true,
      "loc": "kernel/bpf/ringbuf.c:479",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582009840,
      "name": "bpf_ringbuf_reserve_dynptr",
      "external": true,
      "loc": "kernel/bpf/ringbuf.c:565",
      "file": "kernel/bpf/ringbuf.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582349968,
      "name": "bpf_ringbuf_reserve_dynptr",
      "external": true,
      "loc": "kernel/bpf/ringbuf.c:579",
      "file": "kernel/bpf/ringbuf.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

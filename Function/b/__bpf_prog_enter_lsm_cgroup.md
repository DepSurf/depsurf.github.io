...
```json
{
  "name": "__bpf_prog_enter_lsm_cgroup",
  ...
  "funcs": [
    {
      ...
      "name": "__bpf_prog_enter_lsm_cgroup",
      "external": false,
      "loc": "kernel/bpf/trampoline.c:919",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582215936,
      "name": "__bpf_prog_enter_lsm_cgroup",
      "external": false,
      "loc": "kernel/bpf/trampoline.c:897",
      "file": "kernel/bpf/trampoline.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582371200,
      "name": "__bpf_prog_enter_lsm_cgroup",
      "external": false,
      "loc": "kernel/bpf/trampoline.c:908",
      "file": "kernel/bpf/trampoline.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

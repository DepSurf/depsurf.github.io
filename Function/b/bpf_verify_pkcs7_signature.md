...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "bpf_verify_pkcs7_signature",
      "external": true,
      "loc": "kernel/trace/bpf_trace.c:1335",
  ...
  "symbols": [
    {
      "addr": 18446744071596010672,
      "name": "bpf_verify_pkcs7_signature.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 21
    },
  ...
  "funcs": [
    {
      ...
      "name": "bpf_verify_pkcs7_signature",
      "external": true,
      "loc": "kernel/trace/bpf_trace.c:1379",
      "file": "kernel/trace/bpf_trace.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

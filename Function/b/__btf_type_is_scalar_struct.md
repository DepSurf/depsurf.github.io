...
```json
{
  "name": "__btf_type_is_scalar_struct",
  ...
  "funcs": [
    {
      ...
      "name": "__btf_type_is_scalar_struct",
      "external": false,
      "loc": "kernel/bpf/verifier.c:8545",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071581956816,
      "name": "__btf_type_is_scalar_struct",
      "external": false,
      "loc": "kernel/bpf/verifier.c:10013",
      "file": "kernel/bpf/verifier.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582080880,
      "name": "__btf_type_is_scalar_struct",
      "external": false,
      "loc": "kernel/bpf/verifier.c:10796",
      "file": "kernel/bpf/verifier.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

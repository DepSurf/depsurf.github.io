# Function: <code>btt_freelist_init</code>
...
```json
{
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071586114082,
      "name": "btt_freelist_init.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 73
    }

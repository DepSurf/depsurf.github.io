# Function: <code>blk_add_request_payload</code>
...
```json
{
  "name": "blk_add_request_payload",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071582729776,
      "name": "blk_add_request_payload",
      "external": true,
      "loc": "block/blk-core.c:1527",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071583007520,
      "name": "blk_add_request_payload",
      "external": true,
      "loc": "block/blk-core.c:1488",
      "file": "block/blk-core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
<li>
<b>Param reordered. </b>
<code>rq, page, len</code> ➡️ <code>rq, page, offset, len</code>
</li>
</ul>
</details>
</li>

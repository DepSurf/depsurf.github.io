...
```json
{
  "name": "__blk_mq_alloc_requests_batch",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071594096463,
      "name": "__blk_mq_alloc_requests_batch.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 99
    }

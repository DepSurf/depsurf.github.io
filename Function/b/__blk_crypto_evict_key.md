...
```json
{
  "name": "__blk_crypto_evict_key",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071585933904,
      "name": "__blk_crypto_evict_key",
      "external": true,
      "loc": "block/blk-crypto-profile.c:373",
  ...
  "funcs": [
    {
      ...
      "name": "__blk_crypto_evict_key",
      "external": true,
      "loc": "block/blk-crypto-profile.c:374",
      "file": "block/blk-crypto-profile.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "__blk_crypto_evict_key",
      "external": true,
      "loc": "block/blk-crypto-profile.c:363",
      "file": "block/blk-crypto-profile.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

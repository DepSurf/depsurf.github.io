...
```json
{
  "name": "bpf_trampoline_unlink_cgroup_shim",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071582026032,
      "name": "bpf_trampoline_unlink_cgroup_shim",
      "external": true,
      "loc": "kernel/bpf/trampoline.c:767",
  ...
  "funcs": [
    {
      ...
      "name": "bpf_trampoline_unlink_cgroup_shim",
      "external": true,
      "loc": "kernel/bpf/trampoline.c:745",
      "file": "kernel/bpf/trampoline.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582373520,
      "name": "bpf_trampoline_unlink_cgroup_shim",
      "external": true,
      "loc": "kernel/bpf/trampoline.c:756",
      "file": "kernel/bpf/trampoline.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

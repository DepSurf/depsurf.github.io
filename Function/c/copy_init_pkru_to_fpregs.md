# Function: <code>copy_init_pkru_to_fpregs</code>
...
```c
void copy_init_pkru_to_fpregs()
```

```json
{
  "name": "copy_init_pkru_to_fpregs",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579409968,
      "name": "copy_init_pkru_to_fpregs",
      "external": true,
      "loc": "arch/x86/mm/pkeys.c:147",
      "file": "arch/x86/mm/pkeys.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579425712,
      "name": "copy_init_pkru_to_fpregs",
      "external": true,
      "loc": "arch/x86/mm/pkeys.c:134",
      "file": "arch/x86/mm/pkeys.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

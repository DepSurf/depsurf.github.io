# Function: <code>ctnetlink_dump_protoinfo</code>
...
```c
int ctnetlink_dump_protoinfo(struct sk_buff * skb, struct nf_conn * ct)
```

```json
{
  "name": "ctnetlink_dump_protoinfo",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588986096,
      "name": "ctnetlink_dump_protoinfo",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:180",

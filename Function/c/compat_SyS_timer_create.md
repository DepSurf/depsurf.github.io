...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580026064,
      "name": "compat_SyS_timer_create",
      "external": true,
      "loc": "kernel/compat.c:690",
      "file": "kernel/compat.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
  ...
  "funcs": [
    {
      ...
      "name": "compat_SyS_timer_create",
      "external": true,
      "loc": "kernel/time/posix-timers.c:587",
  ...
  "funcs": [
    {
      ...
      "name": "compat_SyS_timer_create",
      "external": true,
      "loc": "kernel/time/posix-timers.c:593",
      "file": "kernel/time/posix-timers.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

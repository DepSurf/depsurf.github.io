# Function: <code>ctnetlink_change_seq_adj</code>
...
```c
int ctnetlink_change_seq_adj(struct nf_conn * ct, const const struct nlattr * * cda)
```

```json
{
  "name": "ctnetlink_change_seq_adj",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588988320,
      "name": "ctnetlink_change_seq_adj",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:1781",

# Function: <code>ctnetlink_parse_tuple</code>
...
```c
int ctnetlink_parse_tuple(const const struct nlattr * * cda, struct nf_conntrack_tuple * tuple, u32 type, u_int8_t l3num, struct nf_conntrack_zone * zone)
```

```json
{
  "name": "ctnetlink_parse_tuple",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588991392,
      "name": "ctnetlink_parse_tuple",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:1127",

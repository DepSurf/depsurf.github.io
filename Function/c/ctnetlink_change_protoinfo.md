# Function: <code>ctnetlink_change_protoinfo</code>
...
```c
int ctnetlink_change_protoinfo(struct nf_conn * ct, const const struct nlattr * * cda)
```

```json
{
  "name": "ctnetlink_change_protoinfo",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588988512,
      "name": "ctnetlink_change_protoinfo",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:1722",

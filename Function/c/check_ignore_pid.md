# Function: <code>check_ignore_pid</code>
...
```c
bool check_ignore_pid(struct trace_pid_list * filtered_pids, struct task_struct * task)
```

```json
{
  "name": "check_ignore_pid",
  ...
  "funcs": [
    {
      ...
      "name": "check_ignore_pid",
      "external": false,
      "loc": "kernel/trace/trace_events.c:487",

# Function: <code>cpu_smallcore_mask</code>
...
```c
struct cpumask * cpu_smallcore_mask(int cpu)
```

```json
{
  "name": "cpu_smallcore_mask",
  "collision_type": "Static Duplication",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 13835058055282336128,
      "name": "cpu_smallcore_mask",
      "external": false,
      "loc": "arch/powerpc/include/asm/smp.h:131",
    ...
    },
    {
      ...
      "inline": "declared, inlined",
      "caller_inline": [
        "arch/powerpc/kernel/smp.c:smallcore_smt_mask",

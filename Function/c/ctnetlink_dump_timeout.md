# Function: <code>ctnetlink_dump_timeout</code>
...
```c
int ctnetlink_dump_timeout(struct sk_buff * skb, const struct nf_conn * ct)
```

```json
{
  "name": "ctnetlink_dump_timeout",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588986960,
      "name": "ctnetlink_dump_timeout",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:168",

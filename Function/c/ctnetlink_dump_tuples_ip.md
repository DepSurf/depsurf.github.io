# Function: <code>ctnetlink_dump_tuples_ip</code>
...
```c
int ctnetlink_dump_tuples_ip(struct sk_buff * skb, const struct nf_conntrack_tuple * tuple)
```

```json
{
  "name": "ctnetlink_dump_tuples_ip",
  ...
  "funcs": [
    {
      ...
      "name": "ctnetlink_dump_tuples_ip",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:101",

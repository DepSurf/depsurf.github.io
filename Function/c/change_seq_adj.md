# Function: <code>change_seq_adj</code>
...
```c
int change_seq_adj(struct nf_ct_seqadj * seq, const const struct nlattr * attr)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588988160,
      "name": "change_seq_adj",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:1748",

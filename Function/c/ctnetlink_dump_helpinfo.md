# Function: <code>ctnetlink_dump_helpinfo</code>
...
```c
int ctnetlink_dump_helpinfo(struct sk_buff * skb, const struct nf_conn * ct)
```

```json
{
  "name": "ctnetlink_dump_helpinfo",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588997600,
      "name": "ctnetlink_dump_helpinfo",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:204",

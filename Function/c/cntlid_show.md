# Function: <code>cntlid_show</code>
...
```c
ssize_t cntlid_show(struct device * dev, struct device_attribute * attr, char * buf)
```
  ...
  "funcs": [
    {
      ...
      "name": "cntlid_show",
      "external": false,
      "loc": "drivers/nvme/host/core.c:3171",

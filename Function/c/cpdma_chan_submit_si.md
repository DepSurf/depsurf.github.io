# Function: <code>cpdma_chan_submit_si</code>
...
```c
int cpdma_chan_submit_si(struct submit_info * si)
```

```json
{
  "name": "cpdma_chan_submit_si",
  ...
  "funcs": [
    {
      ...
      "name": "cpdma_chan_submit_si",
      "external": false,
      "loc": "drivers/net/ethernet/ti/davinci_cpdma.c:1016",

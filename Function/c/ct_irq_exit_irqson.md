# Function: <code>ct_irq_exit_irqson</code>
...
```c
void ct_irq_exit_irqson()
```

```json
{
  "name": "ct_irq_exit_irqson",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071582342128,
      "name": "ct_irq_exit_irqson",
      "external": true,
      "loc": "kernel/context_tracking.c:417",

...
```json
{
  "name": "ccu_gate_helper_disable",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446603336497978272,
      "name": "ccu_gate_helper_disable",
      "external": true,
      "loc": "drivers/clk/sunxi-ng/ccu_gate.c:12",
  ...
  "symbols": [
    {
      "addr": 18446603336497978016,
      "name": "ccu_gate_helper_disable.part.0",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 220
    },
    {
      "addr": 18446603336497978584,
      "name": "ccu_gate_helper_disable",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 56

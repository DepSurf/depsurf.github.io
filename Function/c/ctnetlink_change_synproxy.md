# Function: <code>ctnetlink_change_synproxy</code>
...
```c
int ctnetlink_change_synproxy(struct nf_conn * ct, const const struct nlattr * * cda)
```

```json
{
  "name": "ctnetlink_change_synproxy",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588988672,
      "name": "ctnetlink_change_synproxy",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:1822",

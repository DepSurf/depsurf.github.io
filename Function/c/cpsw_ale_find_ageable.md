# Function: <code>cpsw_ale_find_ageable</code>
...
```c
int cpsw_ale_find_ageable(struct cpsw_ale * ale)
```

```json
{
  "name": "cpsw_ale_find_ageable",
  ...
  "funcs": [
    {
      ...
      "name": "cpsw_ale_find_ageable",
      "external": false,
      "loc": "drivers/net/ethernet/ti/cpsw_ale.c:222",

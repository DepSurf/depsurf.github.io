# Function: <code>ctnetlink_dump_acct</code>
...
```c
int ctnetlink_dump_acct(struct sk_buff * skb, const struct nf_conn * ct, int type)
```

```json
{
  "name": "ctnetlink_dump_acct",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588987392,
      "name": "ctnetlink_dump_acct",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:271",

# Function: <code>_cpdma_control_set</code>
...
```c
int _cpdma_control_set(struct cpdma_ctlr * ctlr, int control, int value)
```

```json
{
  "name": "_cpdma_control_set",
  ...
  "funcs": [
    {
      ...
      "name": "_cpdma_control_set",
      "external": false,
      "loc": "drivers/net/ethernet/ti/davinci_cpdma.c:306",

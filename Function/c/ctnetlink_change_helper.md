# Function: <code>ctnetlink_change_helper</code>
...
```c
int ctnetlink_change_helper(struct nf_conn * ct, const const struct nlattr * * cda)
```

```json
{
  "name": "ctnetlink_change_helper",
  ...
  "funcs": [
    {
      ...
      "name": "ctnetlink_change_helper",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:1619",

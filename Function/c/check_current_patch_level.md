...
```json
{
  "name": "check_current_patch_level",
  ...
  "funcs": [
    {
      ...
      "name": "check_current_patch_level",
      "external": true,
      "loc": "arch/x86/kernel/cpu/microcode/amd.c:627",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579165648,
      "name": "check_current_patch_level",
      "external": true,
      "loc": "arch/x86/kernel/cpu/microcode/amd.c:639",
      "file": "arch/x86/kernel/cpu/microcode/amd.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

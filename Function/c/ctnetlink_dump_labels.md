# Function: <code>ctnetlink_dump_labels</code>
...
```c
int ctnetlink_dump_labels(struct sk_buff * skb, const struct nf_conn * ct)
```

```json
{
  "name": "ctnetlink_dump_labels",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588986016,
      "name": "ctnetlink_dump_labels",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:368",

# Function: <code>cpsw_ale_del_ucast</code>
...
```c
int cpsw_ale_del_ucast(struct cpsw_ale * ale, const u8 * addr, int port, int flags, u16 vid)
```

```json
{
  "name": "cpsw_ale_del_ucast",
  ...
  "funcs": [
    {
      ...
      "name": "cpsw_ale_del_ucast",
      "external": true,
      "loc": "drivers/net/ethernet/ti/cpsw_ale.c:333",

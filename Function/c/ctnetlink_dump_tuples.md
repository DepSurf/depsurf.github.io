# Function: <code>ctnetlink_dump_tuples</code>
...
```c
int ctnetlink_dump_tuples(struct sk_buff * skb, const struct nf_conntrack_tuple * tuple)
```

```json
{
  "name": "ctnetlink_dump_tuples",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588990560,
      "name": "ctnetlink_dump_tuples",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:128",

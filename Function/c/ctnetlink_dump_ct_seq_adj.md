# Function: <code>ctnetlink_dump_ct_seq_adj</code>
...
```c
int ctnetlink_dump_ct_seq_adj(struct sk_buff * skb, struct nf_conn * ct)
```

```json
{
  "name": "ctnetlink_dump_ct_seq_adj",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588986496,
      "name": "ctnetlink_dump_ct_seq_adj",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:438",

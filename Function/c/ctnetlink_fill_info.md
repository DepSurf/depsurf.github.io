# Function: <code>ctnetlink_fill_info</code>
...
```c
int ctnetlink_fill_info(struct sk_buff * skb, u32 portid, u32 seq, u32 type, struct nf_conn * ct)
```

```json
{
  "name": "ctnetlink_fill_info",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588998976,
      "name": "ctnetlink_fill_info",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:510",

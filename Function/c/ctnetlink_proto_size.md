# Function: <code>ctnetlink_proto_size</code>
...
```c
size_t ctnetlink_proto_size(const struct nf_conn * ct)
```

```json
{
  "name": "ctnetlink_proto_size",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588989568,
      "name": "ctnetlink_proto_size",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:591",

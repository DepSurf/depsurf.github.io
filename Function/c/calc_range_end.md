# Function: <code>calc_range_end</code>
...
```c
long unsigned int calc_range_end(long unsigned int start, long unsigned int end)
```
  ...
  "funcs": [
    {
      ...
      "name": "calc_range_end",
      "external": false,
      "loc": "arch/arm/mm/cache-feroceon-l2.c:142",

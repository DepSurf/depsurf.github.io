# Function: <code>clk_pll_wait_for_lock</code>
...
```c
int clk_pll_wait_for_lock(struct tegra_clk_pll * pll)
```

```json
{
  "name": "clk_pll_wait_for_lock",
  ...
  "funcs": [
    {
      ...
      "name": "clk_pll_wait_for_lock",
      "external": false,
      "loc": "drivers/clk/tegra/clk-pll.c:291",
      ...
      "caller_func": [
        ...
        "drivers/clk/tegra/clk-pll.c:tegra_pll_wait_for_lock"
      ]
    }
  ],
  "symbols": [

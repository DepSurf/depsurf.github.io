# Function: <code>ctnetlink_dump_ct_synproxy</code>
...
```c
int ctnetlink_dump_ct_synproxy(struct sk_buff * skb, struct nf_conn * ct)
```

```json
{
  "name": "ctnetlink_dump_ct_synproxy",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588986672,
      "name": "ctnetlink_dump_ct_synproxy",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:462",

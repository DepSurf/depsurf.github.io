# Function: <code>ccu_gate_helper_enable</code>
...
```json
{
  "name": "ccu_gate_helper_enable",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446603336497978552,
      "name": "ccu_gate_helper_enable",
      "external": true,
      "loc": "drivers/clk/sunxi-ng/ccu_gate.c:35",
  ...
  "symbols": [
    {
      "addr": 18446603336497978296,
      "name": "ccu_gate_helper_enable.part.0",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 220
    },
    {
      "addr": 18446603336497978640,
      "name": "ccu_gate_helper_enable",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 60

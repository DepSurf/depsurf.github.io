# Function: <code>__cpufreq_governor</code>
...
```c
int __cpufreq_governor(struct cpufreq_policy * policy, unsigned int event)
```

```json
{
  "name": "__cpufreq_governor",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071585856960,
      "name": "__cpufreq_governor",
      "external": false,
      "loc": "drivers/cpufreq/cpufreq.c:1922",

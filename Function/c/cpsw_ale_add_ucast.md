# Function: <code>cpsw_ale_add_ucast</code>
...
```c
int cpsw_ale_add_ucast(struct cpsw_ale * ale, const u8 * addr, int port, int flags, u16 vid)
```

```json
{
  "name": "cpsw_ale_add_ucast",
  ...
  "funcs": [
    {
      ...
      "name": "cpsw_ale_add_ucast",
      "external": true,
      "loc": "drivers/net/ethernet/ti/cpsw_ale.c:307",

# Function: <code>cec_pin_low</code>
...
```c
void cec_pin_low(struct cec_pin * pin)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446603336500921192,
      "name": "cec_pin_low",
      "external": false,
      "loc": "drivers/media/cec/cec-pin.c:144",

# Function: <code>ctnetlink_attach_labels</code>
...
```c
int ctnetlink_attach_labels(struct nf_conn * ct, const const struct nlattr * * cda)
```

```json
{
  "name": "ctnetlink_attach_labels",
  ...
  "funcs": [
    {
      ...
      "name": "ctnetlink_attach_labels",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:1851",

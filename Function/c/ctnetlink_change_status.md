# Function: <code>ctnetlink_change_status</code>
...
```c
int ctnetlink_change_status(struct nf_conn * ct, const const struct nlattr * * cda)
```

```json
{
  "name": "ctnetlink_change_status",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588989872,
      "name": "ctnetlink_change_status",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:1574",

# Function: <code>__ctnetlink_change_status</code>
...
```c
void __ctnetlink_change_status(struct nf_conn * ct, long unsigned int on, long unsigned int off)
```

```json
{
  "name": "__ctnetlink_change_status",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588989776,
      "name": "__ctnetlink_change_status",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:1556",

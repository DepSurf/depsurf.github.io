  ...
  "funcs": [
    {
      ...
      "name": "copy_xstate_to_uabi_buf",
      "external": true,
      "loc": "arch/x86/kernel/fpu/xstate.c:975",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579201200,
      "name": "copy_xstate_to_uabi_buf",
      "external": true,
      "loc": "arch/x86/kernel/fpu/xstate.c:1179",
      "file": "arch/x86/kernel/fpu/xstate.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "copy_xstate_to_uabi_buf",
      "external": true,
      "loc": "arch/x86/kernel/fpu/xstate.c:1188",
      "file": "arch/x86/kernel/fpu/xstate.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

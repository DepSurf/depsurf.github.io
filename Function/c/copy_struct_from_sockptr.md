# Function: <code>copy_struct_from_sockptr</code>
...
```c
int copy_struct_from_sockptr(void * dst, size_t ksize, sockptr_t src, size_t usize)
```

```json
{
  "name": "copy_struct_from_sockptr",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071595965728,
      "name": "copy_struct_from_sockptr",
      "external": false,

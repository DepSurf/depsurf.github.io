...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580009102,
      "name": "copy_data",
      "external": false,
      "loc": "kernel/printk/printk_ringbuffer.c:1694",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580287802,
      "name": "copy_data",
      "external": false,
      "loc": "kernel/printk/printk_ringbuffer.c:1705",
      "file": "kernel/printk/printk_ringbuffer.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "kernel/printk/printk_ringbuffer.c:_prb_read_valid"

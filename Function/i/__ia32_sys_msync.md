# Function: <code>__ia32_sys_msync</code>
...
```c
long int __ia32_sys_msync(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_sys_msync",
...
```c
long int __ia32_sys_msync(const struct pt_regs * __unused)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071583250096,
      "name": "__ia32_sys_msync",
      "external": true,
      "loc": "kernel/sys_ni.c:182",
      "file": "kernel/sys_ni.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

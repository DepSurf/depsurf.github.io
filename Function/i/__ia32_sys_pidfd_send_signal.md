# Function: <code>__ia32_sys_pidfd_send_signal</code>
...
```c
long int __ia32_sys_pidfd_send_signal(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_sys_pidfd_send_signal",

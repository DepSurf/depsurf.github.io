...
```json
{
  "name": "iommu_flush_irt_and_complete",
  ...
  "funcs": [
    {
      ...
      "name": "iommu_flush_irt_and_complete",
      "external": false,
      "loc": "drivers/iommu/amd/iommu.c:2830",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596768284,
      "name": "iommu_flush_irt_and_complete.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 21
    }
  ...
  "funcs": [
    {
      ...
      "name": "iommu_flush_irt_and_complete",
      "external": false,
      "loc": "drivers/iommu/amd/iommu.c:2869",
      "file": "drivers/iommu/amd/iommu.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

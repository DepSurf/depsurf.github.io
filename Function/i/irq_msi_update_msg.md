  ...
  "funcs": [
    {
      ...
      "name": "irq_msi_update_msg",
      "external": false,
      "loc": "arch/x86/kernel/apic/msi.c:53",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579321843,
      "name": "irq_msi_update_msg",
      "external": false,
      "loc": "arch/x86/kernel/apic/msi.c:25",
      "file": "arch/x86/kernel/apic/msi.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "arch/x86/kernel/apic/msi.c:msi_set_affinity",

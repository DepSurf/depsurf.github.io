# Function: <code>its_free_pending_table</code>
...
```c
void its_free_pending_table(struct page * pt)
```

```json
{
  "name": "its_free_pending_table",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336496396680,
      "name": "its_free_pending_table",
      "external": false,
      "loc": "drivers/irqchip/irq-gic-v3-its.c:2028",

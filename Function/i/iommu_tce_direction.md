# Function: <code>iommu_tce_direction</code>
...
```c
enum dma_data_direction iommu_tce_direction(long unsigned int tce)
```

```json
{
  "name": "iommu_tce_direction",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282495632,
      "name": "iommu_tce_direction",
      "external": true,
      "loc": "arch/powerpc/kernel/iommu.c:961",

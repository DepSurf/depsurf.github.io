# Function: <code>ipv4_conntrack_in</code>
...
```c
unsigned int ipv4_conntrack_in(void * priv, struct sk_buff * skb, const struct nf_hook_state * state)
```
  ...
  "funcs": [
    {
      ...
      "name": "ipv4_conntrack_in",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_proto.c:174",

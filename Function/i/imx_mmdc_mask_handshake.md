# Function: <code>imx_mmdc_mask_handshake</code>
...
```c
void imx_mmdc_mask_handshake(void * ccm_base, unsigned int chn)
```

```json
{
  "name": "imx_mmdc_mask_handshake",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336511150372,
      "name": "imx_mmdc_mask_handshake",
      "external": true,
      "loc": "drivers/clk/imx/clk.c:25",

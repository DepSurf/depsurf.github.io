# Function: <code>imx_clk_hw_pllv3</code>
...
```c
struct clk_hw * imx_clk_hw_pllv3(enum imx_pllv3_type type, const char * name, const char * parent_name, void * base, u32 div_mask)
```

```json
{
  "name": "imx_clk_hw_pllv3",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336497846512,
      "name": "imx_clk_hw_pllv3",
      "external": true,
      "loc": "drivers/clk/imx/clk-pllv3.c:413",

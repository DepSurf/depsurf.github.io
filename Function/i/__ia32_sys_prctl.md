# Function: <code>__ia32_sys_prctl</code>
...
```c
long int __ia32_sys_prctl(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_sys_prctl",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071579534544,
      "name": "__ia32_sys_prctl",
      "external": true,

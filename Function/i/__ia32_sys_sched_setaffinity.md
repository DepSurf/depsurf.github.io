# Function: <code>__ia32_sys_sched_setaffinity</code>
...
```c
long int __ia32_sys_sched_setaffinity(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_sys_sched_setaffinity",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071579637664,
      "name": "__ia32_sys_sched_setaffinity",
      "external": true,

...
```c
struct iomap_folio_state * ifs_alloc(struct inode * inode, struct folio * folio, unsigned int flags)
```
  ...
  "funcs": [
    {
      ...
      "name": "ifs_alloc",
      "external": false,
      "loc": "fs/iomap/buffered-io.c:144",

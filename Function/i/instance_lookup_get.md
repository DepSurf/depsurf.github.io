# Function: <code>instance_lookup_get</code>
...
```c
struct nfulnl_instance * instance_lookup_get(struct nfnl_log_net * log, u_int16_t group_num)
```

```json
{
  "name": "instance_lookup_get",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588918048,
      "name": "instance_lookup_get",
      "external": false,
      "loc": "net/netfilter/nfnetlink_log.c:121",

# Function: <code>__ia32_sys_pivot_root</code>
...
```c
long int __ia32_sys_pivot_root(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_sys_pivot_root",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071581736128,
      "name": "__ia32_sys_pivot_root",
      "external": true,

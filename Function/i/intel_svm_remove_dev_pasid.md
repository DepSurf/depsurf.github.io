...
```json
{
  "name": "intel_svm_remove_dev_pasid",
  ...
  "funcs": [
    {
      ...
      "name": "intel_svm_remove_dev_pasid",
      "external": true,
      "loc": "drivers/iommu/intel/svm.c:844",
  ...
  "funcs": [
    {
      ...
      "name": "intel_svm_remove_dev_pasid",
      "external": true,
      "loc": "drivers/iommu/intel/svm.c:830",
      "file": "drivers/iommu/intel/svm.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071590825952,
      "name": "intel_svm_remove_dev_pasid",
      "external": true,
      "loc": "drivers/iommu/intel/svm.c:393",
      "file": "drivers/iommu/intel/svm.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

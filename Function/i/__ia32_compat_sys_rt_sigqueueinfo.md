# Function: <code>__ia32_compat_sys_rt_sigqueueinfo</code>
...
```c
long int __ia32_compat_sys_rt_sigqueueinfo(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_compat_sys_rt_sigqueueinfo",

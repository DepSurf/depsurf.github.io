# Function: <code>__ia32_sys_setregid</code>
...
```c
long int __ia32_sys_setregid(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_sys_setregid",

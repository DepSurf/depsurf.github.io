# Function: <code>__ia32_sys_rt_sigtimedwait</code>
...
```c
long int __ia32_sys_rt_sigtimedwait(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_sys_rt_sigtimedwait",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071579507680,
      "name": "__ia32_sys_rt_sigtimedwait",
      "external": true,

...
```json
{
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071594120416,
      "name": "io_try_cancel.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 30
    }
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586833184,
      "name": "io_try_cancel",
      "external": true,
      "loc": "io_uring/cancel.c:81",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071587379552,
      "name": "io_try_cancel",
      "external": true,
      "loc": "io_uring/cancel.c:104",
      "file": "io_uring/cancel.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

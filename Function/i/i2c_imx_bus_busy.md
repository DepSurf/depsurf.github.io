# Function: <code>i2c_imx_bus_busy</code>
...
```c
int i2c_imx_bus_busy(struct imx_i2c_struct * i2c_imx, int for_busy)
```

```json
{
  "name": "i2c_imx_bus_busy",
  ...
  "funcs": [
    {
      ...
      "name": "i2c_imx_bus_busy",
      "external": false,
      "loc": "drivers/i2c/busses/i2c-imx.c:417",

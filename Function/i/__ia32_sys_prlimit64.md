# Function: <code>__ia32_sys_prlimit64</code>
...
```c
long int __ia32_sys_prlimit64(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_sys_prlimit64",

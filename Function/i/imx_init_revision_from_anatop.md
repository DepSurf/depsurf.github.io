# Function: <code>imx_init_revision_from_anatop</code>
...
```c
void imx_init_revision_from_anatop()
```

```json
{
  "name": "imx_init_revision_from_anatop",
  ...
  "funcs": [
    {
      ...
      "name": "imx_init_revision_from_anatop",
      "external": true,
      "loc": "arch/arm/mach-imx/anatop.c:109",

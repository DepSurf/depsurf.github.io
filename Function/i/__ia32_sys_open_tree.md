# Function: <code>__ia32_sys_open_tree</code>
...
```c
long int __ia32_sys_open_tree(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_sys_open_tree",

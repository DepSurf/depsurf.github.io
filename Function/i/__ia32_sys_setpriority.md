# Function: <code>__ia32_sys_setpriority</code>
...
```c
long int __ia32_sys_setpriority(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_sys_setpriority",

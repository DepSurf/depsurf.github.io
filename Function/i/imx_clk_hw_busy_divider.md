# Function: <code>imx_clk_hw_busy_divider</code>
...
```c
struct clk_hw * imx_clk_hw_busy_divider(const char * name, const char * parent_name, void * reg, u8 shift, u8 width, void * busy_reg, u8 busy_shift)
```

```json
{
  "name": "imx_clk_hw_busy_divider",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336497832168,
      "name": "imx_clk_hw_busy_divider",
      "external": true,
      "loc": "drivers/clk/imx/clk-busy.c:75",

# Function: <code>imputed_trust_enabled</code>
...
```c
bool imputed_trust_enabled()
```

```json
{
  "name": "imputed_trust_enabled",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071622021936,
      "name": "imputed_trust_enabled",
      "external": true,
      "loc": "security/integrity/platform_certs/machine_keyring.c:85",

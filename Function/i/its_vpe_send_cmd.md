...
```c
void its_vpe_send_cmd(struct its_vpe * vpe, void (*)(struct its_device *, u32) cmd)
```

```json
{
  "name": "its_vpe_send_cmd",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336496391424,
      "name": "its_vpe_send_cmd",
      "external": false,
      "loc": "drivers/irqchip/irq-gic-v3-its.c:2910",

# Function: <code>imx_clk_pllv2</code>
...
```c
struct clk * imx_clk_pllv2(const char * name, const char * parent, void * base)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446603336497844288,
      "name": "imx_clk_pllv2",
      "external": true,
      "loc": "drivers/clk/imx/clk-pllv2.c:242",

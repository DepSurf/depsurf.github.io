# Function: <code>__ia32_sys_clock_adjtime</code>
...
```c
long int __ia32_sys_clock_adjtime(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_sys_clock_adjtime",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071580018800,
      "name": "__ia32_sys_clock_adjtime",
      "external": true,
...
```c
long int __ia32_sys_clock_adjtime(const struct pt_regs * __unused)
```

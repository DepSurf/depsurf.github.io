...
```json
{
  "name": "iommu_uapi_sva_bind_gpasid",
  ...
  "funcs": [
    {
      ...
      "name": "iommu_uapi_sva_bind_gpasid",
      "external": true,
      "loc": "drivers/iommu/iommu.c:2149",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586825744,
      "name": "iommu_uapi_sva_bind_gpasid",
      "external": true,
      "loc": "drivers/iommu/iommu.c:2180",
      "file": "drivers/iommu/iommu.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071587386192,
      "name": "iommu_uapi_sva_bind_gpasid",
      "external": true,
      "loc": "drivers/iommu/iommu.c:2201",
      "file": "drivers/iommu/iommu.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

# Function: <code>instance_destroy_rcu</code>
...
```c
void instance_destroy_rcu(struct callback_head * head)
```

```json
{
  "name": "instance_destroy_rcu",
  ...
  "funcs": [
    {
      ...
      "name": "instance_destroy_rcu",
      "external": false,
      "loc": "net/netfilter/nfnetlink_queue.c:165",

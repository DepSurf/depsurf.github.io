# Function: <code>i2c_nuvoton_ready</code>
...
```c
void i2c_nuvoton_ready(struct tpm_chip * chip)
```

```json
{
  "name": "i2c_nuvoton_ready",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 13835058055292024640,
      "name": "i2c_nuvoton_ready",
      "external": false,
      "loc": "drivers/char/tpm/tpm_i2c_nuvoton.c:121",

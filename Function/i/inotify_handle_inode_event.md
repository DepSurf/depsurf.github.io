...
```json
{
  "name": "inotify_handle_inode_event",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582501328,
      "name": "inotify_handle_inode_event",
      "external": true,
      "loc": "fs/notify/inotify/inotify_fsnotify.c:59",
      "file": "fs/notify/inotify/inotify_fsnotify.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

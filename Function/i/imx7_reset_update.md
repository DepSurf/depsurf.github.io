# Function: <code>imx7_reset_update</code>
...
```json
{
  "name": "imx7_reset_update",
  "collision_type": "Unique Static",
  "inline_type": "Full",
  "funcs": [
    {
      "addr": 18446603336498337172,
      "name": "imx7_reset_update",
      "external": false,
      "loc": "drivers/reset/reset-imx7.c:47",
...
```c
int imx7_reset_update(struct imx7_src * imx7src, long unsigned int id, unsigned int value)
```

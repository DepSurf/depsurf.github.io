# Function: <code>init_vp_index</code>
...
```c
void init_vp_index(struct vmbus_channel * channel, u16 dev_type)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071587572096,
      "name": "init_vp_index",
      "external": false,
      "loc": "drivers/hv/channel_mgmt.c:652",

# Function: <code>__ia32_compat_sys_getrusage</code>
...
```c
long int __ia32_compat_sys_getrusage(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_compat_sys_getrusage",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071579534448,
      "name": "__ia32_compat_sys_getrusage",
      "external": true,

# Function: <code>ima_update_policy_flags</code>
...
```c
void ima_update_policy_flags()
```

```json
{
  "name": "ima_update_policy_flags",
  ...
  "funcs": [
    {
      ...
      "name": "ima_update_policy_flags",
      "external": true,
      "loc": "security/integrity/ima/ima_policy.c:794",
      "file": "security/integrity/ima/ima_policy.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "ima_update_policy_flags",
      "external": true,
      "loc": "security/integrity/ima/ima_policy.c:843",
      "file": "security/integrity/ima/ima_policy.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "ima_update_policy_flags",
      "external": true,
      "loc": "security/integrity/ima/ima_policy.c:836",
      "file": "security/integrity/ima/ima_policy.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

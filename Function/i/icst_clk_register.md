...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "icst_clk_register",
      "external": true,
      "loc": "drivers/clk/versatile/clk-icst.c:380",
  ...
  "symbols": [
    {
      "addr": 18446744071592426794,
      "name": "icst_clk_register.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 31
    },
    {
      "addr": 18446744071586706672,
      "name": "icst_clk_register",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 197
  ...
  "funcs": [
    {
      ...
      "name": "icst_clk_register",
      "external": true,
      "loc": "drivers/clk/versatile/clk-icst.c:390",
      "file": "drivers/clk/versatile/clk-icst.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>__ia32_sys_fchownat</code>
...
```c
long int __ia32_sys_fchownat(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_sys_fchownat",

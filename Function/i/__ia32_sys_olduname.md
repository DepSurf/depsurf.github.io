# Function: <code>__ia32_sys_olduname</code>
...
```c
long int __ia32_sys_olduname(const struct pt_regs * regs)
```

```json
{
  "name": "__ia32_sys_olduname",

...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579899520,
      "name": "__irq_put_desc_unlock",
      "external": true,
      "loc": "kernel/irq/irqdesc.c:838",
      "file": "kernel/irq/irqdesc.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580032768,
      "name": "__irq_put_desc_unlock",
      "external": true,
      "loc": "kernel/irq/irqdesc.c:899",
      "file": "kernel/irq/irqdesc.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580016512,
      "name": "__irq_put_desc_unlock",
      "external": true,
      "loc": "kernel/irq/irqdesc.c:850",
      "file": "kernel/irq/irqdesc.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580505136,
      "name": "__irq_put_desc_unlock",
      "external": true,
      "loc": "kernel/irq/irqdesc.c:866",
      "file": "kernel/irq/irqdesc.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580577280,
      "name": "__irq_put_desc_unlock",
      "external": true,
      "loc": "kernel/irq/irqdesc.c:885",
      "file": "kernel/irq/irqdesc.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>icp_rm_deliver_irq</code>
...
```c
void icp_rm_deliver_irq(struct kvmppc_xics * xics, struct kvmppc_icp * icp, u32 new_irq, bool check_resend)
```

```json
{
  "name": "icp_rm_deliver_irq",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055283354400,
      "name": "icp_rm_deliver_irq",
      "external": false,
      "loc": "arch/powerpc/kvm/book3s_hv_rm_xics.c:284",

# Function: <code>ip_tunnel_find</code>
...
```c
struct ip_tunnel * ip_tunnel_find(struct ip_tunnel_net * itn, struct ip_tunnel_parm * parms, int type)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588702160,
      "name": "ip_tunnel_find",
      "external": false,
      "loc": "net/ipv4/ip_tunnel.c:211",

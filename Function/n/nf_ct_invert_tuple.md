# Function: <code>nf_ct_invert_tuple</code>
...
```c
bool nf_ct_invert_tuple(struct nf_conntrack_tuple * inverse, const struct nf_conntrack_tuple * orig)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588924288,
      "name": "nf_ct_invert_tuple",
      "external": true,
      "loc": "net/netfilter/nf_conntrack_core.c:410",

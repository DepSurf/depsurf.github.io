...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "nvme_set_queue_count",
      "external": true,
      "loc": "drivers/nvme/host/core.c:1198",
  ...
  "symbols": [
    {
      "addr": 18446744071586482649,
      "name": "nvme_set_queue_count.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 35
    },
    {
      "addr": 18446744071586463440,
      "name": "nvme_set_queue_count",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 141

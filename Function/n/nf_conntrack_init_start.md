# Function: <code>nf_conntrack_init_start</code>
...
```c
int nf_conntrack_init_start()
```

```json
{
  "name": "nf_conntrack_init_start",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588940000,
      "name": "nf_conntrack_init_start",
      "external": true,
      "loc": "net/netfilter/nf_conntrack_core.c:2370",

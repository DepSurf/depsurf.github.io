# Function: <code>netkit_entry_fetch</code>
...
```c
struct bpf_mprog_entry * netkit_entry_fetch(struct net_device * dev, bool bundle_fallback)
```

```json
{
  "name": "netkit_entry_fetch",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071597717758,
      "name": "netkit_entry_fetch.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 21
    }

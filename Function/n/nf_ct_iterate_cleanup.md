# Function: <code>nf_ct_iterate_cleanup</code>
...
```c
void nf_ct_iterate_cleanup(int (*)(struct nf_conn *, void *) iter, void * data, u32 portid, int report)
```

```json
{
  "name": "nf_ct_iterate_cleanup",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588932080,
      "name": "nf_ct_iterate_cleanup",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_core.c:2025",

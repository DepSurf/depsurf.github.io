# Function: <code>nf_ct_expect_event_report</code>
...
```c
void nf_ct_expect_event_report(enum ip_conntrack_expect_events event, struct nf_conntrack_expect * exp, u32 portid, int report)
```

```json
{
  "name": "nf_ct_expect_event_report",
  ...
  "funcs": [
    {
      ...
      "name": "nf_ct_expect_event_report",
      "external": true,
      "loc": "net/netfilter/nf_conntrack_ecache.c:230",

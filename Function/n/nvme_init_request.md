# Function: <code>nvme_init_request</code>
...
```c
int nvme_init_request(struct blk_mq_tag_set * set, struct request * req, unsigned int hctx_idx, unsigned int numa_node)
```

```json
{
  "name": "nvme_init_request",
  ...
  "funcs": [
    {
      ...
      "name": "nvme_init_request",
      "external": false,
      "loc": "drivers/nvme/host/pci.c:395",

# Function: <code>nvme_set_disk_name</code>
...
```c
void nvme_set_disk_name(char * disk_name, struct nvme_ns * ns, struct nvme_ctrl * ctrl, int * flags)
```

```json
{
  "name": "nvme_set_disk_name",
  ...
  "funcs": [
    {
      ...
      "name": "nvme_set_disk_name",
      "external": true,
      "loc": "drivers/nvme/host/multipath.c:52",

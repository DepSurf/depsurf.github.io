# Function: <code>nvme_do_delete_ctrl</code>
...
```c
void nvme_do_delete_ctrl(struct nvme_ctrl * ctrl)
```

```json
{
  "name": "nvme_do_delete_ctrl",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586483153,
      "name": "nvme_do_delete_ctrl",
      "external": false,
      "loc": "drivers/nvme/host/core.c:164",
      "file": "drivers/nvme/host/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "drivers/nvme/host/core.c:nvme_sysfs_delete",
        "drivers/nvme/host/core.c:nvme_delete_ctrl_work"
      ]
    }
  ],
  "symbols": [

# Function: <code>nvme_async_probe</code>
...
```c
void nvme_async_probe(void * data, async_cookie_t cookie)
```

```json
{
  "name": "nvme_async_probe",
  ...
  "funcs": [
    {
      ...
      "name": "nvme_async_probe",
      "external": false,
      "loc": "drivers/nvme/host/pci.c:2773",

# Function: <code>nvme_submit_io</code>
...
```c
int nvme_submit_io(struct nvme_ns * ns, struct nvme_user_io * uio)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586458480,
      "name": "nvme_submit_io",
      "external": false,
      "loc": "drivers/nvme/host/core.c:1247",

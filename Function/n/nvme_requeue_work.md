# Function: <code>nvme_requeue_work</code>
...
```c
void nvme_requeue_work(struct work_struct * work)
```

```json
{
  "name": "nvme_requeue_work",
  ...
  "funcs": [
    {
      ...
      "name": "nvme_requeue_work",
      "external": false,
      "loc": "drivers/nvme/host/multipath.c:339",

# Function: <code>nvme_alloc_queue</code>
...
```c
int nvme_alloc_queue(struct nvme_dev * dev, int qid, int depth)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586501232,
      "name": "nvme_alloc_queue",
      "external": false,
      "loc": "drivers/nvme/host/pci.c:1477",

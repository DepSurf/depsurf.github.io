# Function: <code>nvme_wait_freeze_timeout</code>
...
```c
void nvme_wait_freeze_timeout(struct nvme_ctrl * ctrl, long int timeout)
```

```json
{
  "name": "nvme_wait_freeze_timeout",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586457008,
      "name": "nvme_wait_freeze_timeout",
      "external": true,
      "loc": "drivers/nvme/host/core.c:4129",

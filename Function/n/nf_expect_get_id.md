# Function: <code>nf_expect_get_id</code>
...
```c
__be32 nf_expect_get_id(const struct nf_conntrack_expect * exp)
```

```json
{
  "name": "nf_expect_get_id",
  ...
  "funcs": [
    {
      ...
      "name": "nf_expect_get_id",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:2708",

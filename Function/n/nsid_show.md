...
```c
ssize_t nsid_show(struct device * dev, struct device_attribute * attr, char * buf)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586454672,
      "name": "nsid_show",
      "external": false,
      "loc": "drivers/nvme/host/core.c:3085",

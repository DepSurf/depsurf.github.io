# Function: <code>nvme_submit_user_cmd</code>
...
```c
int nvme_submit_user_cmd(struct request_queue * q, struct nvme_command * cmd, void * ubuffer, unsigned int bufflen, void * meta_buffer, unsigned int meta_len, u32 meta_seed, u64 * result, unsigned int timeout)
```

```json
{
  "name": "nvme_submit_user_cmd",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586457616,
      "name": "nvme_submit_user_cmd",
      "external": false,
      "loc": "drivers/nvme/host/core.c:895",

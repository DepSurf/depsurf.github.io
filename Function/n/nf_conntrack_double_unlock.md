# Function: <code>nf_conntrack_double_unlock</code>
...
```c
void nf_conntrack_double_unlock(unsigned int h1, unsigned int h2)
```

```json
{
  "name": "nf_conntrack_double_unlock",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588926880,
      "name": "nf_conntrack_double_unlock",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_core.c:113",

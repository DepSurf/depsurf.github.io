# Function: <code>nvme_sysfs_rescan</code>
...
```c
ssize_t nvme_sysfs_rescan(struct device * dev, struct device_attribute * attr, const char * buf, size_t count)
```

```json
{
  "name": "nvme_sysfs_rescan",
  ...
  "funcs": [
    {
      ...
      "name": "nvme_sysfs_rescan",
      "external": false,
      "loc": "drivers/nvme/host/core.c:3002",

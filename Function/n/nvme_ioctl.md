...
```c
int nvme_ioctl(struct block_device * bdev, fmode_t mode, unsigned int cmd, long unsigned int arg)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586480096,
      "name": "nvme_ioctl",
      "external": false,
      "loc": "drivers/nvme/host/core.c:1538",

# Function: <code>nvme_try_sched_reset</code>
...
```json
{
  "name": "nvme_try_sched_reset",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586452704,
      "name": "nvme_try_sched_reset",
      "external": true,
      "loc": "drivers/nvme/host/core.c:129",
      "file": "drivers/nvme/host/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "drivers/nvme/host/core.c:nvme_fw_act_work",
        "drivers/nvme/host/pci.c:nvme_simple_resume",

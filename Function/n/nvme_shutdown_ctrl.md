...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "nvme_shutdown_ctrl",
      "external": true,
      "loc": "drivers/nvme/host/core.c:2150",
  ...
  "symbols": [
    {
      "addr": 18446744071586482558,
      "name": "nvme_shutdown_ctrl.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 29
    },
    {
      "addr": 18446744071586459344,
      "name": "nvme_shutdown_ctrl",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 232

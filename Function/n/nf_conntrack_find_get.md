# Function: <code>nf_conntrack_find_get</code>
...
```c
struct nf_conntrack_tuple_hash * nf_conntrack_find_get(struct net * net, const struct nf_conntrack_zone * zone, const struct nf_conntrack_tuple * tuple)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588934560,
      "name": "nf_conntrack_find_get",
      "external": true,
      "loc": "net/netfilter/nf_conntrack_core.c:800",

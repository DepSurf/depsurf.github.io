# Function: <code>nvme_nvm_ioctl</code>
...
```c
int nvme_nvm_ioctl(struct nvme_ns * ns, unsigned int cmd, long unsigned int arg)
```
  ...
  "funcs": [
    {
      ...
      "name": "nvme_nvm_ioctl",
      "external": true,
      "loc": "drivers/nvme/host/lightnvm.c:934",
  ...
  "funcs": [
    {
      ...
      "name": "nvme_nvm_ioctl",
      "external": false,
      "loc": "drivers/nvme/host/nvme.h:643",

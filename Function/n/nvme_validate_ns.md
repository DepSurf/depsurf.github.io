# Function: <code>nvme_validate_ns</code>
...
```c
void nvme_validate_ns(struct nvme_ctrl * ctrl, unsigned int nsid)
```

```json
{
  "name": "nvme_validate_ns",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586476960,
      "name": "nvme_validate_ns",
      "external": false,
      "loc": "drivers/nvme/host/core.c:3602",

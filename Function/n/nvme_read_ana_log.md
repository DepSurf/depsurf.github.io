...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "nvme_read_ana_log",
      "external": false,
      "loc": "drivers/nvme/host/multipath.c:532",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071586490918,
      "name": "nvme_read_ana_log.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 29
    }

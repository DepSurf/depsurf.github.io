# Function: <code>nvme_remap_bar</code>
...
```c
int nvme_remap_bar(struct nvme_dev * dev, long unsigned int size)
```
  ...
  "funcs": [
    {
      ...
      "name": "nvme_remap_bar",
      "external": false,
      "loc": "drivers/nvme/host/pci.c:1659",

# Function: <code>nvme_ana_work</code>
...
```c
void nvme_ana_work(struct work_struct * work)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586486960,
      "name": "nvme_ana_work",
      "external": false,
      "loc": "drivers/nvme/host/multipath.c:570",

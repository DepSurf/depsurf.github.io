# Function: <code>nf_ct_iterate_destroy</code>
...
```c
void nf_ct_iterate_destroy(int (*)(struct nf_conn *, void *) iter, void * data)
```

```json
{
  "name": "nf_ct_iterate_destroy",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588932560,
      "name": "nf_ct_iterate_destroy",
      "external": true,
      "loc": "net/netfilter/nf_conntrack_core.c:2137",

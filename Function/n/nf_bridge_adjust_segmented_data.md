# Function: <code>nf_bridge_adjust_segmented_data</code>
...
```c
void nf_bridge_adjust_segmented_data(struct sk_buff * skb)
```

```json
{
  "name": "nf_bridge_adjust_segmented_data",
  ...
  "funcs": [
    {
      ...
      "name": "nf_bridge_adjust_segmented_data",
      "external": false,
      "loc": "net/netfilter/nfnetlink_queue.c:730",

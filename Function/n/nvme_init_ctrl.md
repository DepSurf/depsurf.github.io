# Function: <code>nvme_init_ctrl</code>
...
```c
int nvme_init_ctrl(struct nvme_ctrl * ctrl, struct device * dev, const struct nvme_ctrl_ops * ops, long unsigned int quirks)
```
  ...
  "funcs": [
    {
      ...
      "name": "nvme_init_ctrl",
      "external": true,
      "loc": "drivers/nvme/host/core.c:4018",

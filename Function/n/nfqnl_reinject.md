# Function: <code>nfqnl_reinject</code>
...
```c
void nfqnl_reinject(struct nf_queue_entry * entry, unsigned int verdict)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588909712,
      "name": "nfqnl_reinject",
      "external": false,
      "loc": "net/netfilter/nfnetlink_queue.c:226",

# Function: <code>nf_conntrack_eventmask_report</code>
...
```c
int nf_conntrack_eventmask_report(unsigned int eventmask, struct nf_conn * ct, u32 portid, int report)
```

```json
{
  "name": "nf_conntrack_eventmask_report",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588974128,
      "name": "nf_conntrack_eventmask_report",
      "external": true,
      "loc": "net/netfilter/nf_conntrack_ecache.c:120",

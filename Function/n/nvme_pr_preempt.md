# Function: <code>nvme_pr_preempt</code>
...
```c
int nvme_pr_preempt(struct block_device * bdev, u64 old, u64 new, enum pr_type type, bool abort)
```

```json
{
  "name": "nvme_pr_preempt",
  ...
  "funcs": [
    {
      ...
      "name": "nvme_pr_preempt",
      "external": false,
      "loc": "drivers/nvme/host/core.c:1974",

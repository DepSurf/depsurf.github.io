# Function: <code>nvme_ns_head_release</code>
...
```c
void nvme_ns_head_release(struct gendisk * disk, fmode_t mode)
```

```json
{
  "name": "nvme_ns_head_release",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586471680,
      "name": "nvme_ns_head_release",
      "external": false,
      "loc": "drivers/nvme/host/core.c:2044",

# Function: <code>nf_conntrack_expect_fini</code>
...
```c
void nf_conntrack_expect_fini()
```

```json
{
  "name": "nf_conntrack_expect_fini",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588950048,
      "name": "nf_conntrack_expect_fini",
      "external": true,
      "loc": "net/netfilter/nf_conntrack_expect.c:721",

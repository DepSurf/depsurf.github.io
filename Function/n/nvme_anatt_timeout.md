# Function: <code>nvme_anatt_timeout</code>
...
```c
void nvme_anatt_timeout(struct timer_list * t)
```

```json
{
  "name": "nvme_anatt_timeout",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586490871,
      "name": "nvme_anatt_timeout",
      "external": false,
      "loc": "drivers/nvme/host/multipath.c:577",

# Function: <code>nvme_ns_id_attrs_are_visible</code>
...
```c
umode_t nvme_ns_id_attrs_are_visible(struct kobject * kobj, struct attribute * a, int n)
```

```json
{
  "name": "nvme_ns_id_attrs_are_visible",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586455696,
      "name": "nvme_ns_id_attrs_are_visible",
      "external": false,
      "loc": "drivers/nvme/host/core.c:3105",

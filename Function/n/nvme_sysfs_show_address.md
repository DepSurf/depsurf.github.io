# Function: <code>nvme_sysfs_show_address</code>
...
```c
ssize_t nvme_sysfs_show_address(struct device * dev, struct device_attribute * attr, char * buf)
```

```json
{
  "name": "nvme_sysfs_show_address",
  ...
  "funcs": [
    {
      ...
      "name": "nvme_sysfs_show_address",
      "external": false,
      "loc": "drivers/nvme/host/core.c:3231",

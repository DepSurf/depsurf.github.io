# Function: <code>nfnetlink_send</code>
...
```c
int nfnetlink_send(struct sk_buff * skb, struct net * net, u32 portid, unsigned int group, int echo, gfp_t flags)
```
  ...
  "funcs": [
    {
      ...
      "name": "nfnetlink_send",
      "external": true,
      "loc": "net/netfilter/nfnetlink.c:138",

# Function: <code>nvme_change_ctrl_state</code>
...
```c
bool nvme_change_ctrl_state(struct nvme_ctrl * ctrl, enum nvme_ctrl_state new_state)
```

```json
{
  "name": "nvme_change_ctrl_state",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586453392,
      "name": "nvme_change_ctrl_state",
      "external": true,
      "loc": "drivers/nvme/host/core.c:322",

# Function: <code>nf_ct_unlink_expect_report</code>
...
```c
void nf_ct_unlink_expect_report(struct nf_conntrack_expect * exp, u32 portid, int report)
```

```json
{
  "name": "nf_ct_unlink_expect_report",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588946304,
      "name": "nf_ct_unlink_expect_report",
      "external": true,
      "loc": "net/netfilter/nf_conntrack_expect.c:47",

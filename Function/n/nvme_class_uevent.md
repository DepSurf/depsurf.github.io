# Function: <code>nvme_class_uevent</code>
...
```c
int nvme_class_uevent(struct device * dev, struct kobj_uevent_env * env)
```

```json
{
  "name": "nvme_class_uevent",
  ...
  "funcs": [
    {
      ...
      "name": "nvme_class_uevent",
      "external": false,
      "loc": "drivers/nvme/host/core.c:3782",

# Function: <code>nf_conntrack_ecache_init</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "nf_conntrack_ecache_init",
      "external": true,
      "loc": "net/netfilter/nf_conntrack_ecache.c:354",
  ...
  "symbols": [
    {
      "addr": 18446744071588975991,
      "name": "nf_conntrack_ecache_init.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 17
    },
    {
      "addr": 18446744071588975920,
      "name": "nf_conntrack_ecache_init",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 41

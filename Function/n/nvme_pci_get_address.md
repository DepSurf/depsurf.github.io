# Function: <code>nvme_pci_get_address</code>
...
```c
int nvme_pci_get_address(struct nvme_ctrl * ctrl, char * buf, int size)
```

```json
{
  "name": "nvme_pci_get_address",
  ...
  "funcs": [
    {
      ...
      "name": "nvme_pci_get_address",
      "external": false,
      "loc": "drivers/nvme/host/pci.c:2694",

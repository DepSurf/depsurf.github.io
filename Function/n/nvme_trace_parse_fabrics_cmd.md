# Function: <code>nvme_trace_parse_fabrics_cmd</code>
...
```c
const char * nvme_trace_parse_fabrics_cmd(struct trace_seq * p, u8 fctype, u8 * spc)
```

```json
{
  "name": "nvme_trace_parse_fabrics_cmd",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586485024,
      "name": "nvme_trace_parse_fabrics_cmd",
      "external": true,
      "loc": "drivers/nvme/host/trace.c:230",

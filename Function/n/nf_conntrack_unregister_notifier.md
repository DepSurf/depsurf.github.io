# Function: <code>nf_conntrack_unregister_notifier</code>
...
```json
{
  "name": "nf_conntrack_unregister_notifier",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071588975472,
      "name": "nf_conntrack_unregister_notifier",
      "external": true,
      "loc": "net/netfilter/nf_conntrack_ecache.c:282",
      "file": "net/netfilter/nf_conntrack_ecache.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [
        "net/netfilter/nf_conntrack_netlink.c:ctnetlink_net_exit_batch",
        "net/netfilter/nf_conntrack_netlink.c:ctnetlink_net_init"
      ]
    }
  ],
  "symbols": [

# Function: <code>nvme_end_sync_rq</code>
...
```c
void nvme_end_sync_rq(struct request * rq, blk_status_t error)
```

```json
{
  "name": "nvme_end_sync_rq",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586453936,
      "name": "nvme_end_sync_rq",
      "external": false,
      "loc": "drivers/nvme/host/core.c:788",

...
```c
ssize_t nguid_show(struct device * dev, struct device_attribute * attr, char * buf)
```
  ...
  "funcs": [
    {
      ...
      "name": "nguid_show",
      "external": false,
      "loc": "drivers/nvme/host/core.c:3054",

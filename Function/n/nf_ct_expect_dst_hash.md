# Function: <code>nf_ct_expect_dst_hash</code>
...
```c
unsigned int nf_ct_expect_dst_hash(const struct net * n, const struct nf_conntrack_tuple * tuple)
```

```json
{
  "name": "nf_ct_expect_dst_hash",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588947296,
      "name": "nf_ct_expect_dst_hash",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_expect.c:79",

# Function: <code>nf_conntrack_seqadj_fini</code>
...
```c
void nf_conntrack_seqadj_fini()
```

```json
{
  "name": "nf_conntrack_seqadj_fini",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588971824,
      "name": "nf_conntrack_seqadj_fini",
      "external": true,
      "loc": "net/netfilter/nf_conntrack_seqadj.c:247",

# Function: <code>nvme_remove_invalid_namespaces</code>
...
```c
void nvme_remove_invalid_namespaces(struct nvme_ctrl * ctrl, unsigned int nsid)
```

```json
{
  "name": "nvme_remove_invalid_namespaces",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586472304,
      "name": "nvme_remove_invalid_namespaces",
      "external": false,
      "loc": "drivers/nvme/host/core.c:3615",

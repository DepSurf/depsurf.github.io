# Function: <code>nf_ct_add_to_dying_list</code>
...
```c
void nf_ct_add_to_dying_list(struct nf_conn * ct)
```

```json
{
  "name": "nf_ct_add_to_dying_list",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588926656,
      "name": "nf_ct_add_to_dying_list",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_core.c:495",

# Function: <code>nvme_calc_irq_sets</code>
...
```c
void nvme_calc_irq_sets(struct irq_affinity * affd, unsigned int nrirqs)
```

```json
{
  "name": "nvme_calc_irq_sets",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586498576,
      "name": "nvme_calc_irq_sets",
      "external": false,
      "loc": "drivers/nvme/host/pci.c:2030",

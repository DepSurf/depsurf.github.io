...
```c
int nvme_parse_ana_log(struct nvme_ctrl * ctrl, void * data, int (*)(struct nvme_ctrl *, struct nvme_ana_group_desc *, void *) cb)
```

```json
{
  "name": "nvme_parse_ana_log",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586485552,
      "name": "nvme_parse_ana_log",
      "external": false,
      "loc": "drivers/nvme/host/multipath.c:438",

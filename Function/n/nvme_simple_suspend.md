# Function: <code>nvme_simple_suspend</code>
...
```c
int nvme_simple_suspend(struct device * dev)
```

```json
{
  "name": "nvme_simple_suspend",
  ...
  "funcs": [
    {
      ...
      "name": "nvme_simple_suspend",
      "external": false,
      "loc": "drivers/nvme/host/pci.c:3009",

# Function: <code>nvme_ns_head_open</code>
...
```c
int nvme_ns_head_open(struct block_device * bdev, fmode_t mode)
```

```json
{
  "name": "nvme_ns_head_open",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586471904,
      "name": "nvme_ns_head_open",
      "external": false,
      "loc": "drivers/nvme/host/core.c:2035",

# Function: <code>_nbu2ss_ep_in_end</code>
...
```c
void _nbu2ss_ep_in_end(struct nbu2ss_udc * udc, u32 epnum, u32 data32, u32 length)
```

```json
{
  "name": "_nbu2ss_ep_in_end",
  ...
  "funcs": [
    {
      ...
      "name": "_nbu2ss_ep_in_end",
      "external": false,
      "loc": "drivers/staging/emxx_udc/emxx_udc.c:415",

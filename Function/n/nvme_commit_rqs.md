# Function: <code>nvme_commit_rqs</code>
...
```c
void nvme_commit_rqs(struct blk_mq_hw_ctx * hctx)
```

```json
{
  "name": "nvme_commit_rqs",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586506432,
      "name": "nvme_commit_rqs",
      "external": false,
      "loc": "drivers/nvme/host/pci.c:488",

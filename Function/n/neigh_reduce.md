# Function: <code>neigh_reduce</code>
...
```c
int neigh_reduce(struct net_device * dev, struct sk_buff * skb, __be32 vni)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586657472,
      "name": "neigh_reduce",
      "external": false,
      "loc": "drivers/net/vxlan.c:2143",

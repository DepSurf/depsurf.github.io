# Function: <code>numachip_send_IPI_one</code>
...
```c
void numachip_send_IPI_one(int cpu, int vector)
```
  ...
  "funcs": [
    {
      ...
      "name": "numachip_send_IPI_one",
      "external": false,
      "loc": "arch/x86/kernel/apic/apic_numachip.c:97",
  ...
  "funcs": [
    {
      ...
      "name": "numachip_send_IPI_one",
      "external": false,
      "loc": "arch/x86/kernel/apic/apic_numachip.c:94",
      "file": "arch/x86/kernel/apic/apic_numachip.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579572992,
      "name": "numachip_send_IPI_one",
      "external": false,
      "loc": "arch/x86/kernel/apic/apic_numachip.c:83",
      "file": "arch/x86/kernel/apic/apic_numachip.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

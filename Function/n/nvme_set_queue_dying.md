# Function: <code>nvme_set_queue_dying</code>
...
```c
void nvme_set_queue_dying(struct nvme_ns * ns)
```

```json
{
  "name": "nvme_set_queue_dying",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071586461296,
      "name": "nvme_set_queue_dying",
      "external": false,
      "loc": "drivers/nvme/host/core.c:97",

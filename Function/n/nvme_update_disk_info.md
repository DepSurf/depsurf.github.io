# Function: <code>nvme_update_disk_info</code>
...
```c
void nvme_update_disk_info(struct gendisk * disk, struct nvme_ns * ns, struct nvme_id_ns * id)
```

```json
{
  "name": "nvme_update_disk_info",
  ...
  "funcs": [
    {
      ...
      "name": "nvme_update_disk_info",
      "external": false,
      "loc": "drivers/nvme/host/core.c:1756",

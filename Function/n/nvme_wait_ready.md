...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "nvme_wait_ready",
      "external": false,
      "loc": "drivers/nvme/host/core.c:2060",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071586482803,
      "name": "nvme_wait_ready.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 50
    }

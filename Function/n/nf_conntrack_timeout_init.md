# Function: <code>nf_conntrack_timeout_init</code>
...
```json
{
  "name": "nf_conntrack_timeout_init",
  ...
  "funcs": [
    {
      ...
      "name": "nf_conntrack_timeout_init",
      "external": true,
      "loc": "net/netfilter/nf_conntrack_timeout.c:144",
  ...
  "symbols": [
    {
      "addr": 18446744071588973978,
      "name": "nf_conntrack_timeout_init.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 17
    },

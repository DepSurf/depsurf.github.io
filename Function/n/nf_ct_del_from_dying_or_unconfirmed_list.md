# Function: <code>nf_ct_del_from_dying_or_unconfirmed_list</code>
...
```c
void nf_ct_del_from_dying_or_unconfirmed_list(struct nf_conn * ct)
```

```json
{
  "name": "nf_ct_del_from_dying_or_unconfirmed_list",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071588926768,
      "name": "nf_ct_del_from_dying_or_unconfirmed_list",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_core.c:525",

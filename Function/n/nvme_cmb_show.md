# Function: <code>nvme_cmb_show</code>
...
```c
ssize_t nvme_cmb_show(struct device * dev, struct device_attribute * attr, char * buf)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586500432,
      "name": "nvme_cmb_show",
      "external": false,
      "loc": "drivers/nvme/host/pci.c:1766",

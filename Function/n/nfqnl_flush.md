# Function: <code>nfqnl_flush</code>
...
```c
void nfqnl_flush(struct nfqnl_instance * queue, nfqnl_cmpfn cmpfn, long unsigned int data)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588909808,
      "name": "nfqnl_flush",
      "external": false,
      "loc": "net/netfilter/nfnetlink_queue.c:247",

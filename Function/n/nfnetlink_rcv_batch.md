# Function: <code>nfnetlink_rcv_batch</code>
...
```c
void nfnetlink_rcv_batch(struct sk_buff * skb, struct nlmsghdr * nlh, u16 subsys_id, u32 genid)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588907056,
      "name": "nfnetlink_rcv_batch",
      "external": false,
      "loc": "net/netfilter/nfnetlink.c:297",

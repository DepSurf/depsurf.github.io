# Function: <code>nvme_init_hctx</code>
...
```c
int nvme_init_hctx(struct blk_mq_hw_ctx * hctx, void * data, unsigned int hctx_idx)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586499520,
      "name": "nvme_init_hctx",
      "external": false,
      "loc": "drivers/nvme/host/pci.c:384",

# Function: <code>__nf_conntrack_hash_insert</code>
...
```c
void __nf_conntrack_hash_insert(struct nf_conn * ct, unsigned int hash, unsigned int reply_hash)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588924032,
      "name": "__nf_conntrack_hash_insert",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_core.c:808",

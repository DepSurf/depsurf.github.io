# Function: <code>nvme_pr_register</code>
...
```c
int nvme_pr_register(struct block_device * bdev, u64 old, u64 new, unsigned int flags)
```

```json
{
  "name": "nvme_pr_register",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586469504,
      "name": "nvme_pr_register",
      "external": false,
      "loc": "drivers/nvme/host/core.c:1947",

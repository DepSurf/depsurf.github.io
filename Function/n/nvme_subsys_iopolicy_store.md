# Function: <code>nvme_subsys_iopolicy_store</code>
...
```c
ssize_t nvme_subsys_iopolicy_store(struct device * dev, struct device_attribute * attr, const char * buf, size_t count)
```

```json
{
  "name": "nvme_subsys_iopolicy_store",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586486192,
      "name": "nvme_subsys_iopolicy_store",
      "external": false,
      "loc": "drivers/nvme/host/multipath.c:612",

# Function: <code>nf_ct_gc_expired</code>
...
```c
void nf_ct_gc_expired(struct nf_conn * ct)
```

```json
{
  "name": "nf_ct_gc_expired",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071588928992,
      "name": "nf_ct_gc_expired",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_core.c:713",

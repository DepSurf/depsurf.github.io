# Function: <code>__x64_sys_wait4</code>
...
```c
long int __x64_sys_wait4(const struct pt_regs * regs)
```

```json
{
  "name": "__x64_sys_wait4",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071579451696,
      "name": "__x64_sys_wait4",
      "external": true,

# Function: <code>__x64_sys_madvise</code>
...
```c
long int __x64_sys_madvise(const struct pt_regs * regs)
```
...
```c
long int __x64_sys_madvise(const struct pt_regs * __unused)
```

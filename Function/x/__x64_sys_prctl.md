# Function: <code>__x64_sys_prctl</code>
...
```c
long int __x64_sys_prctl(const struct pt_regs * regs)
```

```json
{
  "name": "__x64_sys_prctl",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071579535904,
      "name": "__x64_sys_prctl",
      "external": true,

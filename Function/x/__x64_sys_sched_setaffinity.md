# Function: <code>__x64_sys_sched_setaffinity</code>
...
```c
long int __x64_sys_sched_setaffinity(const struct pt_regs * regs)
```

```json
{
  "name": "__x64_sys_sched_setaffinity",

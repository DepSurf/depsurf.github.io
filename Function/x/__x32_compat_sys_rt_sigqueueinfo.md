# Function: <code>__x32_compat_sys_rt_sigqueueinfo</code>
...
```c
long int __x32_compat_sys_rt_sigqueueinfo(const struct pt_regs * regs)
```

```json
{
  "name": "__x32_compat_sys_rt_sigqueueinfo",

# Function: <code>__x64_sys_prlimit64</code>
...
```c
long int __x64_sys_prlimit64(const struct pt_regs * regs)
```

```json
{
  "name": "__x64_sys_prlimit64",

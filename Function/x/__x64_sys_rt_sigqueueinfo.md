# Function: <code>__x64_sys_rt_sigqueueinfo</code>
...
```c
long int __x64_sys_rt_sigqueueinfo(const struct pt_regs * regs)
```

```json
{
  "name": "__x64_sys_rt_sigqueueinfo",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071579500064,
      "name": "__x64_sys_rt_sigqueueinfo",
      "external": true,

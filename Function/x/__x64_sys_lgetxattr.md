# Function: <code>__x64_sys_lgetxattr</code>
...
```c
long int __x64_sys_lgetxattr(const struct pt_regs * regs)
```

```json
{
  "name": "__x64_sys_lgetxattr",

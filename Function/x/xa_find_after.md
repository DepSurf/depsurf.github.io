...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071589884688,
      "name": "xa_find_after",
      "external": true,
      "loc": "lib/xarray.c:1840",
      "file": "lib/xarray.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071590110640,
      "name": "xa_find_after",
      "external": true,
      "loc": "lib/xarray.c:1862",
      "file": "lib/xarray.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585115632,
      "name": "xa_find_after",
      "external": true,
      "loc": "lib/xarray.c:1865",
      "file": "lib/xarray.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585265152,
      "name": "xa_find_after",
      "external": true,
      "loc": "lib/xarray.c:2055",
      "file": "lib/xarray.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585147952,
      "name": "xa_find_after",
      "external": true,
      "loc": "lib/xarray.c:2056",
      "file": "lib/xarray.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "symbols": [
    {
      "addr": 18446744071592345441,
      "name": "xa_find_after.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 86
    },
    {
      "addr": 18446744071585599696,
      "name": "xa_find_after",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 293

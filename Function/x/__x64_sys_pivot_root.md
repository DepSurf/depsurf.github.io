# Function: <code>__x64_sys_pivot_root</code>
...
```c
long int __x64_sys_pivot_root(const struct pt_regs * regs)
```

```json
{
  "name": "__x64_sys_pivot_root",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071581737120,
      "name": "__x64_sys_pivot_root",
      "external": true,

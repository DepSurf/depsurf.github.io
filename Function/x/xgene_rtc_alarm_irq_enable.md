# Function: <code>xgene_rtc_alarm_irq_enable</code>
...
```c
int xgene_rtc_alarm_irq_enable(struct device * dev, u32 enabled)
```

```json
{
  "name": "xgene_rtc_alarm_irq_enable",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336500830576,
      "name": "xgene_rtc_alarm_irq_enable",
      "external": false,
      "loc": "drivers/rtc/rtc-xgene.c:77",

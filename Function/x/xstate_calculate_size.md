...
```json
{
  "name": "xstate_calculate_size",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071579196359,
      "name": "xstate_calculate_size",
      "external": false,
      "loc": "arch/x86/kernel/fpu/xstate.c:564",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579253271,
      "name": "xstate_calculate_size",
      "external": false,
      "loc": "arch/x86/kernel/fpu/xstate.c:563",
      "file": "arch/x86/kernel/fpu/xstate.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "arch/x86/kernel/fpu/xstate.c:__xstate_request_perm",

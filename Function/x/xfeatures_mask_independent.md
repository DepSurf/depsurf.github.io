...
```json
{
  "name": "xfeatures_mask_independent",
  "collision_type": "Unique Static",
  "inline_type": "Full",
  "funcs": [
    {
      "addr": 18446744071579152526,
      "name": "xfeatures_mask_independent",
      "external": false,
      "loc": "arch/x86/include/asm/fpu/xstate.h:124",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579196862,
      "name": "xfeatures_mask_independent",
      "external": false,
      "loc": "arch/x86/kernel/fpu/xstate.h:63",
      "file": "arch/x86/kernel/fpu/xstate.c",
      "inline": "declared, inlined",
      "caller_inline": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579290062,
      "name": "xfeatures_mask_independent",
      "external": false,
      "loc": "arch/x86/kernel/fpu/xstate.h:64",
      "file": "arch/x86/kernel/fpu/xstate.c",
      "inline": "declared, inlined",
      "caller_inline": [
        "arch/x86/kernel/fpu/xstate.c:validate_independent_components",

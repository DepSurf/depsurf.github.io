# Function: <code>__x32_compat_sys_rt_tgsigqueueinfo</code>
...
```c
long int __x32_compat_sys_rt_tgsigqueueinfo(const struct pt_regs * regs)
```

```json
{
  "name": "__x32_compat_sys_rt_tgsigqueueinfo",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071579509280,
      "name": "__x32_compat_sys_rt_tgsigqueueinfo",
      "external": true,

...
```json
{
  "name": "xenmem_reservation_increase",
  ...
  "funcs": [
    {
      ...
      "name": "xenmem_reservation_increase",
      "external": true,
      "loc": "drivers/xen/mem-reservation.c:93",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588067440,
      "name": "xenmem_reservation_increase",
      "external": true,
      "loc": "drivers/xen/mem-reservation.c:86",
      "file": "drivers/xen/mem-reservation.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>__x64_sys_capset</code>
...
```c
long int __x64_sys_capset(const struct pt_regs * regs)
```

```json
{
  "name": "__x64_sys_capset",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071579474336,
      "name": "__x64_sys_capset",
      "external": true,

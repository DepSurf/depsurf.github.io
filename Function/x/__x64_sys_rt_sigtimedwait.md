# Function: <code>__x64_sys_rt_sigtimedwait</code>
...
```c
long int __x64_sys_rt_sigtimedwait(const struct pt_regs * regs)
```

```json
{
  "name": "__x64_sys_rt_sigtimedwait",

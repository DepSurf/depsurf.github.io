# Function: <code>__x64_sys_sched_getaffinity</code>
...
```c
long int __x64_sys_sched_getaffinity(const struct pt_regs * regs)
```

```json
{
  "name": "__x64_sys_sched_getaffinity",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071579638400,
      "name": "__x64_sys_sched_getaffinity",
      "external": true,

# Function: <code>xen_get_lazy_mode</code>
...
```c
enum xen_lazy_mode xen_get_lazy_mode()
```

```json
{
  "name": "xen_get_lazy_mode",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071579099141,
      "name": "xen_get_lazy_mode",
      "external": true,
      "loc": "arch/x86/xen/enlighten_pv.c:107",

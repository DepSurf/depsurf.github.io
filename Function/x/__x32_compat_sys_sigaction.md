# Function: <code>__x32_compat_sys_sigaction</code>
...
```c
long int __x32_compat_sys_sigaction(const struct pt_regs * regs)
```

```json
{
  "name": "__x32_compat_sys_sigaction",

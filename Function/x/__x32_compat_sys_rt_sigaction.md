# Function: <code>__x32_compat_sys_rt_sigaction</code>
...
```c
long int __x32_compat_sys_rt_sigaction(const struct pt_regs * regs)
```

```json
{
  "name": "__x32_compat_sys_rt_sigaction",

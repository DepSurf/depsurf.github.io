# Function: <code>xive_smp_disable_cpu</code>
...
```c
void xive_smp_disable_cpu()
```

```json
{
  "name": "xive_smp_disable_cpu",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282945472,
      "name": "xive_smp_disable_cpu",
      "external": true,
      "loc": "arch/powerpc/sysdev/xive/common.c:1447",

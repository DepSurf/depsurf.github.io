...
```json
{
  "name": "xen_swiotlb_unmap_sg_attrs",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071583910640,
      "name": "xen_swiotlb_unmap_sg_attrs",
      "external": true,
      "loc": "drivers/xen/swiotlb-xen.c:600",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584423904,
      "name": "xen_swiotlb_unmap_sg_attrs",
      "external": true,
      "loc": "drivers/xen/swiotlb-xen.c:609",
      "file": "drivers/xen/swiotlb-xen.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584508464,
      "name": "xen_swiotlb_unmap_sg_attrs",
      "external": false,
      "loc": "drivers/xen/swiotlb-xen.c:530",
      "file": "drivers/xen/swiotlb-xen.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585150000,
      "name": "xen_swiotlb_unmap_sg_attrs",
      "external": false,
      "loc": "drivers/xen/swiotlb-xen.c:516",
      "file": "drivers/xen/swiotlb-xen.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585260784,
      "name": "xen_swiotlb_unmap_sg_attrs",
      "external": false,
      "loc": "drivers/xen/swiotlb-xen.c:504",
      "file": "drivers/xen/swiotlb-xen.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": []

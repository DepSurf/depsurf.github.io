# Function: <code>mptcp_reset_timer</code>
...
```json
{
  "name": "mptcp_reset_timer",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071591075360,
      "name": "mptcp_reset_timer",
      "external": false,
      "loc": "net/mptcp/protocol.c:347",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591938629,
      "name": "mptcp_reset_timer",
      "external": false,
      "loc": "net/mptcp/protocol.c:801",
      "file": "net/mptcp/protocol.c",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071593664044,
      "name": "mptcp_reset_timer",
      "external": false,
      "loc": "net/mptcp/protocol.c:862",
      "file": "net/mptcp/protocol.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "net/mptcp/protocol.c:mptcp_subflow_shutdown",

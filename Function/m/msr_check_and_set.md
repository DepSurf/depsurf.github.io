# Function: <code>msr_check_and_set</code>
...
```c
long unsigned int msr_check_and_set(long unsigned int bits)
```

```json
{
  "name": "msr_check_and_set",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282296560,
      "name": "msr_check_and_set",
      "external": true,
      "loc": "arch/powerpc/kernel/process.c:121",

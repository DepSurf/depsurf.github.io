...
```json
{
  "name": "mptcp_subflow_fully_established",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071591173070,
      "name": "mptcp_subflow_fully_established",
      "external": true,
      "loc": "net/mptcp/subflow.c:524",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591109916,
      "name": "mptcp_subflow_fully_established",
      "external": true,
      "loc": "net/mptcp/subflow.c:604",
      "file": "net/mptcp/subflow.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "net/mptcp/subflow.c:subflow_syn_recv_sock"
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071593681956,
      "name": "mptcp_subflow_fully_established",
      "external": true,
      "loc": "net/mptcp/subflow.c:663",
      "file": "net/mptcp/subflow.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "net/mptcp/subflow.c:subflow_syn_recv_sock"
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071595618176,
      "name": "mptcp_subflow_fully_established",
      "external": true,
      "loc": "net/mptcp/subflow.c:727",
      "file": "net/mptcp/subflow.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071596126624,
      "name": "mptcp_subflow_fully_established",
      "external": true,
      "loc": "net/mptcp/subflow.c:728",
      "file": "net/mptcp/subflow.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

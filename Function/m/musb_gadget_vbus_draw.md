# Function: <code>musb_gadget_vbus_draw</code>
...
```c
int musb_gadget_vbus_draw(struct usb_gadget * gadget, unsigned int mA)
```

```json
{
  "name": "musb_gadget_vbus_draw",
  ...
  "funcs": [
    {
      ...
      "name": "musb_gadget_vbus_draw",
      "external": false,
      "loc": "drivers/usb/musb/musb_gadget.c:1623",

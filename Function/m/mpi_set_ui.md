...
```c
MPI mpi_set_ui(MPI w, long unsigned int u)
```
  ...
  "funcs": [
    {
      ...
      "name": "mpi_set_ui",
      "external": true,
      "loc": "lib/crypto/mpi/mpiutil.c:270",

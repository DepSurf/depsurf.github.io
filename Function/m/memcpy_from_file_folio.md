...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "memcpy_from_file_folio",
      "external": false,
      "loc": "include/linux/highmem.h:454",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596609305,
      "name": "memcpy_from_file_folio.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 56
    }
  ...
  "funcs": [
    {
      ...
      "name": "memcpy_from_file_folio",
      "external": false,
      "loc": "include/linux/highmem.h:574",
      "file": "fs/ext4/verity.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

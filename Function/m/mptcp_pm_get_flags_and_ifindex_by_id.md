...
```json
{
  "name": "mptcp_pm_get_flags_and_ifindex_by_id",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071591997792,
      "name": "mptcp_pm_get_flags_and_ifindex_by_id",
      "external": true,
      "loc": "net/mptcp/pm_netlink.c:1237",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071593730512,
      "name": "mptcp_pm_get_flags_and_ifindex_by_id",
      "external": true,
      "loc": "net/mptcp/pm_netlink.c:1342",
      "file": "net/mptcp/pm_netlink.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071595664640,
      "name": "mptcp_pm_get_flags_and_ifindex_by_id",
      "external": true,
      "loc": "net/mptcp/pm_netlink.c:1356",
      "file": "net/mptcp/pm_netlink.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071596154352,
      "name": "mptcp_pm_get_flags_and_ifindex_by_id",
      "external": true,
      "loc": "net/mptcp/pm.c:437",
      "file": "net/mptcp/pm.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071597028320,
      "name": "mptcp_pm_get_flags_and_ifindex_by_id",
      "external": true,
      "loc": "net/mptcp/pm.c:430",
      "file": "net/mptcp/pm.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>msi_setup_device_data</code>
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580569376,
      "name": "msi_setup_device_data",
      "external": true,
      "loc": "kernel/irq/msi.c:292",
      "file": "kernel/irq/msi.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

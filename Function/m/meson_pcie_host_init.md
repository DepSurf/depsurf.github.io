# Function: <code>meson_pcie_host_init</code>
...
```c
int meson_pcie_host_init(struct pcie_port * pp)
```

```json
{
  "name": "meson_pcie_host_init",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071584483632,
      "name": "meson_pcie_host_init",
      "external": false,
      "loc": "drivers/pci/controller/dwc/pci-meson.c:472",

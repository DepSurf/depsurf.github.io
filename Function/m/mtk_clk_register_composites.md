# Function: <code>mtk_clk_register_composites</code>
...
```c
void mtk_clk_register_composites(const struct mtk_composite * mcs, int num, void * base, spinlock_t * lock, struct clk_onecell_data * clk_data)
```

```json
{
  "name": "mtk_clk_register_composites",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336497896664,
      "name": "mtk_clk_register_composites",
      "external": true,
      "loc": "drivers/clk/mediatek/clk-mtk.c:236",

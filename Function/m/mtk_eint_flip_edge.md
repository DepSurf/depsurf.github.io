# Function: <code>mtk_eint_flip_edge</code>
...
```c
int mtk_eint_flip_edge(struct mtk_eint * eint, int hwirq)
```

```json
{
  "name": "mtk_eint_flip_edge",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336496673368,
      "name": "mtk_eint_flip_edge",
      "external": false,
      "loc": "drivers/pinctrl/mediatek/mtk-eint.c:84",

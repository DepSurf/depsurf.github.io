  ...
  "funcs": [
    {
      ...
      "name": "mmc_all_send_cid",
      "external": true,
      "loc": "drivers/mmc/core/mmc_ops.c:224",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586352304,
      "name": "mmc_all_send_cid",
      "external": true,
      "loc": "drivers/mmc/core/mmc_ops.c:219",
      "file": "drivers/mmc/core/mmc_ops.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586561200,
      "name": "mmc_all_send_cid",
      "external": true,
      "loc": "drivers/mmc/core/mmc_ops.c:203",
      "file": "drivers/mmc/core/mmc_ops.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

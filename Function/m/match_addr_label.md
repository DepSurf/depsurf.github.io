# Function: <code>match_addr_label</code>
...
```c
unsigned int match_addr_label(struct aa_policydb * policy, unsigned int state, u32 request, struct match_addr * maddr, struct aa_perms * * p, const char * * info)
```

```json
{
  "name": "match_addr_label",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586587024,
      "name": "match_addr_label",
      "external": false,
      "loc": "security/apparmor/af_inet.c:302",

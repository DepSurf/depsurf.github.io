# Function: <code>mvebu_mbus_add_window_remap_by_id</code>
...
```json
{
  "name": "mvebu_mbus_add_window_remap_by_id",
  ...
  "funcs": [
    {
      ...
      "name": "mvebu_mbus_add_window_remap_by_id",
      "external": true,
      "loc": "drivers/bus/mvebu-mbus.c:902",
      "file": "drivers/bus/mvebu-mbus.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "drivers/bus/mvebu-mbus.c:mvebu_mbus_add_window_by_id",

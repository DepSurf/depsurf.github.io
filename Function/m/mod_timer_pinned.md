# Function: <code>mod_timer_pinned</code>
...
```c
int mod_timer_pinned(struct timer_list * timer, long unsigned int expires)
```

```json
{
  "name": "mod_timer_pinned",

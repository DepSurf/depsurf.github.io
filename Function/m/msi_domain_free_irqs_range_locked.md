...
```json
{
  "name": "msi_domain_free_irqs_range_locked",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071580573298,
      "name": "msi_domain_free_irqs_range_locked",
      "external": true,
      "loc": "kernel/irq/msi.c:1585",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580647912,
      "name": "msi_domain_free_irqs_range_locked",
      "external": true,
      "loc": "kernel/irq/msi.c:1582",
      "file": "kernel/irq/msi.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "kernel/irq/msi.c:msi_domain_free_irqs_all",

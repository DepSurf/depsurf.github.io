...
```json
{
  "name": "mptcp_reset_timeout",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071593665286,
      "name": "mptcp_reset_timeout",
      "external": true,
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071596103440,
      "name": "mptcp_reset_timeout",
      "external": true,
      "loc": "net/mptcp/protocol.c:2570",
      "file": "net/mptcp/protocol.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

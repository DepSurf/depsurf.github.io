# Function: <code>meson_pcie_driver_init</code>
...
```c
int meson_pcie_driver_init()
```

```json
{
  "name": "meson_pcie_driver_init",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071604880189,
      "name": "meson_pcie_driver_init",
      "external": false,
      "loc": "drivers/pci/controller/dwc/pci-meson.c:593",

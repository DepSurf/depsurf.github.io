# Function: <code>mcpm_platform_register</code>
...
```c
int mcpm_platform_register(const struct mcpm_platform_ops * ops)
```

```json
{
  "name": "mcpm_platform_register",
  ...
  "funcs": [
    {
      ...
      "name": "mcpm_platform_register",
      "external": true,
      "loc": "arch/arm/common/mcpm_entry.c:163",

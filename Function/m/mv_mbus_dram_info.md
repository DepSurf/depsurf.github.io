# Function: <code>mv_mbus_dram_info</code>
...
```c
const struct mbus_dram_target_info * mv_mbus_dram_info()
```
  ...
  "funcs": [
    {
      ...
      "name": "mv_mbus_dram_info",
      "external": true,
      "loc": "drivers/bus/mvebu-mbus.c:177",

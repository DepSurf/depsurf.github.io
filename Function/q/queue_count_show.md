# Function: <code>queue_count_show</code>
...
```c
ssize_t queue_count_show(struct device * dev, struct device_attribute * attr, char * buf)
```

```json
{
  "name": "queue_count_show",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586454912,
      "name": "queue_count_show",
      "external": false,
      "loc": "drivers/nvme/host/core.c:3173",

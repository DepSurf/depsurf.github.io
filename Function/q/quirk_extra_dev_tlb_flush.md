...
```json
{
  "name": "quirk_extra_dev_tlb_flush",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071590133974,
      "name": "quirk_extra_dev_tlb_flush",
      "external": true,
      "loc": "drivers/iommu/intel/iommu.c:5052",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071590447753,
      "name": "quirk_extra_dev_tlb_flush",
      "external": true,
      "loc": "drivers/iommu/intel/iommu.c:5010",
      "file": "drivers/iommu/intel/iommu.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "drivers/iommu/intel/iommu.c:domain_context_clear_one",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071590794585,
      "name": "quirk_extra_dev_tlb_flush",
      "external": true,
      "loc": "drivers/iommu/intel/iommu.c:5136",
      "file": "drivers/iommu/intel/iommu.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "drivers/iommu/intel/iommu.c:domain_context_clear_one",

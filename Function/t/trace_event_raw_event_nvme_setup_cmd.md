# Function: <code>trace_event_raw_event_nvme_setup_cmd</code>
...
```c
void trace_event_raw_event_nvme_setup_cmd(void * __data, struct request * req, struct nvme_command * cmd)
```

```json
{
  "name": "trace_event_raw_event_nvme_setup_cmd",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586458816,
      "name": "trace_event_raw_event_nvme_setup_cmd",
      "external": false,

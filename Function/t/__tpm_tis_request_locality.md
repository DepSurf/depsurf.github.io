# Function: <code>__tpm_tis_request_locality</code>
...
```c
int __tpm_tis_request_locality(struct tpm_chip * chip, int l)
```

```json
{
  "name": "__tpm_tis_request_locality",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071590351376,
      "name": "__tpm_tis_request_locality",
      "external": false,

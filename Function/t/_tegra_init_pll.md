# Function: <code>_tegra_init_pll</code>
...
```c
struct tegra_clk_pll * _tegra_init_pll(void * clk_base, void * pmc, struct tegra_clk_pll_params * pll_params, spinlock_t * lock)
```

```json
{
  "name": "_tegra_init_pll",
  ...
  "funcs": [
    {
      ...
      "name": "_tegra_init_pll",
      "external": false,
      "loc": "drivers/clk/tegra/clk-pll.c:1807",

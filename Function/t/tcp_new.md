...
```c
bool tcp_new(struct nf_conn * ct, const struct sk_buff * skb, unsigned int dataoff, const struct tcphdr * th)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588959792,
      "name": "tcp_new",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_proto_tcp.c:758",

# Function: <code>ti_clk_register_omap_hw</code>
...
```c
struct clk * ti_clk_register_omap_hw(struct device * dev, struct clk_hw * hw, const char * con)
```

```json
{
  "name": "ti_clk_register_omap_hw",

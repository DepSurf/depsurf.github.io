...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "thermal_cooling_device_update",
      "external": true,
      "loc": "drivers/thermal/thermal_core.c:1028",
  ...
  "symbols": [
    {
      "addr": 18446744071596838444,
      "name": "thermal_cooling_device_update.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 21
    },
    {
      "addr": 18446744071592764000,
      "name": "thermal_cooling_device_update",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 444
  ...
  "funcs": [
    {
      ...
      "name": "thermal_cooling_device_update",
      "external": true,
      "loc": "drivers/thermal/thermal_core.c:1097",
      "file": "drivers/thermal/thermal_core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>ti_clk_register</code>
...
```c
struct clk * ti_clk_register(struct device * dev, struct clk_hw * hw, const char * con)
```

```json
{
  "name": "ti_clk_register",
  ...
  "funcs": [
    {
      ...
      "name": "ti_clk_register",
      "external": true,
      "loc": "drivers/clk/ti/clk.c:511",
      "file": "drivers/clk/ti/clk.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "drivers/clk/ti/clk.c:ti_clk_register_omap_hw",

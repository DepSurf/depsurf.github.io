# Function: <code>tegra_hsp_doorbell_get</code>
...
```c
struct tegra_hsp_doorbell * tegra_hsp_doorbell_get(struct tegra_hsp * hsp, unsigned int master)
```

```json
{
  "name": "tegra_hsp_doorbell_get",
  ...
  "funcs": [
    {
      ...
      "name": "tegra_hsp_doorbell_get",
      "external": false,
      "loc": "drivers/mailbox/tegra-hsp.c:152",

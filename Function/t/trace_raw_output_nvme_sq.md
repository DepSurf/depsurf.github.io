# Function: <code>trace_raw_output_nvme_sq</code>
...
```c
enum print_line_t trace_raw_output_nvme_sq(struct trace_iterator * iter, int flags, struct trace_event * trace_event)
```

```json
{
  "name": "trace_raw_output_nvme_sq",

...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580587904,
      "name": "tnum_lshift",
      "external": true,
      "loc": "kernel/bpf/tnum.c:36",
...
```json
{
  ...
  "symbols": [
    {
      "addr": 18446744071592185997,
      "name": "tnum_lshift.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 53
    },

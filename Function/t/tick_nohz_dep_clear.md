...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "tick_nohz_dep_clear",
      "external": true,
      "loc": "kernel/time/tick-sched.c:436",
  ...
  "symbols": [
    {
      "addr": 18446744071597416583,
      "name": "tick_nohz_dep_clear.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 30
    },
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580108704,
      "name": "tick_nohz_dep_clear",
      "external": true,
      "loc": "kernel/time/tick-sched.c:301",
      "file": "kernel/time/tick-sched.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

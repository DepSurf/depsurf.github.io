...
```json
{
  "name": "tick_nohz_dep_clear_signal",
  ...
  "symbols": [
    {
      "addr": 18446744071597416643,
      "name": "tick_nohz_dep_clear_signal.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 30
    },
    {
      "addr": 18446744071581059472,
      "name": "tick_nohz_dep_clear_signal",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 65
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580108992,
      "name": "tick_nohz_dep_clear_signal",
      "external": true,
      "loc": "kernel/time/tick-sched.c:366",
      "file": "kernel/time/tick-sched.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

...
```json
{
  "name": "__traceiter_xdp_redirect_err",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580906336,
      "name": "__traceiter_xdp_redirect_err",
      "external": true,
      "loc": "include/trace/events/xdp.h:145",
      "file": "kernel/bpf/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

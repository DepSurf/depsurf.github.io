# Function: <code>tegra_clk_register_mc</code>
...
```c
struct clk * tegra_clk_register_mc(const char * name, const char * parent_name, void * reg, spinlock_t * lock)
```

```json
{
  "name": "tegra_clk_register_mc",
  ...
  "funcs": [
    {
      ...
      "name": "tegra_clk_register_mc",
      "external": true,
      "loc": "drivers/clk/tegra/clk-divider.c:163",

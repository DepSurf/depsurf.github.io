...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "tick_nohz_dep_clear_task",
      "external": true,
      "loc": "kernel/time/tick-sched.c:487",
  ...
  "symbols": [
    {
      "addr": 18446744071597416282,
      "name": "tick_nohz_dep_clear_task.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 30
    },
    {
      "addr": 18446744071581053824,
      "name": "tick_nohz_dep_clear_task",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 65
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580108928,
      "name": "tick_nohz_dep_clear_task",
      "external": true,
      "loc": "kernel/time/tick-sched.c:352",
      "file": "kernel/time/tick-sched.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

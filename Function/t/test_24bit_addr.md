# Function: <code>test_24bit_addr</code>
...
```c
int test_24bit_addr(long unsigned int ip, long unsigned int addr)
```

```json
{
  "name": "test_24bit_addr",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282634272,
      "name": "test_24bit_addr",
      "external": false,
      "loc": "arch/powerpc/kernel/trace/ftrace.c:90",

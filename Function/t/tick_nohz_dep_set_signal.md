...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "tick_nohz_dep_set_signal",
      "external": true,
      "loc": "kernel/time/tick-sched.c:497",
  ...
  "symbols": [
    {
      "addr": 18446744071597416613,
      "name": "tick_nohz_dep_set_signal.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 30
    },
    {
      "addr": 18446744071581059296,
      "name": "tick_nohz_dep_set_signal",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 157
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071580108960,
      "name": "tick_nohz_dep_set_signal",
      "external": true,
      "loc": "kernel/time/tick-sched.c:361",
      "file": "kernel/time/tick-sched.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

...
```json
{
  "name": "__tcf_block_cb_unregister",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071587755678,
      "name": "__tcf_block_cb_unregister",
      "external": true,
      "loc": "net/sched/cls_api.c:443",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588095213,
      "name": "__tcf_block_cb_unregister",
      "external": true,
      "loc": "net/sched/cls_api.c:784",
      "file": "net/sched/cls_api.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "net/sched/cls_api.c:tcf_block_cb_unregister"
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588272672,
      "name": "__tcf_block_cb_unregister",
      "external": true,
      "loc": "net/sched/cls_api.c:1250",
      "file": "net/sched/cls_api.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

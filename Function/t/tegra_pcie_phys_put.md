# Function: <code>tegra_pcie_phys_put</code>
...
```c
void tegra_pcie_phys_put(struct tegra_pcie * pcie)
```

```json
{
  "name": "tegra_pcie_phys_put",
  ...
  "funcs": [
    {
      ...
      "name": "tegra_pcie_phys_put",
      "external": false,
      "loc": "drivers/pci/controller/pci-tegra.c:1466",

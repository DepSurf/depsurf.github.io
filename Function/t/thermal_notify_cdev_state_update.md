...
```json
{
  "name": "thermal_notify_cdev_state_update",
  ...
  "funcs": [
    {
      ...
      "name": "thermal_notify_cdev_state_update",
      "external": true,
      "loc": "drivers/thermal/thermal_netlink.c:329",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071590697376,
      "name": "thermal_notify_cdev_state_update",
      "external": true,
      "loc": "drivers/thermal/thermal_netlink.c:374",
      "file": "drivers/thermal/thermal_netlink.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071593544144,
      "name": "thermal_notify_cdev_state_update",
      "external": true,
      "loc": "drivers/thermal/thermal_netlink.c:367",
      "file": "drivers/thermal/thermal_netlink.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

...
```json
{
  "name": "trace_raw_output_mmap_lock_start_locking",
...
```json
{
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071592198564,
      "name": "trace_raw_output_mmap_lock_start_locking.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 21
    }

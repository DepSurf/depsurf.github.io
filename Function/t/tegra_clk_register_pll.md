# Function: <code>tegra_clk_register_pll</code>
...
```c
struct clk * tegra_clk_register_pll(const char * name, const char * parent_name, void * clk_base, void * pmc, long unsigned int flags, struct tegra_clk_pll_params * pll_params, spinlock_t * lock)
```

```json
{
  "name": "tegra_clk_register_pll",
  ...
  "funcs": [
    {
      ...
      "name": "tegra_clk_register_pll",
      "external": true,
      "loc": "drivers/clk/tegra/clk-pll.c:1858",

# Function: <code>tegra_clk_register_periph_gate</code>
...
```c
struct clk * tegra_clk_register_periph_gate(const char * name, const char * parent_name, u8 gate_flags, void * clk_base, long unsigned int flags, int clk_num, int * enable_refcnt)
```

```json
{
  "name": "tegra_clk_register_periph_gate",
  ...
  "funcs": [
    {
      ...
      "name": "tegra_clk_register_periph_gate",
      "external": true,
      "loc": "drivers/clk/tegra/clk-periph-gate.c:119",

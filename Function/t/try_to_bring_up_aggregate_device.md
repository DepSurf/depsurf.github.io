...
```json
{
  "name": "try_to_bring_up_aggregate_device",
  ...
  "funcs": [
    {
      ...
      "name": "try_to_bring_up_aggregate_device",
      "external": false,
      "loc": "drivers/base/component.c:227",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071594354960,
      "name": "try_to_bring_up_aggregate_device.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 24
    }

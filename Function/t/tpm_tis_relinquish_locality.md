# Function: <code>tpm_tis_relinquish_locality</code>
...
```c
int tpm_tis_relinquish_locality(struct tpm_chip * chip, int l)
```

```json
{
  "name": "tpm_tis_relinquish_locality",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071590353072,
      "name": "tpm_tis_relinquish_locality",
      "external": false,
      "loc": "drivers/char/tpm/tpm_tis_core.c:178",

...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071581056534,
      "name": "tick_nohz_full_kick",
      "external": false,
      "loc": "kernel/time/tick-sched.c:340",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071597416354,
      "name": "tick_nohz_full_kick.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 20
    }
  ...
  "funcs": [
    {
      ...
      "name": "tick_nohz_full_kick",
      "external": false,
      "loc": "kernel/time/tick-sched.c:245",
      "file": "kernel/time/tick-sched.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [

...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "tunables_write",
      "external": false,
      "loc": "arch/x86/platform/uv/tlb_uv.c:1615",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071579467383,
      "name": "tunables_write.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 29
    }

...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "tick_nohz_dep_set_cpu",
      "external": true,
      "loc": "kernel/time/tick-sched.c:445",
  ...
  "symbols": [
    {
      "addr": 18446744071597416472,
      "name": "tick_nohz_dep_set_cpu.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 30
    },
    {
      "addr": 18446744071581058528,
      "name": "tick_nohz_dep_set_cpu",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 219
  ...
  "funcs": [
    {
      ...
      "name": "tick_nohz_dep_set_cpu",
      "external": true,
      "loc": "kernel/time/tick-sched.c:310",
      "file": "kernel/time/tick-sched.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>tcp_to_nlattr</code>
...
```c
int tcp_to_nlattr(struct sk_buff * skb, struct nlattr * nla, struct nf_conn * ct)
```
  ...
  "funcs": [
    {
      ...
      "name": "tcp_to_nlattr",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_proto_tcp.c:1187",

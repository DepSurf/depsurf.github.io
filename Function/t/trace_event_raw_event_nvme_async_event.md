# Function: <code>trace_event_raw_event_nvme_async_event</code>
...
```c
void trace_event_raw_event_nvme_async_event(void * __data, struct nvme_ctrl * ctrl, u32 result)
```

```json
{
  "name": "trace_event_raw_event_nvme_async_event",

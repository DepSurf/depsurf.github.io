...
```json
{
  "name": "thermal_genl_cpu_capability_event",
  ...
  "funcs": [
    {
      ...
      "name": "thermal_genl_cpu_capability_event",
      "external": true,
      "loc": "drivers/thermal/thermal_netlink.c:403",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071593541728,
      "name": "thermal_genl_cpu_capability_event",
      "external": true,
      "loc": "drivers/thermal/thermal_netlink.c:398",
      "file": "drivers/thermal/thermal_netlink.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

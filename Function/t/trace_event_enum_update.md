...
```json
{
  "name": "trace_event_enum_update",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071580289904,
      "name": "trace_event_enum_update",
      "external": true,
      "loc": "kernel/trace/trace_events.c:2294",
  ...
  "funcs": [
    {
      ...
      "name": "trace_event_enum_update",
      "external": true,
      "loc": "kernel/trace/trace_events.c:2199",
      "file": "kernel/trace/trace_events.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "trace_event_enum_update",
      "external": true,
      "loc": "kernel/trace/trace_events.c:2168",
      "file": "kernel/trace/trace_events.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

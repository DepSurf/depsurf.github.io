# Function: <code>tick_nohz_dep_set_task</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "tick_nohz_dep_set_task",
      "external": true,
      "loc": "kernel/time/tick-sched.c:480",
  ...
  "symbols": [
    {
      "addr": 18446744071597416502,
      "name": "tick_nohz_dep_set_task.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 30
    },
  ...
  "funcs": [
    {
      ...
      "name": "tick_nohz_dep_set_task",
      "external": true,
      "loc": "kernel/time/tick-sched.c:343",
      "file": "kernel/time/tick-sched.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

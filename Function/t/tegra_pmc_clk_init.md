# Function: <code>tegra_pmc_clk_init</code>
...
```c
void tegra_pmc_clk_init(void * pmc_base, struct tegra_clk * tegra_clks)
```

```json
{
  "name": "tegra_pmc_clk_init",
  ...
  "funcs": [
    {
      ...
      "name": "tegra_pmc_clk_init",
      "external": true,
      "loc": "drivers/clk/tegra/clk-tegra-pmc.c:70",
      "file": "drivers/clk/tegra/clk-tegra-pmc.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

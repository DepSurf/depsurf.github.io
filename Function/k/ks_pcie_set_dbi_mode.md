# Function: <code>ks_pcie_set_dbi_mode</code>
...
```c
void ks_pcie_set_dbi_mode(struct keystone_pcie * ks_pcie)
```

```json
{
  "name": "ks_pcie_set_dbi_mode",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336497179832,
      "name": "ks_pcie_set_dbi_mode",
      "external": false,
      "loc": "drivers/pci/controller/dwc/pci-keystone.c:365",

# Function: <code>kernel_disable_single_step</code>
...
```c
void kernel_disable_single_step()
```

```json
{
  "name": "kernel_disable_single_step",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336490181528,
      "name": "kernel_disable_single_step",
      "external": true,
      "loc": "arch/arm64/kernel/debug-monitors.c:417",

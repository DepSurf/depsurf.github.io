# Function: <code>kvmppc_find_table</code>
...
```c
struct kvmppc_spapr_tce_table * kvmppc_find_table(struct kvm * kvm, long unsigned int liobn)
```

```json
{
  "name": "kvmppc_find_table",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 13835058055283309656,
      "name": "kvmppc_find_table",
      "external": true,
      "loc": "arch/powerpc/kvm/book3s_64_vio_hv.c:64",

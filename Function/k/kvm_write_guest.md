# Function: <code>kvm_write_guest</code>
...
```c
int kvm_write_guest(struct kvm * kvm, gpa_t gpa, const void * data, long unsigned int len)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446603336490391680,
      "name": "kvm_write_guest",
      "external": true,
      "loc": "virt/kvm/kvm_main.c:2177",

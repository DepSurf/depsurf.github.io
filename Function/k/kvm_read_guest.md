# Function: <code>kvm_read_guest</code>
...
```c
int kvm_read_guest(struct kvm * kvm, gpa_t gpa, void * data, long unsigned int len)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446603336490408376,
      "name": "kvm_read_guest",
      "external": true,
      "loc": "virt/kvm/kvm_main.c:2064",

# Function: <code>kvm_arm_get_running_vcpu</code>
...
```json
{
  "name": "kvm_arm_get_running_vcpu",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336490442008,
      "name": "kvm_arm_get_running_vcpu",
      "external": true,
      "loc": "virt/kvm/arm/arm.c:73",
      "file": "virt/kvm/arm/arm.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "virt/kvm/arm/perf.c:kvm_get_guest_ip",
        "virt/kvm/arm/perf.c:kvm_is_user_mode",
        "virt/kvm/arm/perf.c:kvm_is_in_guest",

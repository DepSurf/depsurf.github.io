# Function: <code>drm_crtc_helper_set_mode</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_crtc_helper_set_mode",
      "external": true,
      "loc": "drivers/gpu/drm/drm_crtc_helper.c:283",
  ...
  "symbols": [
    {
      "addr": 18446744071597712015,
      "name": "drm_crtc_helper_set_mode.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 54
    },
    {
      "addr": 18446744071592242160,
      "name": "drm_crtc_helper_set_mode",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 1315

  ...
  "funcs": [
    {
      ...
      "name": "die_addr",
      "external": true,
      "loc": "arch/x86/kernel/dumpstack.c:432",
  ...
  "funcs": [
    {
      ...
      "name": "die_addr",
      "external": true,
      "loc": "arch/x86/kernel/dumpstack.c:449",
      "file": "arch/x86/kernel/dumpstack.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579137088,
      "name": "die_addr",
      "external": true,
      "loc": "arch/x86/kernel/dumpstack.c:443",
      "file": "arch/x86/kernel/dumpstack.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579184032,
      "name": "die_addr",
      "external": true,
      "loc": "arch/x86/kernel/dumpstack.c:452",
      "file": "arch/x86/kernel/dumpstack.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

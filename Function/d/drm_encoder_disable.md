# Function: <code>drm_encoder_disable</code>
...
```c
void drm_encoder_disable(struct drm_encoder * encoder)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592240160,
      "name": "drm_encoder_disable",
      "external": false,
      "loc": "drivers/gpu/drm/drm_crtc_helper.c:170",

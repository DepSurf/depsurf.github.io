...
```json
{
  "name": "dwc2_set_param_max_transfer_size",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071585284192,
      "name": "dwc2_set_param_max_transfer_size",
      "external": true,
      "loc": "drivers/usb/dwc2/core.c:2586",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585670912,
      "name": "dwc2_set_param_max_transfer_size",
      "external": true,
      "loc": "drivers/usb/dwc2/core.c:858",
      "file": "drivers/usb/dwc2/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585863756,
      "name": "dwc2_set_param_max_transfer_size",
      "external": false,
      "loc": "drivers/usb/dwc2/params.c:620",

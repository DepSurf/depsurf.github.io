...
```json
{
  "name": "dw_pcie_version_detect",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071588435360,
      "name": "dw_pcie_version_detect",
      "external": true,
      "loc": "drivers/pci/controller/dwc/pcie-designware.c:167",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588713296,
      "name": "dw_pcie_version_detect",
      "external": true,
      "loc": "drivers/pci/controller/dwc/pcie-designware.c:180",
      "file": "drivers/pci/controller/dwc/pcie-designware.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

...
```json
{
  "name": "disk_set_independent_access_ranges",
  ...
  "symbols": [
    {
      "addr": 18446744071594104482,
      "name": "disk_set_independent_access_ranges.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 25
    },
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586572752,
      "name": "disk_set_independent_access_ranges",
      "external": true,
      "loc": "block/blk-ia-ranges.c:287",
      "file": "block/blk-ia-ranges.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

  ...
  "funcs": [
    {
      ...
      "name": "dma_resv_add_fence",
      "external": true,
      "loc": "drivers/dma-buf/dma-resv.c:275",
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "dma_resv_add_fence",
      "external": true,
      "loc": "drivers/dma-buf/dma-resv.c:280",
      "file": "drivers/dma-buf/dma-resv.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "symbols": [
    {
      "addr": 18446744071596259303,
      "name": "dma_resv_add_fence.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 62
    },
    {
      "addr": 18446744071590832976,
      "name": "dma_resv_add_fence",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 565

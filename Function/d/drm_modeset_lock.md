# Function: <code>drm_modeset_lock</code>
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592119059,
      "name": "drm_modeset_lock",
      "external": true,
      "loc": "drivers/gpu/drm/drm_modeset_lock.c:392",
  ...
  "symbols": [
    {
      "addr": 18446744071597708412,
      "name": "drm_modeset_lock.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 42
    },
    {
      "addr": 18446744071592118000,
      "name": "drm_modeset_lock",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 228

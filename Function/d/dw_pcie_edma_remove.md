# Function: <code>dw_pcie_edma_remove</code>
  ...
  "funcs": [
    {
      ...
      "name": "dw_pcie_edma_remove",
      "external": true,
      "loc": "drivers/pci/controller/dwc/pcie-designware.c:975",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071589017552,
      "name": "dw_pcie_edma_remove",
      "external": true,
      "loc": "drivers/pci/controller/dwc/pcie-designware.c:1029",
      "file": "drivers/pci/controller/dwc/pcie-designware.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

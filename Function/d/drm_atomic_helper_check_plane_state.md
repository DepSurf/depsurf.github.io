# Function: <code>drm_atomic_helper_check_plane_state</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_atomic_helper_check_plane_state",
      "external": true,
      "loc": "drivers/gpu/drm/drm_atomic_helper.c:859",
  ...
  "symbols": [
    {
      "addr": 18446744071597710273,
      "name": "drm_atomic_helper_check_plane_state.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 85
    },
    {
      "addr": 18446744071592213840,
      "name": "drm_atomic_helper_check_plane_state",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 770

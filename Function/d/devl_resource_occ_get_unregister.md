...
```json
{
  "name": "devl_resource_occ_get_unregister",
  ...
  "funcs": [
    {
      ...
      "name": "devl_resource_occ_get_unregister",
      "external": true,
      "loc": "net/devlink/leftover.c:8104",
  ...
  "funcs": [
    {
      ...
      "name": "devl_resource_occ_get_unregister",
      "external": true,
      "loc": "net/devlink/resource.c:547",

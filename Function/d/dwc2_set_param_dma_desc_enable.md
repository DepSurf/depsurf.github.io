...
```json
{
  "name": "dwc2_set_param_dma_desc_enable",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071585283440,
      "name": "dwc2_set_param_dma_desc_enable",
      "external": true,
      "loc": "drivers/usb/dwc2/core.c:2465",
  ...
  "funcs": [
    {
      ...
      "name": "dwc2_set_param_dma_desc_enable",
      "external": true,
      "loc": "drivers/usb/dwc2/core.c:714",
      "file": "drivers/usb/dwc2/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585863541,
      "name": "dwc2_set_param_dma_desc_enable",
      "external": false,
      "loc": "drivers/usb/dwc2/params.c:472",

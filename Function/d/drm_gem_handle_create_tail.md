# Function: <code>drm_gem_handle_create_tail</code>
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592072272,
      "name": "drm_gem_handle_create_tail",
      "external": true,
      "loc": "drivers/gpu/drm/drm_gem.c:357",
      "file": "drivers/gpu/drm/drm_gem.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "drivers/gpu/drm/drm_gem.c:drm_gem_open_ioctl",
        "drivers/gpu/drm/drm_gem.c:drm_gem_handle_create",

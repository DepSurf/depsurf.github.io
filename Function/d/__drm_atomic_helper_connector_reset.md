# Function: <code>__drm_atomic_helper_connector_reset</code>
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592237476,
      "name": "__drm_atomic_helper_connector_reset",
      "external": true,
      "loc": "drivers/gpu/drm/drm_atomic_state_helper.c:450",

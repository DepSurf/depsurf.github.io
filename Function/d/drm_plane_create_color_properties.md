# Function: <code>drm_plane_create_color_properties</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_plane_create_color_properties",
      "external": true,
      "loc": "drivers/gpu/drm/drm_color_mgmt.c:527",
  ...
  "symbols": [
    {
      "addr": 18446744071597705226,
      "name": "drm_plane_create_color_properties.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 50
    },
    {
      "addr": 18446744071591971328,
      "name": "drm_plane_create_color_properties",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 789

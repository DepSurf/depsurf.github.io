...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591904820,
      "name": "devlink_to_dev",
      "external": true,
      "loc": "net/core/devlink.c:133",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071593710162,
      "name": "devlink_to_dev",
      "external": true,
      "loc": "net/core/devlink.c:137",
      "file": "net/core/devlink.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "net/core/devlink.c:perf_trace_devlink_trap_report",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071595891952,
      "name": "devlink_to_dev",
      "external": true,
      "loc": "net/devlink/core.c:25",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071596667321,
      "name": "devlink_to_dev",
      "external": true,
      "loc": "net/devlink/core.c:247",
      "file": "net/devlink/core.c",
      "inline": "not declared, inlined",
      "caller_inline": [

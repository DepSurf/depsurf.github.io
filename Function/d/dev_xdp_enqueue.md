...
```json
{
  "name": "dev_xdp_enqueue",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071581103808,
      "name": "dev_xdp_enqueue",
      "external": true,
      "loc": "kernel/bpf/devmap.c:496",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071581151360,
      "name": "dev_xdp_enqueue",
      "external": true,
      "loc": "kernel/bpf/devmap.c:474",
      "file": "kernel/bpf/devmap.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071581386176,
      "name": "dev_xdp_enqueue",
      "external": true,
      "loc": "kernel/bpf/devmap.c:523",
      "file": "kernel/bpf/devmap.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071581709120,
      "name": "dev_xdp_enqueue",
      "external": true,
      "loc": "kernel/bpf/devmap.c:519",
      "file": "kernel/bpf/devmap.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582311872,
      "name": "dev_xdp_enqueue",
      "external": true,
      "loc": "kernel/bpf/devmap.c:520",
      "file": "kernel/bpf/devmap.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071582472896,
      "name": "dev_xdp_enqueue",
      "external": true,
      "loc": "kernel/bpf/devmap.c:529",
      "file": "kernel/bpf/devmap.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

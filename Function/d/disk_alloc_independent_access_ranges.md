...
```json
{
  "name": "disk_alloc_independent_access_ranges",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071586572064,
      "name": "disk_alloc_independent_access_ranges",
      "external": true,
      "loc": "block/blk-ia-ranges.c:264",
      "file": "block/blk-ia-ranges.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>drm_atomic_helper_wait_for_fences</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_atomic_helper_wait_for_fences",
      "external": true,
      "loc": "drivers/gpu/drm/drm_atomic_helper.c:1596",
  ...
  "symbols": [
    {
      "addr": 18446744071597711680,
      "name": "drm_atomic_helper_wait_for_fences.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 35
    },
    {
      "addr": 18446744071592227168,
      "name": "drm_atomic_helper_wait_for_fences",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 488

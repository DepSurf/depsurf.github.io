...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071581262416,
      "name": "__delayacct_swapin_end",
      "external": true,
      "loc": "kernel/delayacct.c:244",
      "file": "kernel/delayacct.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071581357488,
      "name": "__delayacct_swapin_end",
      "external": true,
      "loc": "kernel/delayacct.c:247",
      "file": "kernel/delayacct.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

# Function: <code>__drm_atomic_helper_disable_plane</code>
...
```c
int __drm_atomic_helper_disable_plane(struct drm_plane * plane, struct drm_plane_state * plane_state)
```
  ...
  "funcs": [
    {
      ...
      "name": "__drm_atomic_helper_disable_plane",
      "external": true,
      "loc": "drivers/gpu/drm/drm_atomic.c:1548",

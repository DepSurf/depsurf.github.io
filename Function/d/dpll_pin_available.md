# Function: <code>dpll_pin_available</code>
...
```c
bool dpll_pin_available(struct dpll_pin * pin)
```

```json
{
  "name": "dpll_pin_available",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071594280080,
      "name": "dpll_pin_available",
      "external": false,
      "loc": "drivers/dpll/dpll_netlink.c:566",

# Function: <code>dw8250_check_lcr</code>
...
```c
void dw8250_check_lcr(struct uart_port * p, int value)
```

```json
{
  "name": "dw8250_check_lcr",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446603336498613424,
      "name": "dw8250_check_lcr",
      "external": false,
      "loc": "drivers/tty/serial/8250/8250_dw.c:78",

# Function: <code>drm_hdmi_avi_infoframe_from_display_mode</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_hdmi_avi_infoframe_from_display_mode",
      "external": true,
      "loc": "drivers/gpu/drm/drm_edid.c:7088",
  ...
  "symbols": [
    {
      "addr": 18446744071597706336,
      "name": "drm_hdmi_avi_infoframe_from_display_mode.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 63
    },
    {
      "addr": 18446744071592027376,
      "name": "drm_hdmi_avi_infoframe_from_display_mode",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 927

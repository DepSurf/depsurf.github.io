...
```json
{
  "name": "__destroy_compound_gigantic_folio",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596040244,
      "name": "__destroy_compound_gigantic_folio.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 30
    }

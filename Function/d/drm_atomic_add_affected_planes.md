# Function: <code>drm_atomic_add_affected_planes</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_atomic_add_affected_planes",
      "external": true,
      "loc": "drivers/gpu/drm/drm_atomic.c:1353",
  ...
  "symbols": [
    {
      "addr": 18446744071597702503,
      "name": "drm_atomic_add_affected_planes.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 29
    },
    {
      "addr": 18446744071591928208,
      "name": "drm_atomic_add_affected_planes",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 251

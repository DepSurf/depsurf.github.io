# Function: <code>drm_atomic_check_only</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_atomic_check_only",
      "external": true,
      "loc": "drivers/gpu/drm/drm_atomic.c:1388",
  ...
  "symbols": [
    {
      "addr": 18446744071597702556,
      "name": "drm_atomic_check_only.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 168
    },
    {
      "addr": 18446744071591930816,
      "name": "drm_atomic_check_only",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 1011

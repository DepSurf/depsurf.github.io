# Function: <code>drm_mode_addfb2</code>
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592058992,
      "name": "drm_mode_addfb2",
      "external": true,
      "loc": "drivers/gpu/drm/drm_framebuffer.c:328",
      "file": "drivers/gpu/drm/drm_framebuffer.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "drivers/gpu/drm/drm_client.c:drm_client_buffer_addfb",
        "drivers/gpu/drm/drm_framebuffer.c:drm_mode_addfb2_ioctl",

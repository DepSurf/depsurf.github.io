# Function: <code>__drm_gem_duplicate_shadow_plane_state</code>
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592260961,
      "name": "__drm_gem_duplicate_shadow_plane_state",
      "external": true,
      "loc": "drivers/gpu/drm/drm_gem_atomic_helper.c:218",

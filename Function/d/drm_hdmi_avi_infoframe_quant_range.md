# Function: <code>drm_hdmi_avi_infoframe_quant_range</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_hdmi_avi_infoframe_quant_range",
      "external": true,
      "loc": "drivers/gpu/drm/drm_edid.c:7165",
  ...
  "symbols": [
    {
      "addr": 18446744071597706176,
      "name": "drm_hdmi_avi_infoframe_quant_range.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 50
    },
    {
      "addr": 18446744071592015408,
      "name": "drm_hdmi_avi_infoframe_quant_range",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 171

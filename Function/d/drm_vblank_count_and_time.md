# Function: <code>drm_vblank_count_and_time</code>
...
```c
u64 drm_vblank_count_and_time(struct drm_device * dev, unsigned int pipe, ktime_t * vblanktime)
```
  ...
  "funcs": [
    {
      ...
      "name": "drm_vblank_count_and_time",
      "external": false,
      "loc": "drivers/gpu/drm/drm_vblank.c:930",

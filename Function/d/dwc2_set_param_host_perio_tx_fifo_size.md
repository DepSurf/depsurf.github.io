# Function: <code>dwc2_set_param_host_perio_tx_fifo_size</code>
...
```json
{
  "name": "dwc2_set_param_host_perio_tx_fifo_size",
  ...
  "funcs": [
    {
      ...
      "name": "dwc2_set_param_host_perio_tx_fifo_size",
      "external": true,
      "loc": "drivers/usb/dwc2/core.c:2566",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585670784,
      "name": "dwc2_set_param_host_perio_tx_fifo_size",
      "external": true,
      "loc": "drivers/usb/dwc2/core.c:838",
      "file": "drivers/usb/dwc2/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585863485,
      "name": "dwc2_set_param_host_perio_tx_fifo_size",
      "external": false,
      "loc": "drivers/usb/dwc2/params.c:599",

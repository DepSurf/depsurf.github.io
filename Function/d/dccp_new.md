...
```c
bool dccp_new(struct nf_conn * ct, const struct sk_buff * skb, const struct dccp_hdr * dh)
```
  ...
  "funcs": [
    {
      ...
      "name": "dccp_new",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_proto_dccp.c:384",

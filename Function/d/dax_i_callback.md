# Function: <code>dax_i_callback</code>
...
```c
void dax_i_callback(struct callback_head * head)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585816384,
      "name": "dax_i_callback",
      "external": false,
      "loc": "drivers/dax/super.c:367",
      "file": "drivers/dax/super.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

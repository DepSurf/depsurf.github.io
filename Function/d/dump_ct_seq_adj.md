# Function: <code>dump_ct_seq_adj</code>
...
```c
int dump_ct_seq_adj(struct sk_buff * skb, const struct nf_ct_seqadj * seq, int type)
```

```json
{
  "name": "dump_ct_seq_adj",
  ...
  "funcs": [
    {
      ...
      "name": "dump_ct_seq_adj",
      "external": false,
      "loc": "net/netfilter/nf_conntrack_netlink.c:414",

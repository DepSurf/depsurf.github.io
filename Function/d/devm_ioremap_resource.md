...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071583892336,
      "name": "devm_ioremap_resource",
      "external": true,
      "loc": "lib/devres.c:133",
      "file": "lib/devres.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "symbols": [
    {
      "addr": 18446744071584160241,
      "name": "devm_ioremap_resource.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 109
    },
    {
      "addr": 18446744071584159040,
      "name": "devm_ioremap_resource",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 146
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584817168,
      "name": "devm_ioremap_resource",
      "external": true,
      "loc": "lib/devres.c:175",
      "file": "lib/devres.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071584861776,
      "name": "devm_ioremap_resource",
      "external": true,
      "loc": "lib/devres.c:197",
      "file": "lib/devres.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585284368,
      "name": "devm_ioremap_resource",
      "external": true,
      "loc": "lib/devres.c:199",
      "file": "lib/devres.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [

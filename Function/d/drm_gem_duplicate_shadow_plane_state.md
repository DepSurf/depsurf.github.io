# Function: <code>drm_gem_duplicate_shadow_plane_state</code>
...
```json
{
  "name": "drm_gem_duplicate_shadow_plane_state",
  ...
  "funcs": [
    {
      ...
      "name": "drm_gem_duplicate_shadow_plane_state",
      "external": true,
      "loc": "drivers/gpu/drm/drm_gem_atomic_helper.c:250",

# Function: <code>drm_mode_create_from_cmdline_mode</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_mode_create_from_cmdline_mode",
      "external": true,
      "loc": "drivers/gpu/drm/drm_modes.c:2538",
  ...
  "symbols": [
    {
      "addr": 18446744071597708055,
      "name": "drm_mode_create_from_cmdline_mode.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 283
    },
    {
      "addr": 18446744071592114032,
      "name": "drm_mode_create_from_cmdline_mode",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 616

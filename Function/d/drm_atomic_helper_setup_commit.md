# Function: <code>drm_atomic_helper_setup_commit</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_atomic_helper_setup_commit",
      "external": true,
      "loc": "drivers/gpu/drm/drm_atomic_helper.c:2272",
  ...
  "symbols": [
    {
      "addr": 18446744071597711789,
      "name": "drm_atomic_helper_setup_commit.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 40
    },
    {
      "addr": 18446744071592229920,
      "name": "drm_atomic_helper_setup_commit",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 1926

# Function: <code>drm_connector_attach_encoder</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_connector_attach_encoder",
      "external": true,
      "loc": "drivers/gpu/drm/drm_connector.c:485",
  ...
  "symbols": [
    {
      "addr": 18446744071597705520,
      "name": "drm_connector_attach_encoder.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 30
    },
    {
      "addr": 18446744071591982336,
      "name": "drm_connector_attach_encoder",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 92

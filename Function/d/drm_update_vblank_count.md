# Function: <code>drm_update_vblank_count</code>
...
```c
void drm_update_vblank_count(struct drm_device * dev, unsigned int pipe, bool in_vblank_irq)
```
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_update_vblank_count",
      "external": false,
      "loc": "drivers/gpu/drm/drm_vblank.c:273",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071597709149,
      "name": "drm_update_vblank_count.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 21
    }

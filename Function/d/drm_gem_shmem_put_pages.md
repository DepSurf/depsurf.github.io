# Function: <code>drm_gem_shmem_put_pages</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_gem_shmem_put_pages",
      "external": true,
      "loc": "drivers/gpu/drm/drm_gem_shmem_helper.c:207",
  ...
  "symbols": [
    {
      "addr": 18446744071597710106,
      "name": "drm_gem_shmem_put_pages.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 21
    },
    {
      "addr": 18446744071592203152,
      "name": "drm_gem_shmem_put_pages",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 223

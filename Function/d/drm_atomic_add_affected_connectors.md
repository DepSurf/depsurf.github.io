# Function: <code>drm_atomic_add_affected_connectors</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_atomic_add_affected_connectors",
      "external": true,
      "loc": "drivers/gpu/drm/drm_atomic.c:1289",
  ...
  "symbols": [
    {
      "addr": 18446744071597702143,
      "name": "drm_atomic_add_affected_connectors.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 38
    },
    {
      "addr": 18446744071591923744,
      "name": "drm_atomic_add_affected_connectors",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 326

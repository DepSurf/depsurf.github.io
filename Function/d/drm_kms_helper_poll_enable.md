# Function: <code>drm_kms_helper_poll_enable</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_kms_helper_poll_enable",
      "external": true,
      "loc": "drivers/gpu/drm/drm_probe_helper.c:300",
  ...
  "symbols": [
    {
      "addr": 18446744071597713669,
      "name": "drm_kms_helper_poll_enable.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 110
    },
    {
      "addr": 18446744071592270704,
      "name": "drm_kms_helper_poll_enable",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 361

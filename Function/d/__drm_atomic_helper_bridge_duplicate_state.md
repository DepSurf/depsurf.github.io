# Function: <code>__drm_atomic_helper_bridge_duplicate_state</code>
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592236901,
      "name": "__drm_atomic_helper_bridge_duplicate_state",
      "external": true,
      "loc": "drivers/gpu/drm/drm_atomic_state_helper.c:734",

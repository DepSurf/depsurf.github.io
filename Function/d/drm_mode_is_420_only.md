# Function: <code>drm_mode_is_420_only</code>
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592108722,
      "name": "drm_mode_is_420_only",
      "external": true,
      "loc": "drivers/gpu/drm/drm_modes.c:2709",
      ...
      "caller_func": [
        "drivers/gpu/drm/drm_modes.c:drm_mode_validate_ycbcr420"
      ]
    }
  ],
  "symbols": [
    {
      "addr": 18446744071592106304,
      "name": "drm_mode_is_420_only",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 46

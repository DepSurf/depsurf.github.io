...
```json
{
  "name": "devlink_rate_get_from_info",
  "collision_type": "Unique Static",
  "inline_type": "Full",
  "funcs": [
    {
      "addr": 18446744071590334918,
      "name": "devlink_rate_get_from_info",
      "external": false,
      "loc": "net/core/devlink.c:256",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591984427,
      "name": "devlink_rate_get_from_info",
      "external": false,
      "loc": "net/core/devlink.c:407",
      "file": "net/core/devlink.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "net/core/devlink.c:devlink_nl_pre_doit"
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071595888960,
      "name": "devlink_rate_get_from_info",
      "external": true,
      "loc": "net/devlink/leftover.c:242",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071596769760,
      "name": "devlink_rate_get_from_info",
      "external": false,
      "loc": "net/devlink/rate.c:71",
  ...
  "symbols": [
    {
      "addr": 18446744071596769760,
      "name": "devlink_rate_get_from_info.isra.0",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 96
    }

...
```json
{
  "name": "dwc2_set_param_en_multiple_tx_fifo",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071585285968,
      "name": "dwc2_set_param_en_multiple_tx_fifo",
      "external": true,
      "loc": "drivers/usb/dwc2/core.c:2875",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585672704,
      "name": "dwc2_set_param_en_multiple_tx_fifo",
      "external": true,
      "loc": "drivers/usb/dwc2/core.c:1147",
      "file": "drivers/usb/dwc2/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585864587,
      "name": "dwc2_set_param_en_multiple_tx_fifo",
      "external": false,
      "loc": "drivers/usb/dwc2/params.c:914",

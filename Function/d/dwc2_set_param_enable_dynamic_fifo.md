# Function: <code>dwc2_set_param_enable_dynamic_fifo</code>
...
```json
{
  "name": "dwc2_set_param_enable_dynamic_fifo",
  ...
  "funcs": [
    {
      ...
      "name": "dwc2_set_param_enable_dynamic_fifo",
      "external": true,
      "loc": "drivers/usb/dwc2/core.c:2506",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585670384,
      "name": "dwc2_set_param_enable_dynamic_fifo",
      "external": true,
      "loc": "drivers/usb/dwc2/core.c:778",
      "file": "drivers/usb/dwc2/core.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071585863727,
      "name": "dwc2_set_param_enable_dynamic_fifo",
      "external": false,
      "loc": "drivers/usb/dwc2/params.c:537",

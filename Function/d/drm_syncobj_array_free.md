# Function: <code>drm_syncobj_array_free</code>
...
```c
void drm_syncobj_array_free(struct drm_syncobj * * syncobjs, uint32_t count)
```

```json
{
  "name": "drm_syncobj_array_free",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071592147200,
      "name": "drm_syncobj_array_free",
      "external": false,
      "loc": "drivers/gpu/drm/drm_syncobj.c:1305",

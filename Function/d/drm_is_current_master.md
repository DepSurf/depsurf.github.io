# Function: <code>drm_is_current_master</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "drm_is_current_master",
      "external": true,
      "loc": "drivers/gpu/drm/drm_auth.c:81",
  ...
  "symbols": [
    {
      "addr": 18446744071597703168,
      "name": "drm_is_current_master.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 20
    },
    {
      "addr": 18446744071591945760,
      "name": "drm_is_current_master",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 104

# Function: <code>drm_atomic_crtc_get_property</code>
...
```json
{
  "name": "drm_atomic_crtc_get_property",
  ...
  "funcs": [
    {
      ...
      "name": "drm_atomic_crtc_get_property",
      "external": false,
      "loc": "drivers/gpu/drm/drm_atomic_uapi.c:434",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071597702753,
      "name": "drm_atomic_crtc_get_property.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 92
    }

# Function: <code>vxlan_fdb_insert</code>
...
```c
void vxlan_fdb_insert(struct vxlan_dev * vxlan, const u8 * mac, __be32 src_vni, struct vxlan_fdb * f)
```

```json
{
  "name": "vxlan_fdb_insert",

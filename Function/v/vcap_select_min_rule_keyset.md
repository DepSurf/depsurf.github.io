...
```json
{
  "name": "vcap_select_min_rule_keyset",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071591795888,
      "name": "vcap_select_min_rule_keyset",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:3518",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592543632,
      "name": "vcap_select_min_rule_keyset",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:3532",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

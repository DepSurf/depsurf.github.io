# Function: <code>vmbus_acpi_remove</code>
...
```c
int vmbus_acpi_remove(struct acpi_device * device)
```

```json
{
  "name": "vmbus_acpi_remove",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071587553648,
      "name": "vmbus_acpi_remove",
      "external": false,
      "loc": "drivers/hv/vmbus_drv.c:1939",

# Function: <code>vxlan_fdb_find_rdst</code>
...
```c
struct vxlan_rdst * vxlan_fdb_find_rdst(struct vxlan_fdb * f, union vxlan_addr * ip, __be16 port, __be32 vni, __u32 ifindex)
```

```json
{
  "name": "vxlan_fdb_find_rdst",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586635424,
      "name": "vxlan_fdb_find_rdst",
      "external": false,
      "loc": "drivers/net/vxlan.c:682",

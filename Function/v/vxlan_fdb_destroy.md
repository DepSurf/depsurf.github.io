# Function: <code>vxlan_fdb_destroy</code>
...
```c
void vxlan_fdb_destroy(struct vxlan_dev * vxlan, struct vxlan_fdb * f, bool do_notify, bool swdev_notify)
```

```json
{
  "name": "vxlan_fdb_destroy",

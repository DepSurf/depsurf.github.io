# Function: <code>validate_sp</code>
...
```c
int validate_sp(long unsigned int sp, struct task_struct * p, long unsigned int nbytes)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 13835058055282296192,
      "name": "validate_sp",
      "external": true,
      "loc": "arch/powerpc/kernel/process.c:1973",

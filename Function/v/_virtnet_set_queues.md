...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "_virtnet_set_queues",
      "external": false,
      "loc": "drivers/net/virtio_net.c:2403",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596795655,
      "name": "_virtnet_set_queues.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 21
    }
  ...
  "funcs": [
    {
      ...
      "name": "_virtnet_set_queues",
      "external": false,
      "loc": "drivers/net/virtio_net.c:2655",
      "file": "drivers/net/virtio_net.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "virtnet_set_rxfh",
      "external": false,
      "loc": "drivers/net/virtio_net.c:3205",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596795724,
      "name": "virtnet_set_rxfh.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 37
    }
  ...
  "funcs": [
    {
      ...
      "name": "virtnet_set_rxfh",
      "external": false,
      "loc": "drivers/net/virtio_net.c:3766",
      "file": "drivers/net/virtio_net.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

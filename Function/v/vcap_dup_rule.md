...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591402768,
      "name": "vcap_dup_rule",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:825",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591791952,
      "name": "vcap_dup_rule",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:999",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

...
```json
{
  "name": "vcap_keyfield_count",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071591383648,
      "name": "vcap_keyfield_count",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:435",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591791712,
      "name": "vcap_keyfield_count",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:437",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "drivers/net/ethernet/microchip/vcap/vcap_api.c:_vcap_rule_find_keysets",

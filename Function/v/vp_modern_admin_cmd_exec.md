...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "vp_modern_admin_cmd_exec",
      "external": true,
      "loc": "drivers/virtio/virtio_pci_modern.c:77",
  ...
  "symbols": [
    {
      "addr": 18446744071597665889,
      "name": "vp_modern_admin_cmd_exec.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 25
    },
    {
      "addr": 18446744071590043376,
      "name": "vp_modern_admin_cmd_exec",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 917

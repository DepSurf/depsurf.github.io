# Function: <code>vxlan_fdb_notify</code>
...
```c
int vxlan_fdb_notify(struct vxlan_dev * vxlan, struct vxlan_fdb * fdb, struct vxlan_rdst * rd, int type, bool swdev_notify, struct netlink_ext_ack * extack)
```

```json
{
  "name": "vxlan_fdb_notify",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071586633179,
      "name": "vxlan_fdb_notify",
      "external": false,
      "loc": "drivers/net/vxlan.c:560",
      "file": "drivers/net/vxlan.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "drivers/net/vxlan.c:vxlan_fdb_miss",

# Function: <code>vxlan_vs_find_vni</code>
...
```c
struct vxlan_dev * vxlan_vs_find_vni(struct vxlan_sock * vs, int ifindex, __be32 vni)
```

```json
{
  "name": "vxlan_vs_find_vni",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586623024,
      "name": "vxlan_vs_find_vni",
      "external": false,
      "loc": "drivers/net/vxlan.c:367",

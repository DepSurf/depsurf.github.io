...
```json
{
  "name": "vcap_actionfield_count",
  "collision_type": "Unique Global",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446744071591396861,
      "name": "vcap_actionfield_count",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:602",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591806836,
      "name": "vcap_actionfield_count",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:729",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "not declared, inlined",
      "caller_inline": [
        "drivers/net/ethernet/microchip/vcap/vcap_api.c:vcap_decode_actionset",

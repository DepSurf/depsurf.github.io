# Function: <code>vmalloc_to_phys</code>
...
```c
long unsigned int vmalloc_to_phys(void * va)
```

```json
{
  "name": "vmalloc_to_phys",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282719792,
      "name": "vmalloc_to_phys",
      "external": true,
      "loc": "arch/powerpc/mm/pgtable.c:291",
      "file": "arch/powerpc/mm/pgtable.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "arch/powerpc/mm/book3s64/iommu_api.c:mm_iommu_ua_mark_dirty_rm",
        "arch/powerpc/mm/book3s64/iommu_api.c:mm_iommu_ua_to_hpa_rm",

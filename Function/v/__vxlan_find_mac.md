# Function: <code>__vxlan_find_mac</code>
...
```c
struct vxlan_fdb * __vxlan_find_mac(struct vxlan_dev * vxlan, const u8 * mac, __be32 vni)
```

```json
{
  "name": "__vxlan_find_mac",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071586630384,
      "name": "__vxlan_find_mac",
      "external": false,
      "loc": "drivers/net/vxlan.c:649",
      ...
      "caller_func": [
        ...
        "drivers/net/vxlan.c:vxlan_find_mac"
      ]
    }
  ],
  "symbols": [

# Function: <code>vtime_account_guest</code>
...
```json
{
  "name": "vtime_account_guest",
  "collision_type": "Unique Static",
  "inline_type": "Full",
  "funcs": [
    {
      "addr": 18446744071580428047,
      "name": "vtime_account_guest",
      "external": false,
      "loc": "kernel/sched/cputime.c:692",
...
```c
void vtime_account_guest(struct task_struct * tsk, struct vtime * vtime)
```
  ...
  "funcs": [
    {
      ...
      "name": "vtime_account_guest",
      "external": false,
      "loc": "kernel/sched/cputime.c:724",

...
```json
{
  "name": "vcap_rule_add_key",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071591389888,
      "name": "vcap_rule_add_key",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:2235",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591793568,
      "name": "vcap_rule_add_key",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:2656",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "funcs": [
    {
      ...
      "name": "vcap_rule_add_key",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:2670",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

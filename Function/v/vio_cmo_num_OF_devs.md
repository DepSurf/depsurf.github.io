# Function: <code>vio_cmo_num_OF_devs</code>
...
```c
int vio_cmo_num_OF_devs()
```

```json
{
  "name": "vio_cmo_num_OF_devs",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055283212160,
      "name": "vio_cmo_num_OF_devs",
      "external": false,
      "loc": "arch/powerpc/platforms/pseries/vio.c:102",

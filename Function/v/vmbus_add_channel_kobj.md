# Function: <code>vmbus_add_channel_kobj</code>
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "vmbus_add_channel_kobj",
      "external": true,
      "loc": "drivers/hv/vmbus_drv.c:1718",
  ...
  "symbols": [
    {
      "addr": 18446744071587558926,
      "name": "vmbus_add_channel_kobj.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 21
    },
    {
      "addr": 18446744071587557888,
      "name": "vmbus_add_channel_kobj",
      "section": ".text",
      "bind": "STB_GLOBAL",
      "size": 132

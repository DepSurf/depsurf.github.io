...
```json
{
  "name": "vcap_insert_rule",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071591402912,
      "name": "vcap_insert_rule",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:1732",
  ...
  "funcs": [
    {
      ...
      "name": "vcap_insert_rule",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:2085",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592539888,
      "name": "vcap_insert_rule",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:2099",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

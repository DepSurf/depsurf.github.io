...
```json
{
  "name": "vcap_set_rule_set_actionset",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071591384864,
      "name": "vcap_set_rule_set_actionset",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:775",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591796336,
      "name": "vcap_set_rule_set_actionset",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:904",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

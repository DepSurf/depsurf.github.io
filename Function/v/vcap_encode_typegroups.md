...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "vcap_encode_typegroups",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:140",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596267815,
      "name": "vcap_encode_typegroups.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 54
    }
  ...
  "funcs": [
    {
      ...
      "name": "vcap_encode_typegroups",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:142",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

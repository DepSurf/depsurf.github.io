# Function: <code>vmbus_release_relid</code>
...
```c
void vmbus_release_relid(u32 relid)
```

```json
{
  "name": "vmbus_release_relid",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071587569520,
      "name": "vmbus_release_relid",
      "external": false,
      "loc": "drivers/hv/channel_mgmt.c:360",

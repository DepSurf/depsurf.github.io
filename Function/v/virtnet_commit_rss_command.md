...
```json
{
  "name": "virtnet_commit_rss_command",
  ...
  "funcs": [
    {
      ...
      "name": "virtnet_commit_rss_command",
      "external": false,
      "loc": "drivers/net/virtio_net.c:2717",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596795703,
      "name": "virtnet_commit_rss_command.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 21
    }
  ...
  "funcs": [
    {
      ...
      "name": "virtnet_commit_rss_command",
      "external": false,
      "loc": "drivers/net/virtio_net.c:3041",
      "file": "drivers/net/virtio_net.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

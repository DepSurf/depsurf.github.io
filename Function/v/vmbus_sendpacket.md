# Function: <code>vmbus_sendpacket</code>
...
```c
int vmbus_sendpacket(struct vmbus_channel * channel, void * buffer, u32 bufferlen, u64 requestid, enum vmbus_packet_type type, u32 flags)
```

```json
{
  "name": "vmbus_sendpacket",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071587564160,
      "name": "vmbus_sendpacket",
      "external": true,
      "loc": "drivers/hv/channel.c:760",

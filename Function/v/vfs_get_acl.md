# Function: <code>vfs_get_acl</code>
...
```c
struct posix_acl * vfs_get_acl(struct user_namespace * mnt_userns, struct dentry * dentry, const char * acl_name)
```

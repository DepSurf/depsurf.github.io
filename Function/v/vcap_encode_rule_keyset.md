...
```json
{
  "name": "vcap_encode_rule_keyset",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071591392944,
      "name": "vcap_encode_rule_keyset",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:511",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591802576,
      "name": "vcap_encode_rule_keyset",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:635",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

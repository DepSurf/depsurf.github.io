# Function: <code>__vxlan_fdb_free</code>
...
```c
void __vxlan_fdb_free(struct vxlan_fdb * f)
```

```json
{
  "name": "__vxlan_fdb_free",
  ...
  "funcs": [
    {
      ...
      "caller_func": [
        ...
        "drivers/net/vxlan.c:__vxlan_dev_create",
        "drivers/net/vxlan.c:vxlan_fdb_free"
      ]
    }
  ],
  "symbols": [

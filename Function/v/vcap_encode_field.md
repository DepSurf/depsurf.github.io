...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "vcap_encode_field",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:123",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596267694,
      "name": "vcap_encode_field.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 89
    }
  ...
  "funcs": [
    {
      ...
      "name": "vcap_encode_field",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:125",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

...
```json
{
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596044562,
      "name": "vmemmap_should_optimize.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 78
    }

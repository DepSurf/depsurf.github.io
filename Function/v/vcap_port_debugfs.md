...
```json
{
  "name": "vcap_port_debugfs",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071591376224,
      "name": "vcap_port_debugfs",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api_debugfs.c:359",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591782560,
      "name": "vcap_port_debugfs",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api_debugfs.c:386",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api_debugfs.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

# Function: <code>validate_parent_available</code>
...
```c
int validate_parent_available(struct device_node * np)
```

```json
{
  "name": "validate_parent_available",
  "collision_type": "Unique Static",
  "inline_type": "Selective",
  "funcs": [
    {
      "addr": 18446603336501256496,
      "name": "validate_parent_available",
      "external": false,
      "loc": "drivers/edac/altera_edac.c:1910",

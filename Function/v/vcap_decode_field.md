...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "vcap_decode_field",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:195",
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071596267650,
      "name": "vcap_decode_field.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 44
    }
  ...
  "funcs": [
    {
      ...
      "name": "vcap_decode_field",
      "external": false,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:197",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

  ...
  "funcs": [
    {
      ...
      "name": "vaddr_get_pfns",
      "external": false,
      "loc": "drivers/vfio/vfio_iommu_type1.c:548",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588430176,
      "name": "vaddr_get_pfns",
      "external": false,
      "loc": "drivers/vfio/vfio_iommu_type1.c:549",
      "file": "drivers/vfio/vfio_iommu_type1.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "vaddr_get_pfns",
      "external": false,
      "loc": "drivers/vfio/vfio_iommu_type1.c:547",
      "file": "drivers/vfio/vfio_iommu_type1.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071594427689,
      "name": "vaddr_get_pfns.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 27
    }

# Function: <code>vxlan_fan_find_map</code>
...
```c
struct ip_fan_map * vxlan_fan_find_map(struct vxlan_dev * vxlan, __be32 daddr)
```

```json
{
  "name": "vxlan_fan_find_map",

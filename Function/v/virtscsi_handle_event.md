...
```json
{
  "name": "virtscsi_handle_event",
  "collision_type": "Unique Static",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071591306464,
      "name": "virtscsi_handle_event",
      "external": false,
      "loc": "drivers/scsi/virtio_scsi.c:375",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591655104,
      "name": "virtscsi_handle_event",
      "external": false,
      "loc": "drivers/scsi/virtio_scsi.c:379",
      "file": "drivers/scsi/virtio_scsi.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
...
```json
{
  ...
  "funcs": [
    {
      ...
      "name": "virtscsi_handle_event",
      "external": false,
      "loc": "drivers/scsi/virtio_scsi.c:359",
      "file": "drivers/scsi/virtio_scsi.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []
  ...
  "symbols": [
    ...
    {
      "addr": 18446744071586656644,
      "name": "virtscsi_handle_event.cold",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 91
    }

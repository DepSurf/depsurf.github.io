...
```json
{
  "name": "vmware_sev_es_hcall_finish",
  ...
  "funcs": [
    {
      ...
      "name": "vmware_sev_es_hcall_finish",
      "external": false,
      "loc": "arch/x86/kernel/cpu/vmware.c:494",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071579278976,
      "name": "vmware_sev_es_hcall_finish",
      "external": false,
      "loc": "arch/x86/kernel/cpu/vmware.c:497",
      "file": "arch/x86/kernel/cpu/vmware.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": []

...
```json
{
  "name": "vcap_actionfield_typegroup",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071591395680,
      "name": "vcap_actionfield_typegroup",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:590",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071591805504,
      "name": "vcap_actionfield_typegroup",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:717",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

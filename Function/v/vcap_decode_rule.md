...
```json
{
  "name": "vcap_decode_rule",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 18446744071591815520,
      "name": "vcap_decode_rule",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:2392",
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592563424,
      "name": "vcap_decode_rule",
      "external": true,
      "loc": "drivers/net/ethernet/microchip/vcap/vcap_api.c:2406",
      "file": "drivers/net/ethernet/microchip/vcap/vcap_api.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [

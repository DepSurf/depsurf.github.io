# Function: <code>omap_write_buf16</code>
...
```c
void omap_write_buf16(struct mtd_info * mtd, const u_char * buf, int len)
```

```json
{
  "name": "omap_write_buf16",
  ...
  "funcs": [
    {
      ...
      "name": "omap_write_buf16",
      "external": false,
      "loc": "drivers/mtd/nand/raw/omap2.c:318",

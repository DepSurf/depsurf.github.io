...
```json
{
  ...
  "symbols": [
    {
      "addr": 18446744071587535632,
      "name": "_opp_get_opp_table.isra.20",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 357
    }
...
```json
{
  ...
  "symbols": [
    {
      "addr": 18446744071587809472,
      "name": "_opp_get_opp_table.isra.0",
      "section": ".text",
      "bind": "STB_LOCAL",
      "size": 381
    }
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071588014640,
      "name": "_opp_get_opp_table",
      "external": false,
      "loc": "drivers/opp/core.c:1003",
      "file": "drivers/opp/core.c",
      "inline": "not declared, inlined",
      "caller_inline": [],
      "caller_func": [

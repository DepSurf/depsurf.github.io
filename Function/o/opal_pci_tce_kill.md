# Function: <code>opal_pci_tce_kill</code>
...
```c
int64_t opal_pci_tce_kill(int64_t a0, int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6, int64_t a7)
```

```json
{
  "name": "opal_pci_tce_kill",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282967344,
      "name": "opal_pci_tce_kill",
      "external": true,
      "loc": "arch/powerpc/platforms/powernv/opal-call.c:249",

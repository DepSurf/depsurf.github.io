# Function: <code>omap_prefetch_reset</code>
...
```c
int omap_prefetch_reset(int cs, struct omap_nand_info * info)
```

```json
{
  "name": "omap_prefetch_reset",
  ...
  "funcs": [
    {
      ...
      "name": "omap_prefetch_reset",
      "external": false,
      "loc": "drivers/mtd/nand/raw/omap2.c:220",

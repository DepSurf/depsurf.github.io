# Function: <code>omap_hwmod_get_mpu_rt_va</code>
...
```c
void * omap_hwmod_get_mpu_rt_va(struct omap_hwmod * oh)
```

```json
{
  "name": "omap_hwmod_get_mpu_rt_va",
  ...
  "funcs": [
    {
      ...
      "name": "omap_hwmod_get_mpu_rt_va",
      "external": true,
      "loc": "arch/arm/mach-omap2/omap_hwmod.c:3851",

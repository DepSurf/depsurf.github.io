# Function: <code>omap_dma_glbl_read</code>
...
```c
unsigned int omap_dma_glbl_read(struct omap_dmadev * od, unsigned int reg)
```

```json
{
  "name": "omap_dma_glbl_read",
  ...
  "funcs": [
    {
      ...
      "name": "omap_dma_glbl_read",
      "external": false,
      "loc": "drivers/dma/ti/omap-dma.c:338",

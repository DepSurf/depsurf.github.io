# Function: <code>opal_xive_set_vp_info</code>
...
```c
int64_t opal_xive_set_vp_info(int64_t a0, int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6, int64_t a7)
```

```json
{
  "name": "opal_xive_set_vp_info",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282968240,
      "name": "opal_xive_set_vp_info",
      "external": true,
      "loc": "arch/powerpc/platforms/powernv/opal-call.c:263",

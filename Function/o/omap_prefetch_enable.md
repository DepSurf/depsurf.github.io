# Function: <code>omap_prefetch_enable</code>
...
```c
int omap_prefetch_enable(int cs, int fifo_th, int dma_mode, unsigned int u32_count, int is_write, struct omap_nand_info * info)
```

```json
{
  "name": "omap_prefetch_enable",
  ...
  "funcs": [
    {
      ...
      "name": "omap_prefetch_enable",
      "external": false,
      "loc": "drivers/mtd/nand/raw/omap2.c:189",

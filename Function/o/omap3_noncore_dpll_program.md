# Function: <code>omap3_noncore_dpll_program</code>
...
```c
int omap3_noncore_dpll_program(struct clk_hw_omap * clk, u16 freqsel)
```

```json
{
  "name": "omap3_noncore_dpll_program",
  ...
  "funcs": [
    {
      ...
      "name": "omap3_noncore_dpll_program",
      "external": false,
      "loc": "drivers/clk/ti/dpll3xxx.c:302",

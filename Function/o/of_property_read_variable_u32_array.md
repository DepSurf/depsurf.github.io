# Function: <code>of_property_read_variable_u32_array</code>
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446603336501618632,
      "name": "of_property_read_variable_u32_array",
      "external": true,
      "loc": "drivers/of/property.c:276",
      ...
      "caller_func": [
        ...
        "drivers/gpio/gpio-xilinx.c:xgpio_probe",
        "drivers/gpio/gpio-xilinx.c:xgpio_probe",
        "drivers/pci/of.c:of_pci_get_max_link_speed",
        "drivers/pci/of.c:of_pci_check_probe_only",
        "drivers/pci/of.c:of_get_pci_domain_nr",
        "drivers/pci/of.c:of_pci_parse_bus_range",
        "drivers/pci/of.c:of_pci_get_devfn",
        ...
        "drivers/iommu/arm-smmu.c:arm_smmu_of_xlate",
        ...
        "drivers/net/ethernet/freescale/fman/mac.c:mac_probe",
        "drivers/usb/common/common.c:of_usb_update_otg_caps",
        "drivers/usb/core/of.c:usb_of_get_interface_node",
        "drivers/usb/core/of.c:usb_of_get_device_node",
        ...
        "drivers/watchdog/watchdog_core.c:watchdog_init_timeout",
        "drivers/watchdog/watchdog_core.c:watchdog_init_timeout",
        ...
        "drivers/mmc/core/core.c:mmc_of_find_child_device",
        ...
        "drivers/of/base.c:of_n_size_cells",
        "drivers/of/base.c:of_n_size_cells",
        "drivers/of/base.c:of_n_addr_cells",
        "drivers/of/base.c:of_n_addr_cells",
  ...
  "funcs": [
    {
      ...
      "caller_func": [
        ...
        "arch/arm/mm/cache-l2x0.c:aurora_of_parse",
        ...
        "fs/pstore/ram.c:ramoops_parse_dt_size",
        ...
        "drivers/bus/uniphier-system-bus.c:uniphier_system_bus_probe",
        "drivers/bus/vexpress-config.c:vexpress_config_find_prop",
        "drivers/pinctrl/devicetree.c:pinctrl_find_cells_size",
        "drivers/pinctrl/devicetree.c:pinctrl_find_cells_size",
        "drivers/pinctrl/pinconf-generic.c:parse_dt_cfg",
        "drivers/pinctrl/pinctrl-single.c:pcs_probe",
        "drivers/pinctrl/pinctrl-single.c:pcs_probe",
        ...
        "drivers/clk/tegra/clk-dfll.c:read_dt_param",
        ...
        "drivers/memory/of_memory.c:of_do_get_timings",
        "drivers/memory/of_memory.c:of_do_get_timings",
        "drivers/memory/of_memory.c:of_do_get_timings",
        "drivers/memory/of_memory.c:of_do_get_timings",
        "drivers/memory/of_memory.c:of_do_get_timings",
        ...
        "drivers/memory/omap-gpmc.c:gpmc_read_timings_dt",
        "drivers/memory/omap-gpmc.c:gpmc_read_timings_dt",
        "drivers/memory/omap-gpmc.c:gpmc_read_settings_dt",
        "drivers/memory/omap-gpmc.c:gpmc_read_settings_dt",
        "drivers/memory/omap-gpmc.c:gpmc_read_settings_dt",
        "drivers/memory/omap-gpmc.c:gpmc_read_settings_dt",
        "drivers/memory/mvebu-devbus.c:mvebu_devbus_probe",
        "drivers/memory/mvebu-devbus.c:mvebu_devbus_probe",
        "drivers/memory/mvebu-devbus.c:get_timing_param_ps",
        ...
        "drivers/memory/tegra/tegra124-emc.c:load_one_timing_from_dt",
        "drivers/memory/tegra/tegra124-emc.c:load_one_timing_from_dt",
        "drivers/memory/tegra/tegra124-emc.c:load_one_timing_from_dt",
        "drivers/memory/tegra/tegra124-emc.c:load_one_timing_from_dt",
        "drivers/memory/tegra/tegra124-emc.c:load_one_timing_from_dt",
  ...
  "funcs": [
    {
      ...
      "caller_func": [
        ...
        "arch/powerpc/platforms/powernv/ocxl.c:pnv_ocxl_get_xsl_irq",

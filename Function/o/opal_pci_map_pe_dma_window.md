# Function: <code>opal_pci_map_pe_dma_window</code>
...
```c
int64_t opal_pci_map_pe_dma_window(int64_t a0, int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6, int64_t a7)
```

```json
{
  "name": "opal_pci_map_pe_dma_window",
  "collision_type": "Unique Global",
  "inline_type": "No",
  "funcs": [
    {
      "addr": 13835058055282962736,
      "name": "opal_pci_map_pe_dma_window",
      "external": true,
      "loc": "arch/powerpc/platforms/powernv/opal-call.c:177",

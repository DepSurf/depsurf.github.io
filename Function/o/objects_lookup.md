# Function: <code>objects_lookup</code>
...
```c
int objects_lookup(struct drm_file * filp, u32 * handle, int count, struct drm_gem_object * * objs)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446744071592068640,
      "name": "objects_lookup",
      "external": false,
      "loc": "drivers/gpu/drm/drm_gem.c:656",

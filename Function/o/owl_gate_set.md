# Function: <code>owl_gate_set</code>
...
```c
void owl_gate_set(const struct owl_clk_common * common, const struct owl_gate_hw * gate_hw, bool enable)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 18446603336497797920,
      "name": "owl_gate_set",
      "external": true,
      "loc": "drivers/clk/actions/owl-gate.c:16",

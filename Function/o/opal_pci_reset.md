# Function: <code>opal_pci_reset</code>
...
```c
int64_t opal_pci_reset(int64_t a0, int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6, int64_t a7)
```
...
```json
{
  ...
  "funcs": [
    {
      "addr": 13835058055282962864,
      "name": "opal_pci_reset",
      "external": true,
      "loc": "arch/powerpc/platforms/powernv/opal-call.c:179",
      "file": "arch/powerpc/platforms/powernv/opal-call.c",
      "inline": "seen, unknown",
      "caller_inline": [],
      "caller_func": [
        "arch/powerpc/platforms/powernv/pci-ioda.c:pnv_pci_init_ioda_phb",
        "arch/powerpc/platforms/powernv/pci-ioda.c:pnv_pci_ioda_shutdown",

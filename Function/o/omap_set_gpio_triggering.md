# Function: <code>omap_set_gpio_triggering</code>
...
```c
int omap_set_gpio_triggering(struct gpio_bank * bank, int gpio, unsigned int trigger)
```

```json
{
  "name": "omap_set_gpio_triggering",
  ...
  "funcs": [
    {
      ...
      "name": "omap_set_gpio_triggering",
      "external": false,
      "loc": "drivers/gpio/gpio-omap.c:331",

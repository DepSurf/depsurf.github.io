...
struct timer_base {
    ...
    bool nohz_active;
    bool is_idle;
    long unsigned int[9] pending_map;
    struct hlist_head[576] vectors;
}
```
</details>
</li>
...
struct timer_base {
    ...
    bool is_idle;
    bool must_forward_clk;
    long unsigned int[18] pending_map;
    struct hlist_head[576] vectors;
}
```
</details>
...
<li>
<b>Field type changed. </b>
<code>long unsigned int[9] pending_map</code> ➡️ <code>long unsigned int[18] pending_map</code>
</li>
</ul>
</details>
</li>
